import { Data_Skill, Data_Item, Data_MapInfo, Data_SystemMV, Data_Weapon, Data_Armor, Data_Enemy, Data_Class, Data_State, Data_Actor, Data_CommonEvent, Data_System, MapFileInfo, Data_Troop, Data_Map } from '../../../rmmz';
...
export interface RpgDataReadHandlers<Commmon, Map, System, Actor, Skill, Item, Weapon, Armor, Enemy, Class, State, Troop> {
