import { Data_Class, Data_Armor, Data_Weapon, Data_Item } from '../../../../rmmz/rpg';
...
export interface Rmmz_BranchSourceProvider {
    ...
    mapCharacter(characterId: number): {
        direction(): number;
    } | null | undefined;
...
export type Rmmz_BranchSourceActor = Pick<Rmmz_Actor, "isClass" | "hasSkill" | "hasWeapon" | "hasArmor" | "isStateAffected" | "name">;
export type Rmmz_BranchSourceEnemy = Pick<Rmmz_Enemy, "isAlive" | "isStateAffected" | "enemyId">;
