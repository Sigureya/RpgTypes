...
type CommandTypeAssert = {
    [K in Exclude<EventCode, 0 | SubCommands["code"] | 655 | 339> as `command${K}`]: Extract<EventCommand, {
        code: K;
    }> extends undefined ? never : (params: unknown[] & Extract<EventCommand, {
        code: K;
    }>["parameters"]) => boolean;
};
