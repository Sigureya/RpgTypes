...
export interface Rmmz_BattlerContainer_Readonly<Battler> extends Rmmz_Members<Battler> {
    members(): Battler[];
    aliveMembers(): Battler[];
    deadMembers(): Battler[];
    movableMembers(): Battler[];
}
export interface Rmmz_BattlerContainer<Battler> extends Rmmz_BattlerContainer_Readonly<Battler> {
    inBattle(): boolean;
    members(): Battler[];
    aliveMembers(): Battler[];
    deadMembers(): Battler[];
