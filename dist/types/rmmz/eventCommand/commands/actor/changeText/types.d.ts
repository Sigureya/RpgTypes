import { CHANGE_NAME, CHANGE_NICKNAME, CHANGE_PROFILE, EventCommandLike } from '../../../../../libs/eventCommand';
...
export interface Command_ChangeActorName extends EventCommandLike<typeof CHANGE_NAME> {
    parameters: [actorId: number, name: string];
}
export interface Command_ChangeActorNickName extends EventCommandLike<typeof CHANGE_NICKNAME> {
    parameters: [actorId: number, nickname: string];
}
export interface Command_ChangeActorProfile extends EventCommandLike<typeof CHANGE_PROFILE> {
