import { EventCommandLike, FADEOUT_BGM, SAVE_BGM, RESUME_BGM, FADEOUT_BGS } from '../../../../../libs/eventCommand';
export interface Command_FadeOutBGM extends EventCommandLike<typeof FADEOUT_BGM, [
    duration: number
]> {
}
