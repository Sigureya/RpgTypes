...
export interface Command_GetRegionId extends EventCommandLike<typeof GET_LOCATION_INFO> {
    parameters: ParamArray_GetRegionId;
}
export interface Command_GetRegionIdDirect extends EventCommandLike<typeof GET_LOCATION_INFO> {
