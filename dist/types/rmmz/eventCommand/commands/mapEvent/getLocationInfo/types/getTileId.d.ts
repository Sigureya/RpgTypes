...
import { ParamObject_GetLocationInfo } from './getLocation';
...
export interface Command_GetTileId extends EventCommandLike<typeof GET_LOCATION_INFO> {
    parameters: ParamArray_GetTileId;
}
export interface Command_GetTileIdDirect extends EventCommandLike<typeof GET_LOCATION_INFO> {
