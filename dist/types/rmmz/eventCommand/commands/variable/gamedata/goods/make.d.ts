import { Command_ControlVariables_FromAnyGoods, Command_ControlVariables_FromArmor, Command_ControlVariables_FromItem, Command_ControlVariables_FromWeapon, ParamObject_VariableFromArmor, ParamObject_VariableFromItem, ParamObject_VariableFromWeapon } from './types';
export declare const resolveItemId: (command: Command_ControlVariables_FromAnyGoods) => number;
