...
export declare const isStructAttr: (param: PluginParam) => param is PluginParamEx<StructRefParam | StructArrayRefParam>;
...
export declare const hasTextAttr: (param: PluginParam) => param is PluginParamEx<PrimitiveStringParam | StringArrayParam>;
