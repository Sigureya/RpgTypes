...
export type DataKind_RpgUnion = DataKindActor | DataKindEnemy | DataKindClass | DataKindSkill | DataKindItem | DataKindWeapon | DataKindArmor | DataKindState | DataKindTroop | DataKindCommonEvent;
