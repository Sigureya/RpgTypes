...
import { Data_MapUnknown } from './rpg/data/event';
...
export declare const makeMapDataFromTestDataSource: (soruce: TestDataSourceWithNote) => Data_MapUnknown<NormalizedEventCommand>;
