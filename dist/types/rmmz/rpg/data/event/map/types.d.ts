...
import { MapEvent, MapEventContainer } from './event';
import { Data_MapTiles } from './tiles';
export type Map_EncounterSoucre = Data_MapTiles & {
    encounterList: Encounter[];
};
export interface Data_MapUnknown<CommandType extends EventCommandUnknown = EventCommand, MoveRoute extends MoveRouteCommandUnknown = MoveRouteCommandUnknown> extends MapEventContainer<CommandType>, Map_EncounterSoucre {
    data: number[];
