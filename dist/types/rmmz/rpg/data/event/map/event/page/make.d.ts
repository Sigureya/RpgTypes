...
export declare const makeMapEventPage: <Command extends EventCommandUnknown>({ list, conditions, image, moveFrequency, directionFix, moveRoute, priorityType, stepAnime, through, walkAnime, moveSpeed, moveType, trigger, }?: Partial<MapEventPage<Command>>) => MapEventPage<Command>;
