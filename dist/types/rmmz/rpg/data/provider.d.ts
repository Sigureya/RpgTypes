...
import { Data_Armor, Data_Class, Data_Item, Data_State, Data_Weapon } from './main';
...
export interface Provider_CommonEvents<Comand extends EventCommandUnknown = EventCommandUnknown> {
    isValidCommonEvent(commonEventId: number): boolean;
    commonEvent(commonEventId: number): Data_CommonEventUnknown<Comand> | undefined | null;
}
