...
import { ExtraParamObject } from './members/paramArray/types';
...
export declare const calculateParam2: (traits: ReadonlyArray<Trait>) => StatusParamObject & ExtraParamObject;
