...
export declare const SCHEMA_DATA_SYSTEM_TEXTS: {
    readonly required: readonly ["gameTitle", "currencyUnit", "terms"];
    ...
    readonly properties: {
        ...
        readonly terms: {
            readonly type: "object";
            readonly required: readonly ["messages", "commands", "basic", "params"];
            readonly additionalProperties: false;
            readonly properties: {
                readonly messages: {
                    readonly type: "object";
