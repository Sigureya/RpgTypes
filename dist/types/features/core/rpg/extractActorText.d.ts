...
export declare const createActorTextDictionary: <T>(actors: ReadonlyArray<Data_Actor>, commons: ReadonlyArray<Data_CommonEvent>, troops: ReadonlyArray<Data_Troop>, maps: ReadonlyArray<Data_Map>, handlers: HandlresCreateActorTextDictionary<T>) => KeyValuePairEx<T, string>[];
