import { Command_PluginCommandMZ, Data_CommonEvent, Data_Map, Data_Troop } from '../../../../rmmz';
...
export declare const extractMapAudio: <T extends AudioPluginCommandParameter>(map: Data_Map, pluginCommandEvaltor?: (command: Command_PluginCommandMZ) => T[]) => ExtractedMapAudios<T>;
