...
export declare const summarizeNoteKinds: (items: readonly KeyValuePair[], audioFiles: AudioFilesSet, imageFiles: ImageFilesSet, other: OtherFilesSet) => SummarizedNote[];
