import { Data_Map, Data_Troop, Data_CommonEvent, Command_PluginCommandMZ } from '../../../rmmz';
import { ExtractedBattleEventText, ExtractedCommonEventText, ExtractedMapTexts, PluginCommandMzParameter } from './text/eventCommand';
