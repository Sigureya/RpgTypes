...
export interface Rmmz_PluginManager_Translation extends PluginManagerTemplate<typeof PLUGIN_NAME_HONYAKU_EX, typeof PLUGIN_COMMAND_HONYAKU_SETUP, RuntimeDictionaryData<string>> {
}
