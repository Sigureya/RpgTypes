...
export declare const convertCommonEvents: <UUID>(filename: string, cc: ReadonlyArray<ExtractedCommonEventText>, uuidGenFunc: (text: string) => UUID, commandNameFn: (command: TextCommandParameter) => string) => ExtractedCommandItem<UUID>[];
