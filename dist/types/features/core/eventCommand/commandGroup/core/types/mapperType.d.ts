...
export interface GroopMapper<T> {
    ...
    comment(groop: EventCommandGroup_Comment, index: number, array: ReadonlyArray<EventCommand>): T;
    script(groop: EventCommandGroup_Script, index: number, array: ReadonlyArray<EventCommand>): T;
}
