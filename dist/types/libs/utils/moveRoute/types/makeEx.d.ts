import { ROUTE_CHANGE_BLEND_MODE, ROUTE_CHANGE_FREQ, ROUTE_CHANGE_IMAGE, ROUTE_CHANGE_OPACITY, ROUTE_CHANGE_SPEED, ROUTE_JUMP, ROUTE_PLAY_SE, ROUTE_SCRIPT, ROUTE_SWITCH_OFF, ROUTE_SWITCH_ON, ROUTE_WAIT } from './constants';
import { MoveRouteLabels2, MoveRouteLabels3 } from './labels';
...
export type MoveRouteMakeExArray<SoundParamType> = DirectionArray | TurnArray | JumpArray | WaitArray | SwitchOnArray | SwitchOffArray | ChangeSpeedArray | ChangeFrequencyArray | ChangeImageArray | ChangeOpacityArray | ChangeBlendModeArray | PlaySeArray<SoundParamType> | ScriptArray;
