import { aO as o, aP as i } from "./eventCommandCodes.es.js";
const n = (a, t = 0) => ({
  code: o,
  indent: t,
  ...
  positionType: a[3],
  speakerName: a[4] ?? ""
}), c = (a) => [a.facename, a.faceIndex, a.background, a.positionType, a.speakerName], l = (a, t = 0) => ({ code: i, indent: t, parameters: [a] }), e = (a, t) => typeof a == "string" ? a : t, p = (a) => ({
  ...
  seVolume: a.seVolume
}), u = (a) => [a.mhp ?? "", a.mmp ?? "", a.atk ?? "", a.def ?? "", a.mat ?? "", a.mdf ?? "", a.agi ?? "", a.luk ?? "", a.hit ?? "", a.eva ?? ""], g = (a) => ({
  mhp: a[0],
  mmp: a[1],
  atk: a[2],
  def: a[3],
  ...
  hit: a[8],
  eva: a[9]
}), y = (a) => [a.level ?? "Level", a.levelA ?? "Level", a.hp ?? "HP", a.hpA ?? "HP", a.mp ?? "MP", a.mpA ?? "MP", a.tp ?? "TP", a.tpA ?? "TP", a.experience ?? "EXP", a.exp ?? "EXP"], v = (a) => ({
  level: a[0],
  levelA: a[1],
  hp: a[2],
  hpA: a[3],
