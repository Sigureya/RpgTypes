const x = 0, g = 1, M = 2, F = 3, $ = 4, v = 5, m = (a) => a.map(((r) => ({ dataKey: r, placeHolder: `{${r}}` }))), b = (a) => ({
  dataKey: a.dataIdKey,
  ...
  return {
    ...
    properties: (e = a.placeHolder ?? {}, { numbers: e.numbers ? m(e.numbers) : [], strings: e.strings ? m(e.strings) : [] }),
  ...
  const c = ((s, d, o) => {
    const p = o.properties.numbers.reduce(((n, l) => u(n, d, l)), s);
    return o.properties.strings.reduce(((n, l) => u(n, d, l)), p);
  })(t, a, e);
  return r ? K(c, a, e, r, i) : c;
}, K = (a, r, e, t, i) => {
  const c = ((s, d) => {
    const o = ((p, n) => {
      const l = n[p];
      return l && l.id === p ? l : n.find(((y) => y.id === p));
    })(d, s);
    return o ? o.name : `?data[${d}]`;
  })(t, i(r));
  return e.itemMappers.reduce(((s, d) => s.replaceAll(d.placeHolder, c)), a);
};
export {
  g as O,
  $ as a,
