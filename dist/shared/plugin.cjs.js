...
const e = require("ajv"), t = require("./make.cjs.js"), a = (e2, t2) => `\\${e2}[${t2}]`, r = (e2 = {}) => ({
  ...
  kind: e2.kind ?? 0
}), u = "{name}", y = "{name} * {value}%", x = "{name} + {value}%", E = "{value}", g = { title: "特徴", options: {
  ...
  attackSpeed: { title: "攻撃速度補正", format: E },
  attackTimes: { title: "攻撃追加回数", format: E },
...
}, A = "{name} {value1}%", T = "{value1}% + {value2}", _ = "{name} {value1}ターン", b = "{name}", S = {
  title: "使用効果",
  options: {
...
}), h = (e2 = {}) => [t.makeAudioFileParams(e2.cursor), t.makeAudioFileParams(e2.ok), t.makeAudioFileParams(e2.cancel), t.makeAudioFileParams(e2.buzzer), t.makeAudioFileParams(e2.equip), t.makeAudioFileParams(e2.save), t.makeAudioFileParams(e2.load), t.makeAudioFileParams(e2.battleStart), t.makeAudioFileParams(e2.escape), t.makeAudioFileParams(e2.enemyAttack), t.makeAudioFileParams(e2.enemyDamage), t.makeAudioFileParams(e2.enemyCollapse), t.makeAudioFileParams(e2.bossCollapes1), t.makeAudioFileParams(e2.bossCollapes2), t.makeAudioFileParams(e2.actorDamage), t.makeAudioFileParams(e2.actorCollapse), t.makeAudioFileParams(e2.playRecovery), t.makeAudioFileParams(e2.playMiss), t.makeAudioFileParams(e2.playEvasion), t.makeAudioFileParams(e2.playMagicEvasion), t.makeAudioFileParams(e2.playReflection), t.makeAudioFileParams(e2.shop), t.makeAudioFileParams(e2.useItem), t.makeAudioFileParams(e2.useSkill)], v = (e2 = {}) => [e2.item ?? true, e2.weapon ?? true, e2.armor ?? true, e2.keyItem ?? true], M = (e2 = {}) => [e2.item ?? true, e2.skill ?? true, e2.equip ?? true, e2.status ?? true, e2.formation ?? true, e2.save ?? true], k = {
...
}), w = (e2) => e2 ? [...e2] : [], H = (e2) => [e2.mhp ?? "", e2.mmp ?? "", e2.atk ?? "", e2.def ?? "", e2.mat ?? "", e2.mdf ?? "", e2.agi ?? "", e2.luk ?? "", e2.hit ?? "", e2.eva ?? ""], B = (e2 = {}) => ({
...
}, j = { type: "object", properties: { name: { type: "string" }, volume: { type: "integer", minimum: 0, maximum: 100 }, pitch: { type: "integer", minimum: 0, maximum: 100 }, pan: {
  type: "integer",
  minimum: -100,
  maximum: 100
} }, required: ["name", "volume", "pitch", "pan"], additionalProperties: false }, W = {
  additionalProperties: false,
  type: "object",
  required: ["battleBgm", "victoryMe", "gameoverMe", "titleBgm", "defeatMe", "sounds"],
  properties: { battleBgm: j, victoryMe: j, gameoverMe: j, titleBgm: j, defeatMe: j, sounds: {
    type: "array",
    items: j,
    minItems: 24,
    maxItems: 24
  } }
}, Y = { type: "object", additionalProperties: false, required: ["magicSkills", "battleSystem"], properties: { magicSkills: {
  type: "array",
  items: { type: "number" },
  minItems: 0,
  uniqueItems: true
}, battleSystem: { type: "number" } } }, z = { additionalProperties: false, type: "object", required: ["startMapId", "startX", "startY", "partyMembersArray"], properties: { startMapId: {
  type: "integer",
  minimum: 0
...
}, Z = { type: "string" }, Q = { type: "string", nullable: true }, ee = { type: "string" }, te = {
  ...
  properties: { currencyUnit: { type: "string" }, gameTitle: { type: "string" }, terms: {
    ...
    }, commands: { type: "array", items: [Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Q, Z, Z, Q, Z, Z], minItems: 26, maxItems: 26 }, basic: {
      type: "array",
      items: { type: "string" },
      minItems: 10,
      maxItems: 10
  ...
  type: "object",
  properties: { airship: re, boat: re, ship: re, advanced: {
    type: "object",
    properties: {
      gameId: { type: "integer" },
    ...
    additionalProperties: false
  }, attackMotions: { type: "array", items: U } }
}, ie = (e2) => e2.reduce((e3, t2) => ({ required: [...e3.required, ...t2.required], properties: { ...e3.properties, ...t2.properties } }), {
  required: [],
  properties: {}
}), se = new e({ strict: true }), ne = ((e2) => {
  const t2 = ie(e2);
  return {
    additionalProperties: false,
    type: "object",
...
})([oe, W, Y, k, D, z, V, K, $, te, X, ae]), me = se.compile(ne), pe = se.compile(q);
se.compile(U);
const ce = se.compile(V), de = (e2) => [e2.level ?? "Level", e2.levelA ?? "Level", e2.hp ?? "HP", e2.hpA ?? "HP", e2.mp ?? "MP", e2.mpA ?? "MP", e2.tp ?? "TP", e2.tpA ?? "TP", e2.experience ?? "EXP", e2.exp ?? "EXP"], le = (e2, t2) => [e2.fight ?? "Fight", e2.escape ?? "Escape", e2.attack ?? "Attack", e2.guard ?? "Guard", e2.item ?? "Item", e2.skill ?? "Skill", e2.equip ?? "Equip", e2.status ?? "Status", e2.formation ?? "Formation", e2.save ?? "Save", e2.gameEnd ?? "Game End", e2.options ?? "Options", e2.weapon ?? "Weapon", e2.armor ?? "Armor", e2.keyItem ?? "Key Item", e2.equip2 ?? "Equip2", e2.optimize ?? "Optimize", e2.clear ?? "Clear", e2.newGame ?? "New Game", e2.continue_ ?? "Continue", t2, e2.toTitle ?? "To Title", e2.cancel ?? "Cancel", t2, e2.buy ?? "Buy", e2.sell ?? "Sell"], ue = (e2, t2) => "string" == typeof e2 ? e2 : t2, ye = (e2) => {
  return { basic: de(e2.basic ?? {}), commands: (a2 = e2.commands ?? {}, le(a2, "")), params: H(e2.params ?? {}), messages: (t2 = e2.messages ?? {}, {
    actionFailure: ue(t2.actionFailure, "Action failed."),
    actorDamage: ue(t2.actorDamage, "%1 took %2 damage."),
    actorRecovery: ue(t2.actorRecovery, "%1 recovered %2 HP."),
    actorGain: ue(t2.actorGain, "%1 gained %2."),
    actorLoss: ue(t2.actorLoss, "%1 lost %2."),
    actorDrain: ue(t2.actorDrain, "%1 drained %2 HP."),
    actorNoDamage: ue(t2.actorNoDamage, "%1 was not damaged."),
    actorNoHit: ue(t2.actorNoHit, "%1 was not hit."),
    alwaysDash: ue(t2.alwaysDash, "Always dash."),
    bgmVolume: ue(t2.bgmVolume, "BGM volume"),
    bgsVolume: ue(t2.bgsVolume, "BGS volume"),
    commandRemember: ue(t2.commandRemember, "Command remember."),
    criticalToActor: ue(t2.criticalToActor, "%1 dealt %2 damage to %3."),
    criticalToEnemy: ue(t2.criticalToEnemy, "%1 dealt %2 damage to %3."),
    counterAttack: ue(t2.counterAttack, "%1 countered!"),
    debuffAdd: ue(t2.debuffAdd, "%1's %2 was lowered."),
    defeat: ue(t2.defeat, "Defeat."),
    enemyDamage: ue(t2.enemyDamage, "%1 took %2 damage."),
    enemyDrain: ue(t2.enemyDrain, "%1 drained %2 HP."),
    enemyGain: ue(t2.enemyGain, "%1 gained %2."),
    enemyLoss: ue(t2.enemyLoss, "%1 lost %2."),
    enemyNoDamage: ue(t2.enemyNoDamage, "%1 was not damaged."),
    enemyNoHit: ue(t2.enemyNoHit, "%1 was not hit."),
    enemyRecovery: ue(t2.enemyRecovery, "%1 recovered %2 HP."),
    evasion: ue(t2.evasion, "%1 evaded the attack!"),
    autosave: ue(t2.autosave, "Autosave"),
    escapeFailure: ue(t2.escapeFailure, "Escape failed."),
    escapeStart: ue(t2.escapeStart, "%1 started to escape!"),
    emerge: ue(t2.emerge, "%1 appeared!"),
    expNext: ue(t2.expNext, "Next level in %1 EXP."),
    expTotal: ue(t2.expTotal, "Total EXP: %1"),
    file: ue(t2.file, "File"),
    buffAdd: ue(t2.buffAdd, "%1's %2 was raised."),
    buffRemove: ue(t2.buffRemove, "%1's %2 was lowered."),
    obtainExp: ue(t2.obtainExp, "%1 EXP obtained."),
    obtainGold: ue(t2.obtainGold, "%1 gold obtained."),
    obtainItem: ue(t2.obtainItem, "%1 obtained %2."),
    obtainSkill: ue(t2.obtainSkill, "%1 learned %2."),
    levelUp: ue(t2.levelUp, "%1 leveled up!"),
    partyName: ue(t2.partyName, "Party"),
    loadMessage: ue(t2.loadMessage, "Load %1?"),
    meVolume: ue(t2.meVolume, "ME volume"),
    possession: ue(t2.possession, "Possession"),
    preemptive: ue(t2.preemptive, "%1 attacked first!"),
    saveMessage: ue(t2.saveMessage, "Save %1?"),
    seVolume: ue(t2.seVolume, "SE volume"),
    magicEvasion: ue(t2.magicEvasion, "%1 evaded the magic!"),
    magicReflection: ue(t2.magicReflection, "%1 reflected the magic!"),
    substitute: ue(t2.substitute, "%1 took the hit!"),
    surprise: ue(t2.surprise, "%1 surprised the enemy!"),
    touchUI: ue(t2.touchUI, "Touch UI"),
    useItem: ue(t2.useItem, "%1 used %2."),
    victory: ue(t2.victory, "Victory!")
  }) };
  var t2, a2;
}, xe = (e2) => e2 ? [...e2] : [], Ee = (e2) => ((e3) => ce(e3))(e2) ? {
  tileSize: e2.tileSize,
  faceSize: e2.faceSize,
  iconSize: e2.iconSize
} : { tileSize: 48, faceSize: 144, iconSize: 32 }, ge = (e2, t2) => e2 ? e2.map(t2) : [], Ie = (e2) => ((e3) => pe(e3))(e2) ? { actorId: e2.actorId, equips: xe(e2.equips), level: e2.level } : {
  actorId: 0,
  equips: [],
  level: 1
}, Ae = (e2, a2, r2 = 0) => ({ code: e2, parameters: [t.makeAudioFileParams(a2)], indent: r2 }), Te = (e2) => [e2.eventId ?? 0], _e = (e2) => [e2.min, e2.max, e2.value], be = (e2) => [e2], Se = (e2, t2 = 0) => ({
  code: 108,
  indent: t2,
  parameters: be(e2)
}), Ce = (e2, t2 = 0) => ({ code: 408, indent: t2, parameters: be(e2) }), Ne = (e2) => [e2.variableId ?? 0, e2.digits ?? 0], fe = (e2, t2 = 0) => ({
  code: 355,
  indent: t2,
  parameters: [e2]
}), Oe = (e2, t2 = 0) => ({ code: 655, indent: t2, parameters: [e2] }), Re = {
  HP: 0,
  MP: 1,
  MHP: 2,
  MMP: 3,
  ...
  LUK: 9,
  TP: 10
}, he = (e2) => [...e2], ve = (e2) => "string" == typeof e2 || "number" == typeof e2 || "boolean" == typeof e2, Me = new e({ strict: true }), ke = Me.compile({
  type: "object",
  ...
  additionalProperties: false
}), Pe = Me.compile({ type: "object", properties: { code: { type: "number", const: 105 }, indent: { type: "integer", minimum: 0 }, parameters: {
  type: "array",
  minItems: 2,
  maxItems: 2,
  items: [{ type: "number" }, { type: "boolean" }]
} }, required: ["code", "indent", "parameters"] }), Le = Me.compile({ type: "object", required: ["code", "parameters", "indent"], properties: { indent: {
  type: "integer",
  minimum: 0
...
} }, additionalProperties: false }), De = Me.compile({
  type: "object",
  required: ["code", "parameters", "indent"],
  ...
  additionalProperties: false
}), Fe = (e2) => De(e2), we = Me.compile({ type: "object", properties: { code: { type: "number", const: 117 }, indent: {
  type: "integer",
  minimum: 0
}, parameters: { type: "array", minItems: 1, maxItems: 1, items: [{ type: "number", minimum: 0, default: 0 }] } }, required: ["code", "indent", "parameters"] }), He = Me.compile({ type: "object", properties: {
...
}, required: ["code", "indent", "parameters"] }), Be = Me.compile({ type: "object", properties: { code: { type: "number", const: 402 }, indent: {
  type: "integer",
  minimum: 0
}, parameters: { type: "array", minItems: 2, maxItems: 2, items: [{ type: "integer" }, { type: "string" }] } }, required: ["code", "indent", "parameters"] }), Ge = Me.compile({
  type: "object",
...
}), Ue = Me.compile({ type: "object", required: ["code", "parameters", "indent"], properties: { code: { type: "integer", const: 101 }, indent: {
  type: "integer",
  minimum: 0
  ...
  type: "string"
}], minItems: 5, maxItems: 5 } } }), Ve = (e2, t2) => ({ type: "array", items: t2, ...qe(e2), ...je(e2.default) }), qe = (e2) => ({
  ..."string" == typeof e2.text ? { title: e2.text } : {},
  ..."string" == typeof e2.desc ? { description: e2.desc } : {}
}), je = (e2) => void 0 !== e2 ? { default: e2 } : {}, We = (e2) => void 0 === e2 || 0 === e2, Ye = (e2) => Ve(e2, { type: "string" }), ze = (e2) => {
  switch (e2.kind) {
    case "string":
    case "multiline_string":
      return ((e3) => ({ type: "string", ...qe(e3), ...je(e3.default) }))(e2);
    case "file":
    case "combo":
      return ((e3) => ({ type: "string", ...je(e3.default), ...qe(e3) }))(e2);
    case "select":
      return ((e3) => ({ type: "string", ...je(e3.default), ...qe(e3), ...e3.options ? { enum: e3.options.map((e4) => e4.value) } : {} }))(e2);
    case "file[]":
    case "string[]":
    case "multiline_string[]":
      return Ye(e2);
    case "number[]":
      return ((e3) => ({ type: "array", items: { type: We(e3.decimals) ? "integer" : "number" }, ...je(e3.default), ...qe(e3) }))(e2);
    case "actor[]":
    case "weapon[]":
    case "armor[]":
    case "skill[]":
    ...
    case "class[]":
    case "troop[]":
      return ((e3) => Ve(e3, { type: "integer" }))(e2);
    case "number":
      return ((e3) => ({
        type: We(e3.decimals) ? "integer" : "number",
        ...je(e3.default),
        ...qe(e3)
      }))(e2);
    case "actor":
    ...
    case "boolean":
      return ((e3) => ({ type: "boolean", ...je(e3.default), ...qe(e3) }))(e2);
    case "struct":
      return { $ref: `#/definitions/${(t2 = e2).struct}`, ...qe(t2) };
    default:
      return {};
  }
  var t2;
}, Xe = (e2, t2) => Object.entries(t2).reduce((t3, [a2, r2]) => {
  if (a2 in e2) {
    const o2 = e2[a2];
  ...
  ...Xe(a2, r2),
  kind: e2
}), Je = (e2, t2, a2) => ({ default: [], ...Xe(t2, a2), kind: e2 }), $e = "help", Ze = "kind", Qe = "text", et = "struct", tt = (e2) => {
  const t2 = JSON.parse(e2);
  return Array.isArray(t2) ? t2.map(at) : "object" == typeof t2 && null !== t2 ? Object.fromEntries(Object.entries(t2).map(([e3, t3]) => [e3, at(t3)])) : t2;
}, at = (e2) => {
  ...
  if (Ze in e2.attr) {
    const t2 = dt[e2.attr.kind];
    if (t2) return t2(e2);
  }
  return Ke("any", "", e2.attr, st);
}, ot = (e2) => e2, it = (e2) => e2.replace("[", "").replace("]", "").split(",").map((e3) => parseFloat(e3.replaceAll('"', "").trim())).filter((e3) => !isNaN(e3)), st = {
  default: ot,
  text: ot,
  desc: ot,
  parent: ot
}, nt = (e2) => Ke("string", "", e2.attr, st), mt = (e2) => {
  const t2 = { default: (e3) => tt(e3), text: ot, desc: ot, parent: ot };
  return Je("string[]", e2.attr, t2);
}, pt = (e2, t2) => {
  const a2 = {
    default: it,
    text: ot,
  ...
  return Je(t2, e2.attr, a2);
}, ct = (e2, t2) => {
  const a2 = { default: (e3) => parseInt(e3, 10), text: ot, desc: ot, parent: ot };
  return Ke(t2, 0, e2.attr, a2);
}, dt = {
  number: (e2) => ((e3) => {
    const t2 = {
    ...
    return Ke("number", 0, e3.attr, t2);
  })(e2),
  "number[]": (e2) => {
    const t2 = { default: it, text: ot, desc: ot, decimals: (e3) => parseInt(e3, 10), min: (e3) => parseFloat(e3), max: (e3) => parseFloat(e3), parent: ot };
    return Je("number[]", e2.attr, t2);
  },
  string: nt,
  "string[]": mt,
  multiline_string: nt,
  ...
  combo: (e2) => {
    ...
    return { ...Ke("combo", "", e2.attr, st), options: t2 };
  },
  select: (e2) => {
    var _a;
    const t2 = ((_a = e2.options) == null ? void 0 : _a.map((e3) => ({ option: e3.option, value: e3.value }))) ?? [];
    return { ...Ke("select", "", e2.attr, st), options: t2 };
  },
  actor: (e2) => ct(e2, "actor"),
  "actor[]": (e2) => pt(e2, "actor[]"),
  class: (e2) => ct(e2, "class"),
  "class[]": (e2) => pt(e2, "class[]"),
  skill: (e2) => ct(e2, "skill"),
  "skill[]": (e2) => pt(e2, "skill[]"),
  item: (e2) => ct(e2, "item"),
  "item[]": (e2) => pt(e2, "item[]"),
  weapon: (e2) => ct(e2, "weapon"),
  "weapon[]": (e2) => pt(e2, "weapon[]"),
  armor: (e2) => ct(e2, "armor"),
  "armor[]": (e2) => pt(e2, "armor[]"),
  state: (e2) => ct(e2, "state"),
  "state[]": (e2) => pt(e2, "state[]"),
  enemy: (e2) => ct(e2, "enemy"),
  "enemy[]": (e2) => pt(e2, "enemy[]"),
  common_event: (e2) => ct(e2, "common_event"),
  "common_event[]": (e2) => pt(e2, "common_event[]"),
  switch: (e2) => ct(e2, "switch"),
  "switch[]": (e2) => pt(e2, "switch[]"),
  variable: (e2) => ct(e2, "variable"),
  "variable[]": (e2) => pt(e2, "variable[]"),
  troop: (e2) => ct(e2, "troop"),
  "troop[]": (e2) => pt(e2, "troop[]"),
  boolean: (e2) => {
    const t2 = {
      default: (e3) => "true" === e3,
      text: ot,
    ...
    return Ke("boolean", true, e2.attr, t2);
  },
  file: (e2) => {
    const t2 = { default: ot, text: ot, desc: ot, parent: ot, dir: ot };
    return { dir: "", ...Ke("file", "", e2.attr, t2) };
  },
  "file[]": (e2) => {
    const t2 = { default: (e3) => tt(e3), text: ot, desc: ot, parent: ot, dir: ot };
    return { dir: "", ...Je("file[]", e2.attr, t2) };
  }
}, lt = "BODY", ut = "STRUCT", yt = "NONE", xt = (e2, t2) => {
  const a2 = e2.lines.length > 0 ? gt(e2) : e2, r2 = t2[1] || void 0;
  return { ...a2, structName: r2, blockType: r2 ? ut : "INVALID", locale: t2[2], lines: [] };
}, Et = (e2) => ({
  ...e2.lines.length > 0 ? gt(e2) : e2,
  blockType: lt,
  structName: void 0,
  locale: void 0,
  lines: []
}), gt = (e2) => e2.blockType === lt ? { ...e2, bodies: e2.bodies.concat([{ lines: [...e2.lines] }]), lines: [], blockType: yt } : e2.structName && e2.blockType === ut ? {
  ...e2,
  ...
  structName: void 0,
  lines: []
}, It = (e2) => e2.currentOption ? { items: e2.items.concat({ option: e2.currentOption, value: e2.currentOption }) } : e2, At = (e2) => ({
  ..."string" == typeof e2.desc ? { desc: e2.desc } : {},
  ..."string" == typeof e2.text ? { text: e2.text } : {}
}), Tt = (e2) => {
  const t2 = _t(e2), a2 = St(t2);
  return bt(a2);
}, _t = (e2) => {
  if (e2.currentParam && e2.currentOption) {
    const t2 = e2.currentParam.attr.kind;
    if ("select" === t2 || "combo" === t2) return { ...e2, currentParam: { ...e2.currentParam, options: It(e2.currentOption).items } };
  }
  return e2;
}, bt = (e2) => e2.currentParam ? {
  ...e2,
  ...
  if (e2.currentCommand) {
    const t2 = e2.currentParam ? [...e2.currentCommand.args, e2.currentParam] : e2.currentCommand.args, a2 = { ...At(e2.currentCommand), command: e2.currentCommand.command, args: t2 };
    return {
      ...e2,
  ...
  const a2 = e2.lines.reduce((e3, a3) => {
    ...
    if (!r2.startsWith("@")) return e3.currentContext === $e ? { ...e3, helpLines: e3.helpLines.concat(r2) } : e3;
  ...
  const a2 = ((e3) => {
    const t3 = e3.split("\n"), a3 = {
      ...
      return r4 ? xt(e4, r4) : "/*:" === a4 ? Et(e4) : "*/" === a4 ? e4.lines.length > 0 ? gt(e4) : e4 : { ...e4, lines: e4.lines.concat([a4]) };
    }, a3);
  ...
  meta: {}
}), Ot = (e2, t2, a2) => e2.currentParam && !(t2 in e2.currentParam.attr) ? {
  ...e2,
  currentParam: { ...e2.currentParam, attr: { ...e2.currentParam.attr, [t2]: a2 } }
} : e2, Rt = (e2, t2, a2) => ({ ...e2, meta: { [t2]: a2, ...e2.meta } }), ht = {
  param: (e2, t2) => {
    const a2 = Tt(e2);
    return a2.params.some((e3) => e3.name === t2) ? a2 : { ...a2, currentContext: "param", currentParam: { name: t2, attr: {} } };
  },
  text: (e2, t2) => e2.currentParam ? Ot(e2, Qe, t2) : e2.currentCommand && !(Qe in e2.currentCommand) ? { ...e2, currentCommand: {
    ...At(e2.currentCommand),
    command: e2.currentCommand.command,
    args: e2.currentCommand.args,
    [Qe]: t2
  } } : e2,
  desc: (e2, t2) => e2.currentParam ? Ot(e2, "desc", t2) : e2.currentCommand ? { ...e2, currentCommand: { ...e2.currentCommand, desc: t2 } } : e2,
  command: (e2, t2) => {
    const a2 = Tt(e2);
  ...
  help: (e2) => ({ ...Tt(e2), currentContext: $e }),
  option: (e2, t2) => {
  ...
  type: (e2, t2) => {
    if (((e3) => e3.endsWith(">") && e3.startsWith("struct<"))(t2)) {
      const a2 = t2.slice(7, -1), r2 = Ot(e2, et, a2);
      return Ot(r2, Ze, et);
    }
    return e2.currentParam ? Ot(e2, Ze, t2) : e2;
  },
  default: (e2, t2) => Ot(e2, "default", t2),
  on: (e2, t2) => Ot(e2, "on", t2),
  off: (e2, t2) => Ot(e2, "off", t2),
  min: (e2, t2) => Ot(e2, "min", t2),
  max: (e2, t2) => Ot(e2, "max", t2),
  base: (e2, t2) => {
...
exports.ABORT_BATTLE = 340, exports.BATTLE_PROCESSING = 301, exports.CHANGE_ACTOR_IMAGES = 322, exports.CHANGE_ARMORS = 128, exports.CHANGE_BATTLE_BACKGROUND = 283, exports.CHANGE_BATTLE_BGM = 132, exports.CHANGE_CLASS = 321, exports.CHANGE_DEFEAT_ME = 139, exports.CHANGE_ENCOUNTER = 136, exports.CHANGE_ENEMY_HP = 331, exports.CHANGE_ENEMY_MP = 332, exports.CHANGE_ENEMY_STATE = 333, exports.CHANGE_ENEMY_TP = 342, exports.CHANGE_EXP = 315, exports.CHANGE_FORMATION_ACCESS = 137, exports.CHANGE_GOLD = 125, exports.CHANGE_HP = 311, exports.CHANGE_ITEMS = 126, exports.CHANGE_MENU_ACCESS = 135, exports.CHANGE_MP = 312, exports.CHANGE_NAME = 320, exports.CHANGE_NICKNAME = 324, exports.CHANGE_PARALLAX = 284, exports.CHANGE_PARTY_MEMBER = 129, exports.CHANGE_PLAYER_FOLLOWERS = 216, exports.CHANGE_PROFILE = 325, exports.CHANGE_SAVE_ACCESS = 134, exports.CHANGE_TILESET = 282, exports.CHANGE_TP = 313, exports.CHANGE_TRANSPARENCY = 211, exports.CHANGE_VEHICLE_BGM = 140, exports.CHANGE_VEHICLE_IMAGE = 323, exports.CHANGE_VICTORY_ME = 133, exports.CHANGE_WEAPONS = 127, exports.CHANGE_WINDOW_COLOR = 138, exports.COMMENT_BODY = 408, exports.COMMENT_HEAD = 108, exports.COMMON_EVENT = 117, exports.CONDITIONAL_BRANCH = 111, exports.CONDITIONAL_BRANCH_ELSE = 411, exports.CONTROL_SELF_SWITCH = 123, exports.CONTROL_SWITCHES = 121, exports.CONTROL_TIMER = 124, exports.CONTROL_VARIABLES = 122, exports.DEFAULT_DAMAGE_LABELS = c, exports.DEFAULT_GLOBAL_LABELS = O, exports.DEFAULT_ITEM_LABELS = { title: "アイテム", options: { consumable: "消耗品" } }, exports.DEFAULT_SKILL_LABELS = { title: "スキル", options: {
  ...
  code: e2.code,
  indent: e2.indent,
  parameters: he(e2.parameters)
}), exports.cloneParameters = he, exports.convertCommentArrayToObject = (e2) => ({ comment: e2[0] }), exports.createActorControlChars = (e2) => e2.map((e3) => ({
  text: e3.name,
  controlChar: a("N", e3.id)
})), exports.createControlCharFormat = a, exports.createEventCommand = (e2, t2, a2 = 0) => ({ code: e2, indent: a2, parameters: t2 }), exports.createNoteEntity = C, exports.createSystemVariableControlChars = (e2) => e2.variables.map((e3, t2) => ({ text: e3 || "", controlChar: a("V", t2) })).filter((e3) => "" !== e3.text), exports.formatItemEffectText = (e2, t2, a2) => {
  ...
  name: e3,
  id: t2
})), exports.getSaveCommandEnabled = (e2) => e2.menuCommands[5], exports.getSkillCommandEnabled = (e2) => e2.menuCommands[1], exports.getStatusCommandEnabled = (e2) => e2.menuCommands[3], exports.getWeaponCategoryEnabled = (e2) => e2.itemCategories[1], exports.isCloneableCommand = (e2) => e2.parameters.every(ve), exports.isCommandChangeActorText = (e2) => ke(e2), exports.isCommandCommentBody = (e2) => Fe(e2) && 408 === e2.code, exports.isCommandCommentHeader = (e2) => Fe(e2) && 108 === e2.code, exports.isCommandCommonEvent = (e2) => we(e2), exports.isCommandInputNumber = (e2) => Ge(e2), exports.isCommandNonParam = (e2) => Le(e2), exports.isCommandScriptBody = (e2) => Fe(e2) && 655 === e2.code, exports.isCommandScriptHeader = (e2) => Fe(e2) && 355 === e2.code, exports.isCommandScrollTextHead = (e2) => Pe(e2), exports.isCommandShowChoiceItem = (e2) => Be(e2), exports.isCommandShowChoices = (e2) => He(e2), exports.isCommandShowMessage = (e2) => Ue(e2), exports.isCommandShowMessageBody = (e2) => Fe(e2) && 401 === e2.code, exports.isCommandShowScrollingTextBody = (e2) => Fe(e2) && 405 === e2.code, exports.isCommandTextBody = Fe, exports.isDataMap = (e2) => m(e2), exports.isDataMapInfo = (e2) => n(e2), exports.isDataSystem = (e2) => me(e2), exports.labelsRegistry = () => ({ rpg: { damage: c, data: p, traits: g, itemEffect: S }, global: O }), exports.makeActorData = (e2 = {}) => ({
  name: e2.name ?? "",
  id: e2.id ?? 0,
  ...
  price: e2.price ?? 0
}), exports.makeAudioCommand = (e2, a2) => Ae(e2, t.makeAudioFileParams({ name: a2 })), exports.makeBooleanOptions = P, exports.makeClassData = (e2 = {}) => ({ name: e2.name ?? "", id: e2.id ?? 0, traits: [], note: e2.note ?? "", params: [0, 0, 0, 0, 0, 0, 0, 0], learnings: e2.learnings ?? [], expParams: e2.expParams ?? [] }), exports.makeCommandAudioAny = Ae, exports.makeCommandChangeActorName = (e2, t2 = 0) => ({ code: 320, parameters: [e2.actorId, e2.name], indent: t2 }), exports.makeCommandChangeActorNickName = (e2, t2 = 0) => ({
  code: 324,
  parameters: [e2.actorId, e2.nickname],
  indent: t2
}), exports.makeCommandChangeActorProfile = (e2, t2 = 0) => ({ code: 325, parameters: [e2.actorId, e2.profile], indent: t2 }), exports.makeCommandChangeBattleBGM = (e2, t2 = 0) => Ae(132, e2, t2), exports.makeCommandChangeDefeatME = (e2, t2 = 0) => Ae(139, e2, t2), exports.makeCommandChangeVictoryME = (e2, t2 = 0) => Ae(133, e2, t2), exports.makeCommandCommentBody = Ce, exports.makeCommandCommentHeader = Se, exports.makeCommandCommonEvent = (e2, t2 = 0) => ({ code: 117, indent: t2, parameters: Te(e2 ?? {}) }), exports.makeCommandControlSwitches = (e2, t2 = 0) => ({ code: 121, indent: t2, parameters: _e(e2) }), exports.makeCommandInputNumber = (e2, t2 = 0) => ({ code: 103, indent: t2, parameters: Ne(e2 ?? {}) }), exports.makeCommandPlayBGM = (e2, t2 = 0) => Ae(241, e2, t2), exports.makeCommandPlayBGS = (e2, t2 = 0) => Ae(245, e2, t2), exports.makeCommandPlayME = (e2, t2 = 0) => Ae(249, e2, t2), exports.makeCommandPlaySE = (e2, t2 = 0) => Ae(250, e2, t2), exports.makeCommandScriptArray = (e2, t2 = 0) => e2.map((e3, a2) => 0 === a2 ? fe(e3, t2) : Oe(e3, t2)), exports.makeCommandScriptBody = Oe, exports.makeCommandScriptHeader = fe, exports.makeCommandSetupChoice = (e2, t2 = 0) => ({
  code: 102,
  indent: t2,
  ...
  indent: t2,
  parameters: [e2]
}), exports.makeCommentArray = be, exports.makeCommentCommandArray = (e2, t2 = 0) => e2.map((e3, a2) => 0 === a2 ? Se(e3, t2) : Ce(e3, t2)), exports.makeCommonEventData = (e2 = {}) => ({
  id: e2.id ?? 0,
  name: e2.name ?? "",
  trigger: e2.trigger ?? 0,
  list: e2.list ?? [],
  switchId: e2.switchId ?? 0
}), exports.makeDamage = d, exports.makeDataNames = F, exports.makeDropItem = l, exports.makeEditorSetting = G, exports.makeEnemyAction = (e2 = {}) => ({
...
}), exports.makeItemCategories = v, exports.makeItemCategoriesFromArray = (e2) => ({ item: e2[0], weapon: e2[1], armor: e2[2], keyItem: e2[3] }), exports.makeItemData = (e2 = {}) => ({
  ...
  var t2;
}, exports.makeMenuCommandsEnabled = M, exports.makeMenuCommandsEnabledFromArray = (e2) => ({ item: e2[0], skill: e2[1], equip: e2[2], status: e2[3], formation: e2[4], save: e2[5] }), exports.makeParamNamesArray = H, exports.makeRegex = N, exports.makeSkillData = (e2 = {}) => ({
  ...
  tpCost: e2.tpCost ?? 0,
  tpGain: e2.tpGain ?? 0
}), exports.makeSoundsArray = h, exports.makeSoundsObject = (e2) => ({
  cursor: e2[0],
  ok: e2[1],
  cancel: e2[2],
  buzzer: e2[3],
...
}), exports.makeSystemAdvanced = R, exports.makeSystemData = (e2) => {
  ...
  return {
    ...
    sounds: h(e2.sounds),
    editor: G(e2.editing),
    advanced: R(e2.advanced),
    title1Name: ((_c = e2.images) == null ? void 0 : _c.title1Name) ?? "",
    title2Name: ((_d = e2.images) == null ? void 0 : _d.title2Name) ?? "",
    ...F(e2.dataNames ?? {}),
    magicSkills: xe([]),
    airship: B((_e2 = e2.vehicles) == null ? void 0 : _e2.airship),
    boat: B((_f = e2.vehicles) == null ? void 0 : _f.boat),
    ship: B((_g = e2.vehicles) == null ? void 0 : _g.ship),
    ...
    testBattlers: ge((_n = e2.battleTest) == null ? void 0 : _n.testBattlers, Ie),
    ...
    windowTone: [0, 0, 0, 0],
    terms: ye(e2.terms ?? {}),
    itemCategories: v(e2.itemCategories),
    partyMembersArray: xe((_v = e2.gameInit) == null ? void 0 : _v.partyMembersArray),
    battleSystem: 0,
    battlerHue: 0,
    menuCommands: M(e2.menuComamnds)
  };
...
}), exports.makeTroopMember = (e2 = {}) => ({ enemyId: e2.enemyId ?? 0, x: e2.x ?? 0, y: e2.y ?? 0, hidden: e2.hidden ?? false }), exports.makeVehicleData = B, exports.makeWeaponData = (e2 = {}) => ({
  id: e2.id ?? 0,
  name: e2.name ?? "",
  iconIndex: e2.iconIndex ?? 0,
  description: e2.description ?? "",
  ...
  initialLevel: e2.initialLevel ?? 0,
  maxLevel: e2.maxLevel ?? 0
}), exports.pluginSourceToJSON = (e2) => vt(e2), exports.readNote = (e2) => f(e2, (e3, t2) => [e3, t2]), exports.readNoteObject = (e2, t2) => f(e2.note, (a2, r2) => t2(a2, r2, e2)), exports.replaceNote = (e2, t2) => {
  ...
  return e2.replace(r2, (e3, r3) => r3 === t2 ? C(r3, a2) : e3);
