import { aO as Ia, b5 as wa, b6 as ka, aI as Ba, aU as Sa, aZ as B, aP as Aa, aY as Ca, aT as Z, ax as Ea, at as Ma, au as $a, a_ as Pa, a$ as Da } from "./namedItems.es.js";
import { b as Q, q as W, N as aa, E as G, w as z, v as O, aS as C, P as j, Q as _, aP as E, aM as $, aO as H, az as ea, ay as P, aR as ta, as as R } from "./eventCommandCodes.es.js";
import { JSONPathJS as ja } from "jsonpath-js";
import { parseDeepRecord as Ra } from "@sigureya/rmmz-plugin-schema";
import { a as _a, h as La, g as Ua, d as Va } from "./commands.es.js";
import { m as sa } from "./mergeItemsSource.es.js";
const ra = (a, e, t) => a.filter(((s) => s.code === Q || s.code === W || s.code === aa)).map(((s) => Ja(s, e, t))), Fa = {
  [aa]: "weapon",
  [Q]: "armor",
  [W]: "item"
}, Ja = (a, e, t) => {
  const s = Ia(a) ? { direct: !1, variableId: a.parameters[3] } : {
    direct: !0,
    value: a.parameters[3]
  }, r = a.parameters[1] === wa ? e.gain : a.parameters[1] === ka ? e.lose : e.unknown, n = typeof a.parameters[4] == "boolean" ? { includesEquip: a.parameters[4] } : {};
  return {
    itemKind: Fa[a.code],
    dataId: Ba(a),
    code: a.code,
...
}, na = (a) => !!a, dt = (a, e, t) => ({ data: a, eventId: e, pageIndex: t }), qa = (a, e, t) => a.list.map(((s) => ({
  data: s,
  eventId: t.id,
  pageIndex: e
}))), L = (a, e) => a.pages.map(((t, s) => e(t, s, a))), Ga = (a, e) => a.events.filter(na).map(((t) => L(t, e))), ma = (a, e) => a.events.filter(na).flatMap(((t) => L(t, e))), pt = (a, e) => a.map(((t) => L(t, e))), za = (a, e) => a.flatMap(((t) => L(t, e))), ut = (a, e) => a.map(((t) => e(t, 0, t))), gt = (a) => Ga(a, qa).flat(2), oa = (a, e) => {
  const t = e(a.list);
  return { ...a, list: t };
}, ia = (a, e) => ({ ...a, pages: a.pages.map(((t) => oa(t, e))) }), ht = (a, e) => ({
  ...a,
  events: a.events.map(((t) => t ? ia(t, e) : null))
}), yt = (a, e) => a.map(((t) => oa(t, e))), ft = (a, e) => a.map(((t) => ia(t, e))), bt = (a, e, t) => ma(a.map, ((s, r, n) => ({
  ...Oa(s),
  commands: ra(s.list, e, t),
  eventName: n.name,
  pageIndex: r
}))), Oa = (a) => a.conditions.itemId > 0 && a.conditions.itemValid ? { pageCondition: { itemId: a.conditions.itemId } } : {}, vt = (a, e, t) => za(a, ((s, r, n) => ({
  commands: ra(s.list, e, t),
  eventName: n.name,
  troopId: n.id,
  pageIndex: r
  ...
  isTileset: !0,
  isMovie: !0
}), Qa = (a) => [a.noteItems, a.events.map(((e) => e.noteItems))], Wa = (a, e) => ({
  eventId: a.eventId,
  name: a.name,
  ...
  value: t,
  id: a.id
}))), Tt = (a) => S(a, ["name", "nickname", "profile"]), It = (a) => S(a, ["name"]), wt = (a) => S(a, ["name"]), kt = (a) => S(a, ["name", "description", "message1", "message2"]), Bt = (a) => S(a, ["name", "description"]), St = (a) => S(a, ["name", "description"]), At = (a) => S(a, ["name", "description"]), Ct = (a) => S(a, ["name", "message1", "message2", "message3", "message4"]), ne = (a, e) => {
...
`) => Ca(a.note, ((s) => d(s.value, e)), t), _t = (a, e) => da(a, ((t) => ne(t, e))), da = (a, e) => ({
...
const U = (a, e, t, s) => {
  ...
  const { bodies: t, header: s } = ((r, n) => U(r, n, ((m) => m.code === H), ((m) => m.code === E)))(a, e);
  return new Y(E, s, t);
}, ve = (a, e) => {
  const { bodies: t, header: s } = ((r, n) => U(r, n, ((m) => m.code === P), ((m) => m.code === ea)))(a, e);
  return new ua(s, t);
}, xe = (a, e) => {
  const { bodies: t, header: s } = ((r, n) => U(r, n, ((m) => m.code === ta), ((m) => m.code === C)))(a, e);
  return new Y(C, s, t);
}, Ne = {
  [H]: (a, e, t) => t.showMessage(be(a, e), e, a),
  [P]: (a, e, t) => t.script(ve(a, e), e, a),
  [_]: (a, e, t) => t.comment(ye(a, e), e, a),
...
}, ke = (a, e = () => []) => ({ eventId: a.id, commands: V(a.list, e) }), Be = (a, e = () => []) => a.pages.map(((t, s) => ({
  eventId: a.id,
  pageIndex: s,
  commands: V(t.list, e)
...
const Re = (a, e, t, s = xa) => Na(a.attr.struct, `${e}["${a.name}"]`, t, s), _e = (a, e, t, s = xa) => Na(a.attr.struct, `${e}["${a.name}"][*]`, t, s), Le = (a, e, t, s) => ((r) => fa(r.attr))(t) ? Fe(a, t, s) : ba(t) ? Je(a, t, s) : ya(t) ? Ue(a, e, t) : Ve(a, e, t), Ue = (a, e, t) => ({
  rootCategory: a,
  rootName: e,
  ...
  scalars: void 0,
  structs: { items: [], errors: [] }
}), qe = (a, e) => e.map(((t) => Ge(a, t))).flat(3), Ge = (a, e) => [e.top ? F(e, a, e.top, "") : [], e.structs.map(((t) => F(e, a, t))), e.structArrays.map(((t) => F(e, a, t)))], F = (a, e, t, s = t.bundleName) => {
  ...
  return [r, n].flat(2);
}, J = (a, e) => a.scalarsPath ? { bundleName: a.name, arrays: X(a.scalarArrays, a.name, e), scalar: ze(a.scalarsPath, a.objectSchema, e) } : {
  bundleName: a.name,
  arrays: X(a.scalarArrays, a.name, e)
}, X = (a, e, t) => a.map(((s) => ({ jsonPathJS: t(s.path), schema: s.param, parentType: e }))), ze = (a, e, t) => ({ jsonPathJS: t(a), record: e }), Oe = (a, e, t, s) => ({
  pluginName: a,
  ...
  const m = r.scalars ? J(r.scalars, n) : void 0, o = r.structs.items.map(((h) => J(h, n))), i = r.structArrays.items.map(((h) => J(h, n)));
  return {
...
})(Le("args", a.command, s, e), t))), Ye = (a, e) => {
  const t = ((s) => new Map(s.map(((r) => [r.struct, Me(r.params)]))))(a.schema.structs);
  return Ke(a.pluginName, a.schema.commands, t, e);
}, Ke = (a, e, t, s) => e.map(((r) => [`${a}:${r.command}`, Oe(a, r, t, s)])), Xe = (a, e) => {
  const [t, s] = a.parameters, r = `${t}:${s}`, n = e.get(r);
  return n ? ((m, o) => ({ pluginName: o.pluginName, commandName: o.commandName, args: qe(m, o.extractors) }))(Ra(a.parameters[3]), n) : { pluginName: t, commandName: s, args: [] };
}, Vt = (a) => {
  const e = new Map(a);
  return new K(e);
}, Ft = () => new K(/* @__PURE__ */ new Map()), Jt = (a) => {
  const e = a.flatMap(((t) => Ye(t, ((s) => new ja(s)))));
  return new K(new Map(e));
};
class K {
  _commandMap;
  constructor(e) {
...
const Ze = (a) => typeof a.value == "string", qt = (a) => ({
  key: "battlerName",
  image: a.battlerName,
  id: a.id
}), q = (a, e, t) => ({ folder: t, key: e, image: a[e], id: a.id }), Gt = (a) => [q(a, "faceName", "faces"), q(a, "characterName", "characters"), q(a, "battlerName", "sv_actors")], zt = (a) => ({
  ...
  terms: {
    basic: Va(a.terms.basic),
    commands: Ua(a.terms.commands),
    messages: La(a.terms.messages),
    params: _a(a.terms.params)
  }
}), Ot = (a, e, t, s, r, n) => [...Ea(t, s), ...Ma(a, e), ...$a(r, n)], Ht = (a, e) => sa(Da(e), a), Yt = (a, e, t) => {
  const s = Pa(e);
  return sa(t ? [...s, ...t] : s, a);
}, Qe = (a, e, t, s) => {
  if (a.code === E || a.code === C || a.code === j) return;
  const r = ga(a.code);
  return r ? r(t, e, s) : a.code === $ ? We(a) : a.code === O || a.code === z || a.code === G ? at(a) : a.code !== ea ? a : void 0;
}, We = (a) => ({
  code: $,
  indent: a.indent,
  ...
  return ((s) => {
    ...
    return s.map(((n, m) => n.code === R ? n : Qe(n, m, s, r))).filter(((n) => n !== void 0)).flat();
  ...
  switchId: a.switchId,
  list: D(a.list, e)
}), Qt = (a, e) => ({ id: a.id, name: a.name, trigger: a.trigger, switchId: a.switchId, list: D(a.list, {
  pluginCommand: (t) => t,
  scriptCommand: (t) => t,
  replaceText: e
}) }), Wt = (a, e) => Ta(a, { pluginCommand: (t) => t, scriptCommand: (t) => t, replaceText: e, isReplaceTargetNote: () => !1 }), as = (a, e) => Ta(a, e), Ta = (a, e) => ({
  note: B(a.note, e),
