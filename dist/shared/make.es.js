import re from "ajv";
import { c as ue, a as ge, m as s } from "./make.es2.js";
import { aF as be, aJ as Ie, aK as ve, ax as se, ay as ne, az as oe, ae as he, ai as fe, ak as xe, al as Te, F as we, G as Se, P as ke, p as Ne, u as qe, z as N, cY as T, cZ as w, c_ as v, c$ as S, A as q, B as P, C as De, j as Me, aZ as Pe, a_ as Re, au as je, av as Ce, v as u, cX as Ae, cQ as Fe, cU as Ee, cS as Be } from "./make.es3.js";
const Ga = { LEFT: 4, UP: 8, DOWN: 2, RIGHT: 6 }, Ka = (e) => {
  const a = e.split("/");
  return a[a.length - 1];
}, Ua = (e = 0) => ({ code: 314, indent: e, parameters: [0, 0] }), Oa = (e, a = 0) => ({
  code: 314,
  indent: a,
...
}), B = (e, a) => `\\${e}[${a}]`, Za = (e, a) => a.map((t, r) => ({ text: t, controlChar: B(e, r) })), $a = (e) => Array.from(e.matchAll(/\\([A-Za-z]+)\[(\d+)]/g)).map((a) => ({
  char: a[1],
  id: parseInt(a[2], 10)
})), Ja = (e) => e.map((a) => ({ text: a.name, controlChar: B("N", a.id) })), Qa = (e) => e.variables.map((a, t) => ({
  text: a || "",
  controlChar: B("V", t)
})).filter((a) => a.text !== ""), et = (e = {}) => ({ id: e.id ?? 0, name: e.name ?? "", trigger: e.trigger ?? 0, list: e.list ?? [], switchId: e.switchId ?? 0 }), at = (e = {}) => ({
  id: e.id ?? 0,
  name: e.name ?? "",
  members: e.members ?? [],
  pages: e.pages ?? []
}), tt = (e = {}) => ({ enemyId: e.enemyId ?? 0, x: e.x ?? 0, y: e.y ?? 0, hidden: e.hidden ?? !1 }), it = (e = {}) => ({
  actorHp: e.actorHp ?? 0,
  actorId: e.actorId ?? 0,
...
}), rt = 0, st = 1, nt = 2, ot = 3, mt = 4, pt = 5, dt = 6, ct = 7, lt = 8, yt = 9, ut = 10, gt = 11, bt = 12, It = 13, vt = 14, ht = 15, ft = 16, xt = 17, Tt = 18, wt = 19, St = 20, kt = 21, Nt = 22, qt = 23, Dt = 24, Mt = 25, Pt = 26, Rt = 27, jt = 28, Ct = 29, At = 30, Ft = 31, Et = 32, Bt = 33, Vt = 34, zt = 35, Lt = 36, Ht = 37, Wt = 38, Xt = 39, Yt = 40, Gt = 41, Kt = 42, Ut = 43, Ot = 44, _t = 45, Zt = ({ id: e = 1, name: a = "", pages: t = [], note: r = "", x: n = 0, y: o = 0 } = {}) => ({
  id: e,
  name: a,
  pages: t,
  note: r,
  ...
  pattern: r,
  tileId: n
}), $t = ({ list: e = [], conditions: a = Ve(), image: t = ze(), moveFrequency: r = 5, directionFix: n = !1, moveRoute: o = { list: [], repeat: !1, skippable: !1, wait: !1 } } = {}) => ({
  conditions: a,
  list: e,
  directionFix: n,
  image: t,
  ...
  type: "boolean"
}, order: { type: "integer" }, parentId: { type: "integer" }, scrollX: { type: "number" }, scrollY: { type: "number" } } }), We = me.compile(Le), ei = (e) => He(e), ai = (e) => We(e), Xe = {
  actor: {
    title: "アクター",
    options: {
  ...
  title: "ダメージ",
  options: {}
}, V = (e = {}) => ({ type: e.type ?? 0, elementId: e.elementId ?? 0, formula: e.formula ?? "", variance: e.variance ?? 0, critical: e.critical ?? !1 }), ti = (e = {}) => ({
  name: e.name ?? "",
  id: e.id ?? 0,
...
}, Ke = (e = {}) => ({ dataId: e.dataId ?? 0, denominator: e.denominator ?? 0, kind: e.kind ?? 0 }), oi = (e = {}) => ({
  ...
  tpCost: e.tpCost ?? 0,
  tpGain: e.tpGain ?? 0
}), Si = "data", ki = "actor", Ni = "map", qi = "enemy", Di = "state", Mi = "skill", Pi = "item", Ri = "weapon", ji = "armor", Ci = "class", Ai = "common_event", Fi = "troop", Ze = {
  id: "識別子",
  name: "名前",
  note: "メモ",
  description: "説明",
  ...
  noneCollaps: "崩壊なし",
  escape: "逃走"
}, Ei = () => ({ rpg: { damage: Ye, data: Xe, traits: Ue, itemEffect: _e }, global: Ze }), Bi = (e, a = 0) => ({ code: be, parameters: [e.actorId, e.name], indent: a }), Vi = (e, a = 0) => ({
  code: Ie,
  parameters: [e.actorId, e.nickname],
  indent: a
}), zi = (e, a = 0) => ({ code: ve, parameters: [e.actorId, e.profile], indent: a }), x = { direct: 0, variable: 1 }, Li = (e, a = 0) => ({
  code: se,
  indent: a,
  parameters: pe(0, e)
}), Hi = (e, a = 0) => ({ code: se, indent: a, parameters: pe(1, e) }), Wi = (e, a = 0) => ({ code: oe, indent: a, parameters: R(0, e) }), Xi = (e, a = 0) => ({
  code: oe,
  indent: a,
  parameters: R(1, e)
  ...
  indent: a,
  parameters: R(1, e)
}), R = (e, a) => [a.targetType === "variable" ? x.variable : x.direct, a.targetType === "each" ? 0 : a.target, e, x[a.operand.mode], a.operand.value], pe = (e, a) => [a.targetType === "variable" ? x.variable : x.direct, a.targetType === "each" ? 0 : a.target, e, x[a.operand.mode], a.operand.value, a.allowDeath], Ki = (e, a = 0) => ({
  code: 242,
  indent: a,
  parameters: [e.duration]
}), Ui = (e = 0) => ({ code: 243, indent: e, parameters: [] }), Oi = (e = 0) => ({ code: 244, indent: e, parameters: [] }), _i = (e, a = 0) => ({
  code: 246,
  indent: a,
  parameters: [e.duration]
}), Zi = (e, a) => g(e, s({ name: a })), g = (e, a, t = 0) => ({
  code: e,
  parameters: [s(a)],
  indent: t
}), $i = (e, a = 0) => g(he, e, a), Ji = (e, a = 0) => g(fe, e, a), Qi = (e, a = 0) => g(xe, e, a), er = (e, a = 0) => g(Te, e, a), ar = (e, a = 0) => g(we, e, a), tr = (e, a = 0) => g(Se, e, a), ir = (e, a = 0) => g(ke, e, a), $e = {
  plus: 0,
  minus: 1
}, rr = ({ operation: e, time: a }) => ({ code: 124, indent: 0, parameters: [$e[e ?? "plus"] ?? 0, a ?? 0] });
function sr(e, a = 0) {
...
const nr = (e) => ({ enemyId: e[0], newEnemyId: e[1] }), or = (e, a = 0) => ({ code: 333, indent: a, parameters: [e.enemyIndex, 0, e.stateId] }), mr = (e, a = 0) => ({
  ...
  indent: e,
  parameters: [0]
}), lr = (e, a = 0) => ({ code: 334, indent: a, parameters: [e.enemyIndex] }), yr = (e, a = 0) => ({ code: Ne, indent: a, parameters: Je(e ?? {}) }), ur = (e) => ({
  eventId: e[0]
}), Je = (e) => [e.eventId ?? 0], gr = (e) => ({ min: e[0], max: e[1], value: e[2] }), Qe = (e) => [e.min, e.max, e.value], br = (e, a = 0) => ({ code: qe, indent: a, parameters: Qe(e) }), Ir = (e, a = 0) => ({
  code: 103,
  ...
  parameters: [1],
  indent: e
}), Yr = (e = 0) => ({ code: 137, parameters: [0], indent: e }), de = (e) => [e], Gr = (e) => ({ comment: e[0] }), ea = (e, a = 0) => ({ code: De, indent: a, parameters: de(e) }), aa = (e, a = 0) => ({
  code: Me,
  indent: a,
  parameters: de(e)
}), Kr = (e, a = 0) => e.map((t, r) => r === 0 ? ea(t, a) : aa(t, a)), Ur = (e, a = 0) => ({ code: 402, indent: a, parameters: [(e == null ? void 0 : e.index) ?? 0, (e == null ? void 0 : e.name) ?? ""] }), Or = (e) => ({
  index: e[0],
  name: e[1]
}), _r = (e) => [e.index ?? 0, e.name ?? ""], Zr = (e) => ({
  choices: e[0],
  cancelType: e[1],
  defaultType: e[2],
  positionType: e[3],
  background: e[4]
}), $r = (e) => [e.choices ?? [], e.cancelType ?? 0, e.defaultType ?? 0, e.positionType ?? 2, e.background ?? 0], Jr = (e, a = 0) => ({
  code: 102,
  indent: a,
...
}), es = (e, a = 0) => ({ code: 261, indent: a, parameters: [e.filename] }), as = (e) => ({
  filename: e[0]
}), ts = ({ args: e = {}, commandName: a, commandTitle: t = "", pluginName: r }, n = 0) => ({ code: 357, indent: n, parameters: [r, a, t, { ...e }] }), is = (e) => ({
  pluginName: e[0],
  commandName: e[1],
  commandTitle: e[2],
  args: { ...e[3] }
}), rs = (e, a = 0) => ({ code: 129, parameters: [0, e.actorId], indent: a }), ss = (e, a = 0) => ({
  code: 129,
  parameters: [1, e.actorId],
  indent: a
}), ns = ({ pictureId: e = 0, origin: a = 0, name: t = "", x: r = 0, y: n = 0, scaleX: o = 100, scaleY: p = 100, opacity: l = 255, blendMode: y = 0 }) => ({
  code: 231,
  indent: 0,
  parameters: [e, t, a, r, n, o, p, l, y]
}), os = ({ pictureId: e, origin: a, x: t, y: r, scaleX: n, scaleY: o, opacity: p, blendMode: l, wait: y = !1, easingType: D = 0 }) => ({ code: 232, indent: 0, parameters: [e, a, t, r, n, o, p, l, y, D] }), ta = (e, a = 0) => ({
  code: Pe,
  indent: a,
  parameters: [e]
}), ia = (e, a = 0) => ({ code: Re, indent: a, parameters: [e] }), ms = (e, a = 0) => e.map((t, r) => r === 0 ? ta(t, a) : ia(t, a)), ps = 1, ds = 0, M = {
  item: 0,
  weapon: 1,
  armors: 2
}, cs = ({ goods: e, buyOnly: a = !1 }, t = 0) => e.map((r, n) => {
...
}), ls = 0, ys = 1, us = 2, gs = 3, bs = 4, Is = 0, vs = 1, hs = 2, fs = (e, a) => {
  switch (a[6]) {
    case 0:
      return e.hp;
    case 1:
...
}, Ts = (e) => e.parameters[2] === 1, ra = (e, a, t = 0) => [e.startId, e.endId ?? e.startId, t, 3, 3, a.index, a.param], ws = (e, a, t = {}) => ({
  code: u,
  indent: t.indent ?? 0,
  parameters: ra(e, a, t.operation ?? 0)
}), sa = (e, a, t = 0) => [e.startId, e.endId ?? e.startId, t, 3, 2, a.armorId], Ss = (e, a) => ({
  code: u,
  indent: 0,
  parameters: sa(e, a, 0)
}), na = (e, a, t = 0) => [e.startId, e.endId ?? e.startId, t, 0, a.value], ks = (e, a, t = {}) => ({ code: u, indent: t.indent ?? 0, parameters: na(e, a, t.operation ?? 0) }), oa = {
  HP: 0,
  MP: 1,
  MHP: 2,
  MMP: 3,
  ...
  LUK: 9,
  TP: 10
}, ma = (e, a, t = 0) => [e.startId, e.endId ?? e.startId, t, 3, 4, a.index, oa[a.param]], Ns = (e, a, t = {}) => ({
  code: u,
  indent: t.indent ?? 0,
...
}), pa = (e, a, t = 0) => [e.startId, e.endId ?? e.startId, t, 3, 0, a.itemId], da = (e, a, t = 0) => [e.startId, e.endId ?? e.startId, t, 2, a.min, a.max], Ds = (e, a, t = {}) => ({
  code: u,
  indent: t.indent ?? 0,
  parameters: da(e, a, t.operation ?? 0)
}), ca = (e, a, t = 0) => [e.startId, e.endId ?? e.startId, t, 4, a.code], Ms = (e, a, t = {}) => ({
  code: u,
  indent: t.indent ?? 0,
  parameters: ca(e, a, t.operation ?? 0)
}), la = (e, a, t = 0) => [e.startId, e.endId ?? e.startId, t, 3, 1, a.weaponId], Ps = (e, a) => ({ code: u, indent: 0, parameters: la(e, a, 0) }), ya = (e) => [...e], Rs = (e) => ({
  code: e.code,
  indent: e.indent,
  parameters: ya(e.parameters)
}), ua = (e) => typeof e == "string" || typeof e == "number" || typeof e == "boolean", js = (e) => e.parameters.every(ua), Cs = "bgm", As = "se", Fs = "me", Es = "bgs", Bs = "battlebacks1", Vs = "battlebacks2", zs = "characters", Ls = "enemies", Hs = "faces", Ws = "parallaxes", Xs = "pictures", Ys = "sv_actors", Gs = "sv_enemies", Ks = "system", Us = "tilesets", Os = "titles1", _s = "titles2", Zs = "System.json", $s = "Actors.json", Js = "Classes.json", Qs = "Skills.json", en = "Items.json", an = "Weapons.json", tn = "Armors.json", rn = "Enemies.json", sn = "Troops.json", nn = "States.json", on = "Animations.json", mn = "Tilesets.json", pn = "CommonEvents.json", dn = "MapInfos.json", cn = "data", ln = "img", yn = "audio", un = "js", ga = (e = {}) => ({
  gameId: e.gameId ?? 0,
  ...
  useItem: e[22],
  useSkill: e[23]
}), bn = (e) => e.menuCommands[0], In = (e) => e.menuCommands[1], vn = (e) => e.menuCommands[2], hn = (e) => e.menuCommands[3], fn = (e) => e.menuCommands[4], xn = (e) => e.menuCommands[5], Tn = (e) => e.itemCategories[0], wn = (e) => e.itemCategories[1], Sn = (e) => e.itemCategories[2], kn = (e) => e.itemCategories[3], Ia = (e = {}) => [e.item ?? !0, e.weapon ?? !0, e.armor ?? !0, e.keyItem ?? !0], Nn = (e) => ({
  item: e[0],
  weapon: e[1],
  armor: e[2],
  keyItem: e[3]
}), va = (e = {}) => [e.item ?? !0, e.skill ?? !0, e.equip ?? !0, e.status ?? !0, e.formation ?? !0, e.save ?? !0], qn = (e) => ({
  item: e[0],
  skill: e[1],
  equip: e[2],
  status: e[3],
...
}), b = (e) => e ? [...e] : [], Mn = (e) => e.terms.params.map((a, t) => ({
  name: a,
  id: t
})), Pn = (e) => ({ background: e.background ?? 0, offsetX: e.offsetX ?? 0, offsetY: e.offsetY ?? 0 }), A = (e = {}) => ({
  characterIndex: e.characterIndex ?? 0,
  characterName: e.characterName ?? "",
  bgm: s(e.bgm ?? {}),
  startMapId: e.startMapId ?? 0,
...
})([ja, Sa, ka, ha, xa, Na, le, Da, Ma, Pa, qa, Ra]), Fa = j.compile(Aa), Fn = (e) => Fa(e), Ea = j.compile(ye);
j.compile(ce);
const Ba = j.compile(le), En = (e) => {
