import { ParamArray_Comment, ParamObject_Comment, Command_CommentHeader, Command2_CommentBody } from './types';
...
export declare const makeCommentCommandArray: (comments: ReadonlyArray<string>, indent?: number) => [Command_CommentHeader, ...Command2_CommentBody[]];
