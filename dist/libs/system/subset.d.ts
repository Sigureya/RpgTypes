...
export type System_DataNames = Pick<Data_System, "weaponTypes" | "skillTypes" | "elements" | "variables" | "equipTypes" | "switches" | "armorTypes" | "magicSkills">;
...
export type System_BooleanOptions = Pick<Data_System, "optAutosave" | "optDisplayTp" | "optDrawTitle" | "optExtraExp" | "optFloorDeath" | "optFollowers" | "optKeyItemsNumber" | "optSideView" | "optSlipDeath" | "optTransparent" | "optMessageSkip" | "optSplashScreen">;
export type System_Debug = Pick<Data_System, "battlerHue" | "battlerName" | "testBattlers" | "testTroopId" | "editMapId">;
export type System_GameInitial = Pick<Data_System, "startMapId" | "startX" | "startY" | "partyMembersArray">;
