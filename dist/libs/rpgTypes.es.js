...
export {
  ...
  actorSourceId,
  armorSourceId,
  buildArmorTypesSource,
  buildCollapsSource,
  buildElementTypesSource,
  buildEquipTypesSource,
  buildExtraParamSource,
  buildPartyAbilitySource,
  buildRegularParamSource,
  buildSkillTypesSource,
  buildSpecialFlagSource,
  buildSpecialParamSource,
  buildVariableNamesSource,
  buildWeaponTypesSource,
  cloneChoices,
  cloneEventCommand,
  cloneParameters,
  ...
  makeAudioFileParams,
  makeClassData,
  classSourceId as makeClassSourceIdentifier,
  makeCommandAudioAny,
