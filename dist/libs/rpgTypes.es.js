...
const t = (e2 = {}) => ({
  ...
  useItem: e2[22],
  useSkill: e2[23]
}), o = (e2) => [e2.level ?? "Level", e2.levelA ?? "Level", e2.hp ?? "HP", e2.hpA ?? "HP", e2.mp ?? "MP", e2.mpA ?? "MP", e2.tp ?? "TP", e2.tpA ?? "TP", e2.experience ?? "EXP", e2.exp ?? "EXP"], m = (e2) => ({
  level: e2[0],
  levelA: e2[1],
  hp: e2[2],
  hpA: e2[3],
  ...
  buy: e2[24],
  sell: e2[25]
}), l = (e2, t2) => "string" == typeof e2 ? e2 : t2, c = (e2) => ({
  actionFailure: l(e2.actionFailure, "Action failed."),
  actorDamage: l(e2.actorDamage, "%1 took %2 damage."),
  actorRecovery: l(e2.actorRecovery, "%1 recovered %2 HP."),
  actorGain: l(e2.actorGain, "%1 gained %2."),
  actorLoss: l(e2.actorLoss, "%1 lost %2."),
  actorDrain: l(e2.actorDrain, "%1 drained %2 HP."),
  actorNoDamage: l(e2.actorNoDamage, "%1 was not damaged."),
  actorNoHit: l(e2.actorNoHit, "%1 was not hit."),
  alwaysDash: l(e2.alwaysDash, "Always dash."),
  bgmVolume: l(e2.bgmVolume, "BGM volume"),
  bgsVolume: l(e2.bgsVolume, "BGS volume"),
  commandRemember: l(e2.commandRemember, "Command remember."),
  criticalToActor: l(e2.criticalToActor, "%1 dealt %2 damage to %3."),
  criticalToEnemy: l(e2.criticalToEnemy, "%1 dealt %2 damage to %3."),
  counterAttack: l(e2.counterAttack, "%1 countered!"),
  debuffAdd: l(e2.debuffAdd, "%1's %2 was lowered."),
  defeat: l(e2.defeat, "Defeat."),
  enemyDamage: l(e2.enemyDamage, "%1 took %2 damage."),
  enemyDrain: l(e2.enemyDrain, "%1 drained %2 HP."),
  enemyGain: l(e2.enemyGain, "%1 gained %2."),
  enemyLoss: l(e2.enemyLoss, "%1 lost %2."),
  enemyNoDamage: l(e2.enemyNoDamage, "%1 was not damaged."),
  enemyNoHit: l(e2.enemyNoHit, "%1 was not hit."),
  enemyRecovery: l(e2.enemyRecovery, "%1 recovered %2 HP."),
  evasion: l(e2.evasion, "%1 evaded the attack!"),
  autosave: l(e2.autosave, "Autosave"),
  escapeFailure: l(e2.escapeFailure, "Escape failed."),
  escapeStart: l(e2.escapeStart, "%1 started to escape!"),
  emerge: l(e2.emerge, "%1 appeared!"),
  expNext: l(e2.expNext, "Next level in %1 EXP."),
  expTotal: l(e2.expTotal, "Total EXP: %1"),
  file: l(e2.file, "File"),
  buffAdd: l(e2.buffAdd, "%1's %2 was raised."),
  buffRemove: l(e2.buffRemove, "%1's %2 was lowered."),
  obtainExp: l(e2.obtainExp, "%1 EXP obtained."),
  obtainGold: l(e2.obtainGold, "%1 gold obtained."),
  obtainItem: l(e2.obtainItem, "%1 obtained %2."),
  obtainSkill: l(e2.obtainSkill, "%1 learned %2."),
  levelUp: l(e2.levelUp, "%1 leveled up!"),
  partyName: l(e2.partyName, "Party"),
  loadMessage: l(e2.loadMessage, "Load %1?"),
  meVolume: l(e2.meVolume, "ME volume"),
  possession: l(e2.possession, "Possession"),
  preemptive: l(e2.preemptive, "%1 attacked first!"),
  saveMessage: l(e2.saveMessage, "Save %1?"),
  seVolume: l(e2.seVolume, "SE volume"),
  magicEvasion: l(e2.magicEvasion, "%1 evaded the magic!"),
  magicReflection: l(e2.magicReflection, "%1 reflected the magic!"),
  substitute: l(e2.substitute, "%1 took the hit!"),
  surprise: l(e2.surprise, "%1 surprised the enemy!"),
  touchUI: l(e2.touchUI, "Touch UI"),
  useItem: l(e2.useItem, "%1 used %2."),
  victory: l(e2.victory, "Victory!")
}), y = (e2) => [e2.mhp ?? "", e2.mmp ?? "", e2.atk ?? "", e2.def ?? "", e2.mat ?? "", e2.mdf ?? "", e2.agi ?? "", e2.luk ?? "", e2.hit ?? "", e2.eva ?? ""], u = (e2 = {}) => ({
  ...
  startX: e2.startX ?? 0,
  startY: e2.startY ?? 0
}), g = (e2 = {}) => [e2.item ?? true, e2.skill ?? true, e2.equip ?? true, e2.status ?? true, e2.formation ?? true, e2.save ?? true], b = (e2) => ({
  item: e2[0],
  skill: e2[1],
  equip: e2[2],
  status: e2[3],
  formation: e2[4],
  save: e2[5]
}), I = (e2 = {}) => [e2.item ?? true, e2.weapon ?? true, e2.armor ?? true, e2.keyItem ?? true], f = (e2) => ({ item: e2[0], weapon: e2[1], armor: e2[2], keyItem: e2[3] }), v = (e2 = {}) => ({
  jsonFormatLevel: e2.jsonFormatLevel ?? 0,
  messageWidth1: e2.messageWidth1 ?? 816,
  messageWidth2: e2.messageWidth2 ?? 816
}), h = { domainName: "オプション", options: {
...
const T = k.compile({ additionalProperties: false, type: "object", required: ["actorId", "equips", "level"], properties: { actorId: { type: "integer" }, level: {
  type: "integer",
  minimum: 1
}, equips: { type: "array", items: { type: "integer" } } } });
k.compile({ type: "object", additionalProperties: false, required: ["type", "weaponImageId"], properties: { type: {
  type: "number"
}, weaponImageId: { type: "number" } } });
const S = k.compile({ additionalProperties: false, type: "object", required: ["tileSize", "faceSize", "iconSize"], properties: { tileSize: {
  type: "integer",
  minimum: 0
}, faceSize: { type: "integer", minimum: 0 }, iconSize: { type: "integer", minimum: 0 } } }), w = (e2) => {
  ...
  return {
    ...
    armorTypes: q(n2.armorTypes),
    elements: q(n2.elements),
    equipTypes: q(n2.equipTypes),
    weaponTypes: q(n2.weaponTypes),
    skillTypes: q(n2.skillTypes),
    switches: q(n2.switches),
    variables: q(n2.variables),
    magicSkills: P([]),
    airship: u(a2.airship),
    boat: u(a2.boat),
    ship: u(a2.ship),
    defeatMe: i((_c = e2.me) == null ? void 0 : _c.defeatMe),
    gameoverMe: i((_d = e2.me) == null ? void 0 : _d.gameoverMe),
    titleBgm: i(s2.titleBgm),
    tileSize: d2.tileSize,
    faceSize: d2.faceSize,
    iconSize: d2.iconSize,
    versionId: 1,
    attackMotions: [],
    testBattlers: D(o2.testBattlers, E),
    battleBgm: i(s2.battleBgm),
    victoryMe: i((_e2 = e2.me) == null ? void 0 : _e2.victoryMe),
    editMapId: o2.editMapId ?? 0,
    locale: "",
    startMapId: p2.startMapId ?? 0,
    startX: p2.startX ?? 0,
    startY: p2.startY ?? 0,
    testTroopId: o2.testTroopId ?? 0,
    windowTone: [0, 0, 0, 0],
    terms: R(e2.terms ?? {}),
    itemCategories: I(e2.itemCategories),
    partyMembersArray: P(p2.partyMembersArray),
    battleSystem: 0,
    battlerHue: 0,
    battlerName: o2.battlerName ?? "",
    menuCommands: g(e2.menuComamnds)
  };
}, R = (e2) => ({
  basic: o(e2.basic ?? {}),
  commands: p(e2.commands ?? {}),
  params: y(e2.params ?? {}),
  messages: c(e2.messages ?? {})
}), q = (e2) => e2 ? [...e2] : [], P = (e2) => e2 ? [...e2] : [], A = (e2) => ((e3) => S(e3))(e2) ? { tileSize: e2.tileSize, faceSize: e2.faceSize, iconSize: e2.iconSize } : {
  tileSize: 48,
  faceSize: 144,
  iconSize: 32
}, D = (e2, t2) => e2 ? e2.map(t2) : [], E = (e2) => ((e3) => T(e3))(e2) ? { actorId: e2.actorId, equips: P(e2.equips), level: e2.level } : { actorId: 0, equips: [], level: 1 }, M = (e2, t2) => ({
  name: e2,
  id: t2
}), j = (e2) => e2.variables.map(M), H = (e2) => e2.elements.map(M), C = (e2) => e2.equipTypes.map(M), B = (e2) => e2.skillTypes.map(M), F = (e2) => e2.weaponTypes.map(M), V = (e2) => e2.armorTypes.map(M), L = (e2) => e2.switches.map(M), z = "rmmz", W = "colors", G = (e2) => ({
  properties: e2.placeHolders.map((e3) => ({ dataKey: e3, placeHolder: `{${e3}}` })),
  itemMappers: X(e2).map(K)
}), X = (e2) => {
  ...
  if (e2.pattern.length >= i2.formatMaxLength) return {
    formatLabel: e2.label,
    syntaxErrors: [{ message: a2.formatVeryLong, reason: e2.pattern.slice(0, i2.formatMaxLength) }],
    semanticErrors: []
  };
  const r2 = O(e2, t2, a2), n2 = U(e2.pattern, t2, a2, i2.placeHolderMaxLength);
  return { formatLabel: e2.label, syntaxErrors: n2, semanticErrors: r2 };
}, U = (e2, t2, a2, i2) => {
  ...
  module: re,
  kind: "elements"
}), oe = () => ({ author: z, module: re, kind: "armorTypes" }), me = () => ({ author: z, module: re, kind: "equipTypes" }), pe = () => ({ author: z, module: re, kind: "skillTypes" }), se = () => ({
  author: z,
  module: re,
  kind: "switches"
}), de = () => ({ author: z, module: re, kind: "variables" }), le = () => ({
  author: z,
  module: re,
  kind: "weaponTypes"
}), ce = (e2, t2) => [ue(e2, t2), ge(e2, t2), ve(e2, t2), be(e2, t2), ye(e2, t2), Ie(e2, t2), fe(e2, t2)], ye = (e2, t2) => ({ items: V(e2), label: t2.armorTypes, source: oe() }), ue = (e2, t2) => ({
  items: H(e2),
  label: t2.elements,
  source: ne()
}), ge = (e2, t2) => ({ items: C(e2), label: t2.equipTypes, source: me() }), be = (e2, t2) => ({ items: B(e2), label: t2.skillTypes, source: pe() }), Ie = (e2, t2) => ({
  items: j(e2),
  label: t2.variables,
  source: de()
}), fe = (e2, t2) => ({ items: L(e2), label: t2.switches, source: se() }), ve = (e2, t2) => ({
  items: F(e2),
  label: t2.weaponTypes,
  source: le()
}), he = "bgm", xe = "se", Ne = "me", ke = "bgs", Te = "battlebacks1", Se = "battlebacks2", we = "characters", Re = "enemies", qe = "faces", Pe = "parallaxes", Ae = "pictures", De = "sv_actors", Ee = "sv_enemies", Me = "system", je = "tilesets", He = "titles1", Ce = "titles2", Be = "System.json", Fe = "Actors.json", Ve = "Classes.json", Le = "Skills.json", ze = "Items.json", We = "Weapons.json", Ge = "Armors.json", Xe = "Enemies.json", Ke = "Troops.json", Ye = "States.json", $e = "Animations.json", Ue = "Tilesets.json", Oe = "CommonEvents.json", _e = "MapInfos.json", Ze = "data", Je = "img", Qe = "audio", et = "js", tt = 0, at = 1, it = 2, rt = 3, nt = {
  id: "識別子",
  name: "名前",
  note: "メモ",
  description: "説明",
  ...
  noneCollaps: "崩壊なし",
  escape: "逃走"
}, ot = () => ({ author: z, module: La, kind: Xa }), mt = (e2, t2) => ({
  items: pt(e2.options, t2),
  label: e2.domainName,
  source: ot()
}), pt = (e2, t2) => [{ id: 0, name: t2.normal }, { id: 1, name: e2.bossCollaps }, { id: 2, name: e2.instantCollaps }, { id: 3, name: e2.noneCollaps }], st = 0, dt = 1, lt = 2, ct = 3, yt = 4, ut = 5, gt = () => ({
  author: z,
  module: La,
  kind: Ka
}), bt = (e2) => [{ id: 0, name: e2.encounterHalf }, { id: 1, name: e2.encounterNone }, { id: 2, name: e2.cancelSurprise }, { id: 3, name: e2.raisePreemptive }, { id: 4, name: e2.goldDouble }, {
  id: 5,
  name: e2.dropItemDouble
}], It = 0, ft = 1, vt = 2, ht = 3, xt = (e2) => ({ items: kt(e2.options), label: e2.domainName, source: Nt() }), Nt = () => ({ author: z, module: La, kind: Ya }), kt = (e2) => [{ id: 0, name: e2.autoBattle }, {
  id: 1,
  name: e2.guard
}, { id: 2, name: e2.substitute }, { id: 3, name: e2.preventEscape }], Tt = 0, St = 1, wt = 2, Rt = 3, qt = 4, Pt = 5, At = 6, Dt = 7, Et = 8, Mt = 9, jt = () => ({ author: z, module: La, kind: Wa }), Ht = (e2) => ({
  items: Ct(e2.options),
  label: e2.domainName,
  source: jt()
}), Ct = (e2) => [{ id: 0, name: e2.hitRate }, { id: 1, name: e2.evasionRate }, { id: 2, name: e2.criticalRate }, { id: 3, name: e2.criticalEvasionRate }, {
  id: 4,
  ...
  return `?xparams[${e2}]`;
}, Ft = 0, Vt = 1, Lt = 2, zt = 3, Wt = 4, Gt = 5, Xt = 6, Kt = 7, Yt = () => ({ author: z, module: La, kind: za }), $t = (e2) => ({
  items: Ut(e2.options),
  label: e2.domainName,
  source: Yt()
}), Ut = (e2) => [{ id: 0, name: e2.maxHp }, { id: 1, name: e2.maxMp }, { id: 2, name: e2.atk }, { id: 3, name: e2.def }, { id: 4, name: e2.matk }, { id: 5, name: e2.mdef }, { id: 6, name: e2.agi }, {
  id: 7,
  name: e2.luk
}], Ot = (e2, t2) => {
  switch (e2) {
...
}, _t = 0, Zt = 1, Jt = 2, Qt = 3, ea = 4, ta = 5, aa = 6, ia = 7, ra = 8, na = 9, oa = () => ({ author: z, module: La, kind: Ga }), ma = (e2) => ({
  items: pa(e2.options),
  label: e2.domainName,
  source: oa()
}), pa = (e2) => [{ id: 0, name: e2.targetRate }, { id: 1, name: e2.guardEffectRate }, { id: 2, name: e2.recoveryEffectRate }, { id: 3, name: e2.pharmacology }, {
  id: 4,
  name: e2.mpCostRate
}, { id: 5, name: e2.tpChargeRate }, { id: 6, name: e2.physicalDamageRate }, { id: 7, name: e2.magicDamageRate }, { id: 8, name: e2.floorDamageRate }, { id: 9, name: e2.experienceRate }], sa = (e2, t2) => {
  switch (e2) {
    case 9:
  ...
  return `?sparams[${e2}]`;
}, da = "{name}", la = "{name} * {value}%", ca = "{name} + {value}%", ya = "{value}", ua = {
  domainName: "特徴",
  options: {
    regularParam: { domainName: "基本能力値", format: la, options: {
      maxHp: "最大HP",
      maxMp: "最大MP",
      atk: "攻撃力",
      def: "防御力",
    ...
    extraParam: { domainName: "追加能力値", format: ca, options: {
      hitRate: "命中率",
      evasionRate: "回避率",
    ...
    specialParam: { domainName: "特殊能力値", format: la, options: {
      targetRate: "狙われ率",
    ...
    collaps: { domainName: "消滅エフェクト", format: da, options: {
      bossCollaps: "ボス崩壊",
      instantCollaps: "即時崩壊",
      noneCollaps: "崩壊なし"
    } },
    partyAbility: { domainName: "パーティ能力", format: da, options: {
    ...
    elementRate: { domainName: "属性有効度", format: la },
    debuffRate: { domainName: "弱体有効度", format: la },
    stateRate: { domainName: "ステート有効度", format: la },
    stateResist: { domainName: "ステート無効", format: da },
    attackElement: { domainName: "攻撃属性", format: da },
    attackState: { domainName: "攻撃ステート", format: ca },
    attackSpeed: { domainName: "攻撃速度補正", format: ya },
    attackTimes: { domainName: "攻撃追加回数", format: ya },
    actionPlus: { domainName: "行動追加", format: la },
    attackSkill: { domainName: "攻撃スキル", format: da },
    equipWeaponType: { domainName: "装備武器タイプ", format: da },
    equipArmorType: { domainName: "装備防具タイプ", format: da },
    equipLock: { domainName: "装備固定", format: da },
    equipSeal: { domainName: "装備封印", format: da },
    slotType: { domainName: "スロットタイプ", format: da },
    skillAdd: {
      domainName: "スキル追加",
      format: da
    },
    skillSeal: { domainName: "スキルタイプ封印", format: da },
    skillTypeAdd: { domainName: "スキルタイプ追加", format: da },
    skillTypeSeal: { domainName: "スキルタイプ封印", format: da }
  }
}, ga = 11, ba = 12, Ia = 13, fa = 14, va = 21, ha = 22, xa = 23, Na = 31, ka = 32, Ta = 33, Sa = 34, wa = 35, Ra = 41, qa = 42, Pa = 43, Aa = 44, Da = 51, Ea = 52, Ma = 53, ja = 54, Ha = 55, Ca = 61, Ba = 62, Fa = 63, Va = 64, La = "trait", za = "params", Wa = "xparams", Ga = "sparams", Xa = "collaps", Ka = "partyAbiility", Ya = "sflag", $a = (e2, t2) => [$t(e2.regularParam), Ht(e2.extraParam), ma(e2.specialParam), mt(e2.collaps, t2), xt(e2.specialFlag)], Ua = (e2) => [Oa(e2.elementRate), _a(e2.debuffRate), Za(e2.stateRate), Ja(e2.stateResist), Qa(e2.regularParam), ei(e2.extraParam), ti(e2.specialParam), ai(e2.attackElement), ii(e2.attackState), ri(e2.attackSpeed), ni(e2.attackTimes), oi(e2.attackSkill), mi(e2.skillTypeAdd), pi(e2.skillTypeSeal), si(e2.skillAdd), di(e2.skillAdd), li(e2.equipWeaponType), ci(e2.equipArmorType), yi(e2.equipLock), ui(e2.equipSeal), gi(e2.slotType), bi(e2.actionPlus), Ii(e2.specialFlag), fi(e2.collaps), vi(e2.partyAbility)], Oa = (e2) => ({
  format: e2.format,
  label: e2.domainName,
  code: 11,
  dataSource: ne()
}), _a = (e2) => ({ format: e2.format, label: e2.domainName, code: 12, dataSource: Yt() }), Za = (e2) => ({
  format: e2.format,
  label: e2.domainName,
  code: 13,
  dataSource: Yi()
}), Ja = (e2) => ({ format: e2.format, label: e2.domainName, code: 14, dataSource: Yi() }), Qa = (e2) => ({ format: e2.format, label: e2.domainName, code: 21, dataSource: Yt() }), ei = (e2) => ({
  format: e2.format,
  label: e2.domainName,
  code: 22,
  dataSource: jt()
}), ti = (e2) => ({ format: e2.format, label: e2.domainName, code: 23, dataSource: oa() }), ai = (e2) => ({
  format: e2.format,
  label: e2.domainName,
  code: 31,
  dataSource: ne()
}), ii = (e2) => ({ format: e2.format, label: e2.domainName, code: 32, dataSource: Yi() }), ri = (e2) => ({ format: e2.format, label: e2.domainName, code: 33 }), ni = (e2) => ({
  format: e2.format,
  label: e2.domainName,
  code: 34
}), oi = (e2) => ({ format: e2.format, label: e2.domainName, code: 35 }), mi = (e2) => ({ format: e2.format, label: e2.domainName, code: 41, dataSource: pe() }), pi = (e2) => ({
  format: e2.format,
  label: e2.domainName,
  code: 42,
  dataSource: pe()
}), si = (e2) => ({ format: e2.format, label: e2.domainName, code: 43, dataSource: mr() }), di = (e2) => ({
  format: e2.format,
  label: e2.domainName,
  code: 44,
  dataSource: mr()
}), li = (e2) => ({ format: e2.format, label: e2.domainName, code: 51, dataSource: le() }), ci = (e2) => ({ format: e2.format, label: e2.domainName, code: 52, dataSource: oe() }), yi = (e2) => ({
  format: e2.format,
  label: e2.domainName,
  code: 53,
  dataSource: me()
}), ui = (e2) => ({ format: e2.format, label: e2.domainName, code: 54, dataSource: me() }), gi = (e2) => ({
  format: e2.format,
  label: e2.domainName,
  code: 55,
  dataSource: me()
}), bi = (e2) => ({ format: e2.format, label: e2.domainName, code: 61 }), Ii = (e2) => ({ format: e2.format, label: e2.domainName, code: 62, dataSource: Nt() }), fi = (e2) => ({
  format: e2.format,
  label: e2.domainName,
  code: 63,
  dataSource: ot()
}), vi = (e2) => ({ format: e2.format, label: e2.domainName, code: 64, dataSource: gt() }), hi = "Trait", xi = { type: "object", required: ["code", "dataId", "value"], properties: { code: {
  type: "integer"
}, dataId: { type: "integer" }, value: { type: "integer" } } }, Ni = {
  itemMapper: { placeHolder: "name", dataIdKey: "dataId", kindKey: "code", map: [] },
  placeHolders: ["value"],
  itemMappers: []
}, ki = (e2, t2, a2) => {
  const i2 = G(Ni);
  return ie(t2, a2, i2, e2.pattern, (e3) => e3.dataId);
}, Ti = (e2 = {}) => ({
  name: e2.name ?? "",
  id: e2.id ?? 0,
...
}), Si = () => ({ author: z, module: Ri, kind: qi }), wi = {
  type: "object",
...
}, Ri = "data", qi = "actor", Pi = "map", Ai = "enemy", Di = "state", Ei = "skill", Mi = "items", ji = "weapon", Hi = "armor", Ci = "class", Bi = "common_event", Fi = "troop", Vi = (e2 = {}) => ({
  id: e2.id ?? 0,
  name: e2.name ?? "",
  ...
  price: e2.price ?? 0
}), Li = () => ({ author: z, module: Ri, kind: Hi }), zi = {
  type: "object",
...
}), Gi = () => ({ author: z, module: Ri, kind: Ci }), Xi = {
  type: "object",
...
}), Yi = () => ({ author: z, module: Ri, kind: Di }), $i = {
  type: "object",
  ...
  return {
    ...
    dropItems: ((_a2 = e2.dropItems) == null ? void 0 : _a2.map(() => Zi())) ?? [],
    exp: e2.exp ?? 0,
    gold: e2.gold ?? 0,
    traits: [],
    note: e2.note ?? "",
...
}, er = () => ({ author: z, module: Ri, kind: Ai }), tr = {
  type: "object",
...
}, ar = { domainName: "ダメージ", options: {} }, ir = (e2 = {}) => ({
  type: e2.type ?? 0,
...
}, nr = () => ({ author: z, module: Ri, kind: Mi }), or = (e2 = {}) => ({
  animationId: e2.animationId ?? 0,
  id: e2.id ?? 0,
  name: e2.name ?? "",
  iconIndex: e2.iconIndex ?? 0,
...
}, lr = 0, cr = 1, yr = 2, ur = "{name} {value1}%", gr = "{value1}% + {value2}", br = "{name} {value1}ターン", Ir = "{name}", fr = {
  domainName: "使用効果",
  options: { addBuff: {
    desc: "バフを付与する",
    domainName: "バフ付与",
    format: br
  }, addDebuff: { desc: "デバフを付与する", domainName: "デバフ付与", format: br }, gainTp: { desc: "TPを指定した量だけ増加させます。", domainName: "TP増加", format: gr }, grow: {
    desc: "成長効果",
    domainName: "成長効果",
    format: "{name} + {value1}"
  }, learnSkill: { desc: "スキルを習得する", domainName: "スキル習得", format: Ir }, recoverHp: {
    desc: "HPを回復します。最大HPに対する割合と一定値のいずれか一方または両方を指定します。アイテムの場合は、特殊能力値[薬の知識]の倍率が適用されます。",
    domainName: "HP回復",
    format: gr
  }, recoverMp: { desc: "MPを回復します。最大MPに対する割合と一定値のいずれか一方または両方を指定します。アイテムの場合は、特殊能力値[薬の知識]の倍率が適用されます。", domainName: "MP回復", format: gr }, removeBuff: {
    desc: "バフを解除する",
    domainName: "バフ解除",
    format: Ir
  }, removeDebuff: { desc: "デバフを解除する", domainName: "デバフ解除", format: Ir }, removeState: { desc: "指定したステートを付加します。", domainName: "ステート付加", format: ur }, special: {
    desc: "特殊効果",
    domainName: "特殊効果",
    format: Ir
  }, addState: { desc: "状態異常を解除する", domainName: "ステート解除", format: ur }, commonEvent: { desc: "コモンイベントを実行する", domainName: "コモンイベント", format: Ir } }
}, vr = 11, hr = 12, xr = 13, Nr = 21, kr = 22, Tr = 31, Sr = 32, wr = 33, Rr = 34, qr = 41, Pr = 42, Ar = 43, Dr = 44, Er = 0, Mr = (e2) => [Hr(e2), Cr(e2), Br(e2), Fr(e2), Vr(e2), Lr(e2), zr(e2), Wr(e2), Gr(e2), Xr(e2), Kr(e2), Yr(e2)], jr = (e2, t2, a2) => ({
  code: e2,
  label: t2.domainName,
  format: t2.format,
  description: t2.desc,
  dataSource: a2
}), Hr = (e2) => jr(11, e2.recoverHp), Cr = (e2) => jr(12, e2.recoverMp), Br = (e2) => jr(13, e2.gainTp), Fr = (e2) => jr(21, e2.addState, Yi()), Vr = (e2) => jr(22, e2.removeState, Yi()), Lr = (e2) => jr(31, e2.addBuff, Yt()), zr = (e2) => jr(32, e2.addDebuff, Yt()), Wr = (e2) => jr(33, e2.removeBuff, Yt()), Gr = (e2) => jr(34, e2.removeDebuff, Yt()), Xr = (e2) => jr(42, e2.grow, Yt()), Kr = (e2) => jr(43, e2.learnSkill, mr()), Yr = (e2) => jr(44, e2.commonEvent, {
  author: z,
  module: Ri,
  kind: Bi
}), $r = (e2, t2, a2) => {
...
}, Or = { domainName: "スキル", options: { requiredWeaponTypeId1: "必要武器タイプ1", requiredWeaponTypeId2: "必要武器タイプ2", mpCost: "MP消費", tpCost: "TP消費" } }, _r = { domainName: "", options: {
  scope: "範囲",
  speed: "速度補正",
  successRate: "成功率"
} }, Zr = {
...
}), cp = () => ({ id: 1, name: "", pages: [], note: "", x: 0, y: 0 }), yp = () => ({
  characterIndex: 0,
  characterName: "",
  direction: 2,
  pattern: 0,
...
}), gp = { type: "object", required: ["name", "id", "expanded", "order", "parentId", "scrollX", "scrollY"], properties: { name: {
  type: "string"
}, id: { type: "integer", minimum: 0 }, expanded: { type: "boolean" }, order: { type: "integer" }, parentId: { type: "integer" }, scrollX: { type: "integer" }, scrollY: { type: "integer" } } }, bp = (e2 = {
  id: 0
}) => {
  return {
...
}), vp = (e2 = {}) => ({ id: e2.id ?? 0, name: e2.name ?? "", members: e2.members ?? [], pages: e2.pages ?? [] }), hp = (e2 = {}) => ({
  enemyId: e2.enemyId ?? 0,
  x: e2.x ?? 0,
  y: e2.y ?? 0,
  hidden: e2.hidden ?? false
}), xp = (e2 = {}) => ({ actorHp: e2.actorHp ?? 0, actorId: e2.actorId ?? 0, enemyValid: e2.enemyValid ?? 0, switchValid: e2.switchValid ?? 0 }), Np = {
  type: "object",
...
}, Cp = (e2, t2) => `\\${e2}[${t2}]`, Bp = (e2, t2) => t2.map((t3, a2) => ({
  text: t3,
  controlChar: Cp(e2, a2)
})), Fp = (e2) => Array.from(e2.matchAll(/\\([A-Za-z]+)\[(\d+)]/g)).map((e3) => ({ char: e3[1], id: parseInt(e3[2], 10) })), Vp = (e2) => e2.map((e3) => ({
  text: e3.name,
  controlChar: Cp("N", e3.id)
})), Lp = (e2) => e2.variables.map((e3, t2) => ({ text: e3 || "", controlChar: Cp("V", t2) })).filter((e3) => "" !== e3.text), zp = {
  rpg: { damage: ar, data: Zr, traits: ua, itemEffect: fr },
  global: nt
}, Wp = new e(), Gp = Wp.compile({ type: "object", required: ["code", "parameters", "indent"], properties: { code: { type: "integer", enum: [320, 324, 325] }, indent: { type: "integer" }, parameters: {
  type: "array",
  minItems: 2,
  maxItems: 2,
  items: [{ type: "integer", minimum: 0 }, { type: "string" }]
} }, additionalProperties: false }), Xp = (e2) => Gp(e2), Kp = Wp.compile({
  type: "object",
  properties: { code: {
    type: "number",
    const: 105
  }, indent: { type: "integer", minimum: 0 }, parameters: { type: "array", minItems: 2, maxItems: 2, items: [{ type: "number" }, { type: "boolean" }] } },
  required: ["code", "indent", "parameters"]
}), Yp = (e2) => Kp(e2), $p = Wp.compile({
  type: "object",
  required: ["code", "parameters", "indent"],
  properties: { code: {
    type: "integer",
    enum: [132, 133, 139, 241, 245, 249, 250]
  }, indent: { type: "integer" }, parameters: { type: "array", minItems: 1, maxItems: 1, items: [{ type: "object", properties: { name: { type: "string" }, volume: {
    type: "integer"
  }, pitch: { type: "integer" }, pan: { type: "integer" } }, required: ["name", "volume", "pitch", "pan"], additionalProperties: false }] } },
  additionalProperties: false
}), Up = (e2) => $p(e2), Op = Wp.compile({ type: "object", required: ["code", "parameters", "indent"], properties: {
...
}, additionalProperties: false }), _p = (e2) => Op(e2), Zp = Wp.compile({
  type: "object",
  required: ["code", "parameters", "indent"],
  ...
  required: ["code", "indent", "parameters"]
}), es = (e2) => Qp(e2), ts = Wp.compile({ type: "object", properties: { code: { type: "number", const: 102 }, indent: { type: "integer", minimum: 0 }, parameters: { type: "array", minItems: 5, maxItems: 5, items: [{
  type: "array",
  items: { type: "string" }
}, { type: "integer" }, { type: "integer" }, { type: "integer" }, { type: "integer" }] } }, required: ["code", "indent", "parameters"] }), as = (e2) => ts(e2), is = Wp.compile({
  type: "object",
  properties: {
  ...
  required: ["code", "indent", "parameters"]
}), rs = (e2) => is(e2), ns = Wp.compile({ type: "object", properties: { code: { type: "number", const: 103 }, indent: { type: "integer", minimum: 0 }, parameters: {
  type: "array",
  minItems: 2,
  maxItems: 2,
  items: [{ type: "number" }, { type: "number" }]
} }, required: ["code", "indent", "parameters"] }), os = (e2) => ns(e2), ms = Wp.compile({
  type: "object",
  required: ["code", "parameters", "indent"],
...
}), ps = (e2) => ms(e2), ss = (e2) => Jp(e2) && 401 === e2.code, ds = (e2) => Jp(e2) && 405 === e2.code, ls = (e2) => Jp(e2) && 108 === e2.code, cs = (e2) => Jp(e2) && 408 === e2.code, ys = (e2) => Jp(e2) && 355 === e2.code, us = (e2) => Jp(e2) && 655 === e2.code, gs = (e2, t2 = 0) => ({
  code: 320,
  parameters: [e2.actorId, e2.name],
  indent: t2
}), bs = (e2, t2 = 0) => ({ code: 324, parameters: [e2.actorId, e2.nickname], indent: t2 }), Is = (e2, t2 = 0) => ({
  code: 325,
  parameters: [e2.actorId, e2.profile],
  indent: t2
}), fs = (e2, t2) => vs(e2, i({ name: t2 })), vs = (e2, t2, a2 = 0) => ({
  code: e2,
  parameters: [i(t2)],
  indent: a2
}), hs = (e2, t2 = 0) => vs(241, e2, t2), xs = (e2, t2 = 0) => vs(245, e2, t2), Ns = (e2, t2 = 0) => vs(249, e2, t2), ks = (e2, t2 = 0) => vs(250, e2, t2), Ts = (e2, t2 = 0) => vs(132, e2, t2), Ss = (e2, t2 = 0) => vs(133, e2, t2), ws = (e2, t2 = 0) => vs(139, e2, t2), Rs = (e2) => [e2], qs = (e2) => ({
  comment: e2[0]
}), Ps = (e2, t2 = 0) => ({ code: 108, indent: t2, parameters: Rs(e2) }), As = (e2, t2 = 0) => ({
  code: 408,
  indent: t2,
  parameters: Rs(e2)
}), Ds = (e2, t2 = 0) => e2.map((e3, a2) => 0 === a2 ? Ps(e3, t2) : As(e3, t2)), Es = (e2) => [e2.variableId ?? 0, e2.digits ?? 0], Ms = (e2) => ({ variableId: e2[0], digits: e2[1] }), js = (e2, t2 = 0) => ({
  code: 103,
  indent: t2,
  parameters: Es(e2 ?? {})
}), Hs = (e2 = {}) => [(e2 == null ? void 0 : e2.speed) ?? 4, (e2 == null ? void 0 : e2.skip) ?? false], Cs = (e2) => ({ speed: e2[0], skip: e2[1] }), Bs = (e2 = {}, t2 = 0) => ({ code: 105, indent: t2, parameters: Hs(e2) }), Fs = (e2 = "") => [e2], Vs = (e2) => ({ content: e2[0] }), Ls = (e2 = "", t2 = 0) => ({
  code: 405,
  indent: t2 ?? 0,
  parameters: Fs(e2)
}), zs = (e2, t2 = 0) => ({ code: 402, indent: t2, parameters: [(e2 == null ? void 0 : e2.index) ?? 0, (e2 == null ? void 0 : e2.name) ?? ""] }), Ws = (e2) => ({ index: e2[0], name: e2[1] }), Gs = (e2) => [e2.index ?? 0, e2.name ?? ""], Xs = (e2) => ({
  choices: e2[0],
  cancelType: e2[1],
  defaultType: e2[2],
  positionType: e2[3],
  background: e2[4]
}), Ks = (e2) => [e2.choices ?? [], e2.cancelType ?? 0, e2.defaultType ?? 0, e2.positionType ?? 2, e2.background ?? 0], Ys = (e2, t2 = 0) => ({
  code: 102,
  indent: t2,
  ...
  positionType: e2[3],
  speakerName: e2[4]
}), _s = (e2) => [e2.facename, e2.faceIndex, e2.background, e2.positionType, e2.speakerName], Zs = (e2, t2 = 0) => ({ code: 401, indent: t2, parameters: [e2] }), Js = (e2, t2 = 0) => ({
  code: 355,
  indent: t2,
  parameters: [e2]
}), Qs = (e2, t2 = 0) => ({ code: 655, indent: t2, parameters: [e2] }), ed = (e2, t2 = 0) => e2.map((e3, a2) => 0 === a2 ? Js(e3, t2) : Qs(e3, t2)), td = 0, ad = 1, id = 2, rd = 3, nd = 4, od = (e2, t2) => {
  switch (t2[6]) {
    case 0:
      return e2.hp;
    case 1:
  ...
  LUK: 9,
  TP: 10
}, sd = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 0, t2.value], dd = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 1, t2.variableId], ld = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 2, t2.min, t2.max], cd = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 4, t2.code], yd = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 3, t2.type, t2.itemId], ud = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 3, 3, t2.index, t2.param], gd = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 3, 4, t2.index, pd[t2.param]], bd = (e2) => ({
  min: e2[0],
  max: e2[1],
  value: e2[2]
}), Id = (e2) => [e2.min, e2.max, e2.value], fd = (e2, t2 = 0) => ({ code: 121, indent: t2, parameters: Id(e2) }), vd = (e2, t2 = 0) => ({ code: 117, indent: t2, parameters: xd(e2 ?? {}) }), hd = (e2) => ({
  eventId: e2[0]
}), xd = (e2) => [e2.eventId ?? 0], Nd = (e2) => Up(e2) && 241 === e2.code, kd = (e2) => Up(e2) && 245 === e2.code, Td = (e2) => Up(e2) && 249 === e2.code, Sd = (e2) => Up(e2) && 250 === e2.code, wd = (e2) => Up(e2) && 132 === e2.code, Rd = (e2) => Up(e2) && 133 === e2.code, qd = (e2) => Up(e2) && 139 === e2.code, Pd = (e2) => [...e2], Ad = (e2) => ({
  code: e2.code,
  indent: e2.indent,
  parameters: Pd(e2.parameters)
}), Dd = (e2) => "string" == typeof e2 || "number" == typeof e2 || "boolean" == typeof e2, Ed = (e2) => e2.parameters.every(Dd);
export {
  pm as ABORT_BATTLE,
  z as AUTHOR_RMMZ,
