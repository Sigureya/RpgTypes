...
const e = require("ajv"), t = (e2, t2) => `\\${e2}[${t2}]`, a = (e2 = {}) => ({
...
}, m = new e(), p = m.compile(o), n = m.compile(s), d = (e2, t2) => [l(e2.skills, t2), c(e2.actors, t2), y(e2.states, t2), u(e2.armors, t2), g(e2.classes, t2), x(e2.enemies, t2), E(e2.items, t2), A(e2.weapons, t2), T(e2.commonEvents, t2)], l = (e2, t2) => ({
...
}), y = (e2, t2) => ({ items: e2, label: t2.state.domainName, source: { author: "rmmz", module: "data", kind: "state" } }), u = (e2, t2) => ({ items: e2, label: t2.armor.domainName, source: {
  author: "rmmz",
  kind: "armor",
  module: "data"
} }), g = (e2, t2) => ({ items: e2, label: t2.class.domainName, source: { author: "rmmz", module: "data", kind: "class" } }), x = (e2, t2) => ({ items: e2, label: t2.enemy.domainName, source: {
  author: "rmmz",
  module: "data",
  kind: "enemy"
} }), E = (e2, t2) => ({ items: e2, label: t2.item.domainName, source: { author: "rmmz", module: "data", kind: "item" } }), A = (e2, t2) => ({ items: e2, label: t2.weapon.domainName, source: {
  author: "rmmz",
  module: "data",
  kind: "weapon"
} }), T = (e2, t2) => ({ items: e2, label: t2.commonEvent.domainName, source: { author: "rmmz", module: "data", kind: "common_event" } }), I = {
  actor: {
    domainName: "アクター",
    options: {
  ...
  armor: { domainName: "防具", options: {
    armorTypeId: "防具タイプID",
    slotTypeId: "スロットタイプID"
  } },
  enemy: { domainName: "敵キャラ", options: { dropItems: "ドロップアイテム", battlerHue: "バトラーヒュー", battlerName: "バトラー名", gold: "ゴールド" } },
  item: {
    domainName: "アイテム",
    options: { consumable: "消耗品" }
  },
  skill: { domainName: "スキル", options: { requiredWeaponTypeId1: "必要武器タイプ1", requiredWeaponTypeId2: "必要武器タイプ2", mpCost: "MP消費", tpCost: "TP消費" } },
...
}, _ = { domainName: "ダメージ", options: {} }, S = (e2 = {}) => ({
  type: e2.type ?? 0,
  ...
  id: 3,
  name: e2.noneCollaps
}], v = (e2) => ({ items: O(e2.options), label: e2.domainName, source: { author: "rmmz", module: "trait", kind: "xparams" } }), O = (e2) => [{ id: 0, name: e2.hitRate }, { id: 1, name: e2.evasionRate }, {
  id: 2,
...
}, { id: 8, name: e2.mpRegenerationRate }, { id: 9, name: e2.tpRegenerationRate }], L = (e2) => ({ items: P(e2.options), label: e2.domainName, source: {
  author: "rmmz",
  module: "trait",
  kind: "params"
} }), P = (e2) => [{ id: 0, name: e2.maxHp }, { id: 1, name: e2.maxMp }, { id: 2, name: e2.atk }, { id: 3, name: e2.def }, { id: 4, name: e2.matk }, { id: 5, name: e2.mdef }, { id: 6, name: e2.agi }, {
  id: 7,
  name: e2.luk
}], D = (e2) => ({ items: F(e2.options), label: e2.domainName, source: { author: "rmmz", module: "trait", kind: "sparams" } }), F = (e2) => [{ id: 0, name: e2.targetRate }, { id: 1, name: e2.guardEffectRate }, {
  id: 2,
...
}, { id: 9, name: e2.experienceRate }], H = (e2) => ({ items: w(e2.options), label: e2.domainName, source: { author: "rmmz", module: "trait", kind: "partyAbility" } }), w = (e2) => [{
  id: 0,
  name: e2.encounterHalf
}, { id: 1, name: e2.encounterNone }, { id: 2, name: e2.cancelSurprise }, { id: 3, name: e2.raisePreemptive }, { id: 4, name: e2.goldDouble }, { id: 5, name: e2.dropItemDouble }], B = (e2) => ({
  items: G(e2.options),
  label: e2.domainName,
...
}], U = "{name}", q = "{name} * {value}%", V = "{name} + {value}%", Y = "{value}", j = { domainName: "特徴", options: { regularParam: { domainName: "基本能力値", format: q, options: {
  maxHp: "最大HP",
  maxMp: "最大MP",
  atk: "攻撃力",
  def: "防御力",
  ...
  agi: "敏捷性",
  luk: "運"
} }, extraParam: { domainName: "追加能力値", format: V, options: {
  hitRate: "命中率",
  evasionRate: "回避率",
...
} }, specialParam: { domainName: "特殊能力値", format: q, options: {
  targetRate: "狙われ率",
...
}, collaps: { domainName: "消滅エフェクト", format: U, options: {
  bossCollaps: "ボス崩壊",
  instantCollaps: "即時崩壊",
  noneCollaps: "崩壊なし"
} }, partyAbility: { domainName: "パーティ能力", format: U, options: {
...
} }, elementRate: { domainName: "属性有効度", format: q }, debuffRate: { domainName: "弱体有効度", format: q }, stateRate: {
  domainName: "ステート有効度",
  format: q
}, stateResist: { domainName: "ステート無効", format: U }, attackElement: { domainName: "攻撃属性", format: U }, attackState: { domainName: "攻撃ステート", format: V }, attackSpeed: {
  domainName: "攻撃速度補正",
  format: Y
}, attackTimes: { domainName: "攻撃追加回数", format: Y }, actionPlus: { domainName: "行動追加", format: q }, attackSkill: { domainName: "攻撃スキル", format: U }, equipWeaponType: {
  domainName: "装備武器タイプ",
  format: U
}, equipArmorType: { domainName: "装備防具タイプ", format: U }, equipLock: { domainName: "装備固定", format: U }, equipSeal: { domainName: "装備封印", format: U }, slotType: {
  domainName: "スロットタイプ",
  format: U
}, skillAdd: { domainName: "スキル追加", format: U }, skillSeal: { domainName: "スキルタイプ封印", format: U }, skillTypeAdd: { domainName: "スキルタイプ追加", format: U }, skillTypeSeal: {
  domainName: "スキルタイプ封印",
  format: U
} } }, W = (e2, t2) => [L(e2.regularParam), v(e2.extraParam), D(e2.specialParam), f(e2.collaps, t2), B(e2.specialFlag), H(e2.partyAbility)], z = (e2) => e2.map((e3) => ({
  dataKey: e3,
  placeHolder: `{${e3}}`
})), K = (e2) => ({
...
}, /* @__PURE__ */ new Map()), ne = (e2) => e2.map((e3) => ({ id: e3.id, name: e3.name })), de = (e2, t2, a2, r2, o2) => {
  const i2 = ((e3, t3, a3) => {
...
}, ue = (e2) => [Ee(e2), Ae(e2), Te(e2), Ie(e2), _e(e2), Se(e2), Re(e2), be(e2), Ne(e2), xe(e2), Ce(e2), Me(e2), he(e2)], ge = (e2, t2, a2) => ({
  kindId: e2,
  label: t2.domainName,
  pattern: t2.format,
  description: t2.desc,
  ...
  module: "trait",
  kind: "params"
}), be = (e2) => ge(33, e2.removeBuff, { author: "rmmz", module: "trait", kind: "params" }), Ne = (e2) => ge(34, e2.removeDebuff, {
  author: "rmmz",
  module: "trait",
  kind: "params"
}), Ce = (e2) => ge(42, e2.grow, { author: "rmmz", module: "trait", kind: "params" }), Me = (e2) => ge(43, e2.learnSkill, { author: "rmmz", module: "data", kind: "skill" }), he = (e2) => ge(44, e2.commonEvent, {
  author: "rmmz",
  module: "data",
  kind: "common_event"
}), fe = "{name} {value1}%", ke = "{value1}% + {value2}", ve = "{name} {value1}ターン", Oe = "{name}", Le = { domainName: "使用効果", options: { addBuff: {
  desc: "バフを付与する",
  domainName: "バフ付与",
  format: ve
...
}, Fe = new e(), He = Fe.compile(De), we = Fe.compile(Pe), Be = Fe.compile(R), Ge = Fe.compile(b), Ue = Fe.compile(ye), qe = Fe.compile(C), Ve = Fe.compile(h), Ye = Fe.compile(N), je = (e2, t2) => `<${e2}:${t2}>`, We = () => /<([^<>:]{1,100}):([^>]{1,1000})>/g, ze = (e2, t2) => {
  const a2 = /<([^<>:]{1,100}):([^>]{1,1000})>/g;
  return Array.from(e2.matchAll(a2), (e3) => t2(e3[1], e3[2]));
}, Ke = (e2) => [Xe(e2.elementRate), $e(e2.debuffRate), Ze(e2.stateRate), Qe(e2.stateResist), Je(e2.regularParam), et(e2.extraParam), tt(e2.specialParam), at(e2.attackElement), rt(e2.attackState), ot(e2.attackSpeed), it(e2.attackTimes), st(e2.attackSkill), mt(e2.skillTypeAdd), pt(e2.skillTypeSeal), nt(e2.skillAdd), dt(e2.skillSeal), lt(e2.equipWeaponType), ct(e2.equipArmorType), yt(e2.equipLock), ut(e2.equipSeal), gt(e2.slotType), xt(e2.actionPlus), Et(e2.specialFlag), At(e2.collaps), Tt(e2.partyAbility)], Xe = (e2) => ({
  pattern: e2.format,
  label: e2.domainName,
  kindId: 11,
  dataSource: St()
...
}), Ze = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 13, dataSource: It() }), Qe = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 14, dataSource: It() }), Je = (e2) => ({
  pattern: e2.format,
  label: e2.domainName,
  kindId: 21,
  dataSource: { author: "rmmz", module: "trait", kind: "params" }
}), et = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 22, dataSource: {
  author: "rmmz",
  module: "trait",
  kind: "xparams"
} }), tt = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 23, dataSource: { author: "rmmz", module: "trait", kind: "sparams" } }), at = (e2) => ({
  pattern: e2.format,
  label: e2.domainName,
  kindId: 31,
  dataSource: St()
}), rt = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 32, dataSource: It() }), ot = (e2) => ({
  pattern: e2.format,
  label: e2.domainName,
  kindId: 33
}), it = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 34 }), st = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 35, dataSource: _t() }), mt = (e2) => ({
  pattern: e2.format,
  label: e2.domainName,
  kindId: 41,
  dataSource: Rt()
}), pt = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 42, dataSource: Rt() }), nt = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 43, dataSource: _t() }), dt = (e2) => ({
  pattern: e2.format,
  label: e2.domainName,
  kindId: 44,
  dataSource: _t()
}), lt = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 51, dataSource: bt() }), ct = (e2) => ({
  pattern: e2.format,
  label: e2.domainName,
  kindId: 52,
  dataSource: Nt()
}), yt = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 53, dataSource: Ct() }), ut = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 54, dataSource: Ct() }), gt = (e2) => ({
  pattern: e2.format,
  label: e2.domainName,
  kindId: 55,
  dataSource: Ct()
}), xt = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 61 }), Et = (e2) => ({
  pattern: e2.format,
  label: e2.domainName,
  kindId: 62,
  dataSource: { author: "rmmz", module: "trait", kind: "sflag" }
}), At = (e2) => ({ pattern: e2.format, label: e2.domainName, kindId: 63, dataSource: { author: "rmmz", module: "trait", kind: "collaps" } }), Tt = (e2) => ({
  pattern: e2.format,
  label: e2.domainName,
  kindId: 64,
  dataSource: { author: "rmmz", module: "trait", kind: "partyAbility" }
}), It = () => ({ author: "rmmz", module: "data", kind: "state" }), _t = () => ({
  author: "rmmz",
  module: "data",
  kind: "skill"
}), St = () => ({ author: "rmmz", module: "system", kind: "elements" }), Rt = () => ({ author: "rmmz", module: "system", kind: "skillTypes" }), bt = () => ({
  author: "rmmz",
  module: "system",
  kind: "weaponTypes"
}), Nt = () => ({ author: "rmmz", module: "system", kind: "armorTypes" }), Ct = () => ({ author: "rmmz", module: "system", kind: "equipTypes" }), Mt = {
  id: "識別子",
  name: "名前",
  note: "メモ",
  description: "説明",
  ...
  name: e2,
  id: t2
}), zt = (e2) => e2.variables.map(Wt), Kt = (e2) => e2.elements.map(Wt), Xt = (e2) => e2.equipTypes.map(Wt), $t = (e2) => e2.skillTypes.map(Wt), Zt = (e2) => e2.weaponTypes.map(Wt), Qt = (e2) => e2.armorTypes.map(Wt), Jt = (e2) => e2.switches.map(Wt), ea = (e2, t2) => [aa(e2, t2), ra(e2, t2), ma(e2, t2), oa(e2, t2), ta(e2, t2), ia(e2, t2), sa(e2, t2)], ta = (e2, t2) => ({
  items: Qt(e2),
  ...
  module: "system",
  kind: "variables"
} }), sa = (e2, t2) => ({ items: Jt(e2), label: t2.options.switches, source: { author: "rmmz", module: "system", kind: "switches" } }), ma = (e2, t2) => ({
  items: Zt(e2),
  label: t2.options.weaponTypes,
  source: { author: "rmmz", module: "system", kind: "weaponTypes" }
}), pa = { type: "array", items: { type: "string" } }, na = {
  additionalProperties: false,
  type: "object",
...
}, ba = (e2 = {}) => ({ jsonFormatLevel: e2.jsonFormatLevel ?? 0, messageWidth1: e2.messageWidth1 ?? 816, messageWidth2: e2.messageWidth2 ?? 816 }), Na = {
  additionalProperties: false,
  type: "object",
  ...
  properties: {
    testBattlers: { type: "array", items: Na },
...
})([Ma, Pt, Dt, wt, Ut, qt, Vt, jt, na, Ia, Yt, Ca]), va = fa.compile(ka), Oa = fa.compile(Na);
fa.compile(kt);
const La = fa.compile(Vt), Pa = (e2) => ({
  ...
  additionalProperties: false
}), sr = (e2) => ir(e2), mr = Ja.compile({ type: "object", properties: { code: { type: "number", const: 117 }, indent: {
  type: "integer",
  minimum: 0
}, parameters: { type: "array", minItems: 1, maxItems: 1, items: [{ type: "number", minimum: 0, default: 0 }] } }, required: ["code", "indent", "parameters"] }), pr = Ja.compile({ type: "object", properties: {
...
exports.ABORT_BATTLE = 340, exports.AUTHOR_RMMZ = "rmmz", exports.BATTLE_PROCESSING = 301, exports.CHANGE_ACTOR_IMAGES = 322, exports.CHANGE_ARMORS = 128, exports.CHANGE_BATTLE_BACKGROUND = 283, exports.CHANGE_BATTLE_BGM = 132, exports.CHANGE_CLASS = 321, exports.CHANGE_DEFEAT_ME = 139, exports.CHANGE_ENCOUNTER = 136, exports.CHANGE_ENEMY_HP = 331, exports.CHANGE_ENEMY_MP = 332, exports.CHANGE_ENEMY_STATE = 333, exports.CHANGE_ENEMY_TP = 342, exports.CHANGE_EXP = 315, exports.CHANGE_FORMATION_ACCESS = 137, exports.CHANGE_GOLD = 125, exports.CHANGE_HP = 311, exports.CHANGE_ITEMS = 126, exports.CHANGE_MENU_ACCESS = 135, exports.CHANGE_MP = 312, exports.CHANGE_NAME = 320, exports.CHANGE_NICKNAME = 324, exports.CHANGE_PARALLAX = 284, exports.CHANGE_PARTY_MEMBER = 129, exports.CHANGE_PLAYER_FOLLOWERS = 216, exports.CHANGE_PROFILE = 325, exports.CHANGE_SAVE_ACCESS = 134, exports.CHANGE_TILESET = 282, exports.CHANGE_TP = 313, exports.CHANGE_TRANSPARENCY = 211, exports.CHANGE_VEHICLE_BGM = 140, exports.CHANGE_VEHICLE_IMAGE = 323, exports.CHANGE_VICTORY_ME = 133, exports.CHANGE_WEAPONS = 127, exports.CHANGE_WINDOW_COLOR = 138, exports.COLLAPS_BOSS = 1, exports.COLLAPS_INSTANT = 2, exports.COLLAPS_NONE = 3, exports.COLLAPS_NORMAL = 0, exports.COMMENT_BODY = 408, exports.COMMENT_HEAD = 108, exports.COMMON_EVENT = 117, exports.CONDITIONAL_BRANCH = 111, exports.CONDITIONAL_BRANCH_ELSE = 411, exports.CONTROL_SELF_SWITCH = 123, exports.CONTROL_SWITCHES = 121, exports.CONTROL_TIMER = 124, exports.CONTROL_VARIABLES = 122, exports.DEFAULT_DAMAGE_LABELS = _, exports.DEFAULT_GLOBAL_LABELS = Mt, exports.DEFAULT_ITEM_LABELS = {
...
}, exports.SCHEMA_DATA_ACTOR = R, exports.SCHEMA_DATA_ARMMOR = b, exports.SCHEMA_DATA_CLASS = N, exports.SCHEMA_DATA_ENEMY = C, exports.SCHEMA_DATA_ITEM = De, exports.SCHEMA_DATA_MAP_INFO = o, exports.SCHEMA_DATA_SKILL = Pe, exports.SCHEMA_DATA_STATE = h, exports.SCHEMA_DATA_WEAPON = ye, exports.SCHEMA_SYSTEM_ADVANCED = ft, exports.SCHEMA_SYSTEM_AUDIOFILES = Pt, exports.SCHEMA_SYSTEM_BATTLE_RULE_RMMZ = Dt, exports.SCHEMA_SYSTEM_BOOLEAN_GAMEMENU_OPTIONS = wt, exports.SCHEMA_SYSTEM_BOOLEAN_OPTIONS = Ut, exports.SCHEMA_SYSTEM_GAME_EDITOR_BUNDLE = Ca, exports.SCHEMA_SYSTEM_GAME_INITIAL = qt, exports.SCHEMA_SYSTEM_IMAGE_SIZE = Vt, exports.SCHEMA_SYSTEM_MEMBERS_ATTACK_MOTION = kt, exports.SCHEMA_SYSTEM_OTHER_DATA = jt, exports.SCHEMA_SYSTEM_RPG_DATA_NAMES = na, exports.SCHEMA_SYSTEM_TERMS_BUNDLE = Ia, exports.SCHEMA_SYSTEM_TITLE_COMMAND_WINDOW = {
  additionalProperties: false,
  type: "object",
...
}], semanticErrors: [] } : { formatLabel: e2.label, semanticErrors: re(e2, t2, a2), syntaxErrors: ae(e2.pattern, t2, a2, r2.placeHolderMaxLength) }, exports.domainNames = (e2) => Object.entries(e2).map(([, e3]) => e3.domainName), exports.extraParamName = (e2, t2) => {
  switch (e2) {
    case 3:
...
}), exports.makeCommandAudioAny = Ba, exports.makeCommandChangeActorName = (e2, t2 = 0) => ({ code: 320, parameters: [e2.actorId, e2.name], indent: t2 }), exports.makeCommandChangeActorNickName = (e2, t2 = 0) => ({
  code: 324,
  parameters: [e2.actorId, e2.nickname],
  indent: t2
}), exports.makeCommandChangeActorProfile = (e2, t2 = 0) => ({ code: 325, parameters: [e2.actorId, e2.profile], indent: t2 }), exports.makeCommandChangeBattleBGM = (e2, t2 = 0) => Ba(132, e2, t2), exports.makeCommandChangeDefeatME = (e2, t2 = 0) => Ba(139, e2, t2), exports.makeCommandChangeVictoryME = (e2, t2 = 0) => Ba(133, e2, t2), exports.makeCommandCommentBody = Ya, exports.makeCommandCommentHeader = Va, exports.makeCommandCommonEvent = (e2, t2 = 0) => ({ code: 117, indent: t2, parameters: Ga(e2 ?? {}) }), exports.makeCommandControlSwitches = (e2, t2 = 0) => ({ code: 121, indent: t2, parameters: Ua(e2) }), exports.makeCommandInputNumber = (e2, t2 = 0) => ({ code: 103, indent: t2, parameters: ja(e2 ?? {}) }), exports.makeCommandPlayBGM = (e2, t2 = 0) => Ba(241, e2, t2), exports.makeCommandPlayBGS = (e2, t2 = 0) => Ba(245, e2, t2), exports.makeCommandPlayME = (e2, t2 = 0) => Ba(249, e2, t2), exports.makeCommandPlaySE = (e2, t2 = 0) => Ba(250, e2, t2), exports.makeCommandScriptArray = (e2, t2 = 0) => e2.map((e3, a2) => 0 === a2 ? Ka(e3, t2) : Xa(e3, t2)), exports.makeCommandScriptBody = Xa, exports.makeCommandScriptHeader = Ka, exports.makeCommandScrollingTextBody = (e2 = "", t2 = 0) => ({ code: 405, indent: t2 ?? 0, parameters: za(e2) }), exports.makeCommandScrollingTextHeader = (e2 = {}, t2 = 0) => ({
  code: 105,
  indent: t2,
  parameters: Wa(e2)
...
}), exports.makeDamage = S, exports.makeDataNames = da, exports.makeDropItem = M, exports.makeEditorSetting = ba, exports.makeEnemyAction = (e2 = {}) => ({
  ...
  return {
    ...
    dropItems: ((_a2 = e2.dropItems) == null ? void 0 : _a2.map(() => M())) ?? [],
    exp: e2.exp ?? 0,
    gold: e2.gold ?? 0,
    traits: [],
    note: e2.note ?? "",
