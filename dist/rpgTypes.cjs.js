...
const e = require("ajv"), t = (e2, t2) => `\\${e2}[${t2}]`, a = (e2 = {}) => ({
  ...
  module: "system",
  kind: "variables"
} }), sa = (e2, t2) => ({ items: Jt(e2), label: t2.options.switches, source: { author: "rmmz", module: "system", kind: "switches" } }), pa = (e2, t2) => ({
  items: Zt(e2),
