...
const e = require("ajv"), t = (e2, t2) => `\\${e2}[${t2}]`, a = (e2 = {}) => ({
...
}), m = s.compile(i), p = (e2, t2) => [d(e2.skills, t2), l(e2.actors, t2), c(e2.states, t2), u(e2.armors, t2), y(e2.classes, t2), x(e2.enemies, t2), g(e2.items, t2), E(e2.weapons, t2), A(e2.commonEvents, t2)], d = (e2, t2) => ({
  ...
  module: "data",
  kind: "weapon"
} }), A = (e2, t2) => ({ items: e2, label: t2.commonEvent.title, source: { author: "rmmz", module: "data", kind: "common_event" } }), T = {
  actor: {
    title: "アクター",
    options: {
  ...
  kind: e2.kind ?? 0
}), S = (e2, t2) => ({ items: R(e2.options, t2), label: e2.title, source: { author: "rmmz", module: "trait", kind: "collaps" } }), R = (e2, t2) => [{ id: 0, name: t2.normal }, { id: 1, name: e2.bossCollaps }, {
  id: 2,
  ...
  id: 6,
  name: e2.agi
}, { id: 7, name: e2.luk }], M = (e2) => ({ items: k(e2.options), label: e2.title, source: { author: "rmmz", module: "trait", kind: "sparams" } }), k = (e2) => [{ id: 0, name: e2.targetRate }, {
  id: 1,
...
}, { id: 8, name: e2.floorDamageRate }, { id: 9, name: e2.experienceRate }], v = (e2) => ({ items: O(e2.options), label: e2.title, source: {
  author: "rmmz",
  module: "trait",
  kind: "partyAbility"
...
}], P = (e2) => ({ items: L(e2.options), label: e2.title, source: { author: "rmmz", module: "trait", kind: "sflag" } }), L = (e2) => [{ id: 0, name: e2.autoBattle }, { id: 1, name: e2.guard }, { id: 2, name: e2.substitute }, {
  id: 3,
  name: e2.preventEscape
}], D = "{name}", F = "{name} * {value}%", H = "{name} + {value}%", w = "{value}", B = {
  title: "特徴",
  options: {
    ...
    extraParam: { title: "追加能力値", format: H, options: {
      hitRate: "命中率",
      evasionRate: "回避率",
    ...
    attackTimes: { title: "攻撃追加回数", format: w },
...
}, G = (e2, t2) => [N(e2.regularParam), C(e2.extraParam), M(e2.specialParam), S(e2.collaps, t2), P(e2.specialFlag), v(e2.partyAbility)], U = (e2) => e2.map((e3) => ({ dataKey: e3, placeHolder: `{${e3}}` })), q = (e2) => ({
  ...
  return {
    ...
    fallbackFormat: { text: z(e2), label: K(e2) },
  ...
  var a2;
}, W = (e2) => ({ placeHolder: `{${e2.placeHolder}}`, kindKey: e2.kindKey, dataIdKey: e2.dataIdKey }), z = (e2) => {
...
}, ne = (e2) => [de(e2), le(e2), ce(e2), ue(e2), ye(e2), xe(e2), ge(e2), Ee(e2), Ae(e2), pe(e2), Te(e2), Ie(e2), _e(e2)], me = (e2, t2, a2) => ({
  kindId: e2,
  label: t2.domainName,
  pattern: t2.format,
  description: t2.desc,
  ...
  module: "trait",
  kind: "params"
}), Ee = (e2) => me(33, e2.removeBuff, { author: "rmmz", module: "trait", kind: "params" }), Ae = (e2) => me(34, e2.removeDebuff, {
  author: "rmmz",
  module: "trait",
  kind: "params"
}), Te = (e2) => me(42, e2.grow, { author: "rmmz", module: "trait", kind: "params" }), Ie = (e2) => me(43, e2.learnSkill, { author: "rmmz", module: "data", kind: "skill" }), _e = (e2) => me(44, e2.commonEvent, {
  author: "rmmz",
  module: "data",
  kind: "common_event"
}), be = "{name} {value1}%", Se = "{value1}% + {value2}", Re = "{name} {value1}ターン", Ce = "{name}", fe = { title: "使用効果", options: { addBuff: {
  desc: "バフを付与する",
  domainName: "バフ付与",
  format: Re
}, addDebuff: { desc: "デバフを付与する", domainName: "デバフ付与", format: Re }, gainTp: { desc: "TPを指定した量だけ増加させます。", domainName: "TP増加", format: Se }, grow: {
  desc: "成長効果",
  domainName: "成長効果",
  format: "{name} + {value1}"
  ...
  domainName: "ステート解除",
  format: be
}, commonEvent: { desc: "コモンイベントを実行する", domainName: "コモンイベント", format: Ce } } }, Ne = { type: "string" }, he = { type: "integer" }, Me = {
  type: "integer",
  minimum: 0
}, ke = {
  type: "object",
  properties: { type: { type: "integer" }, elementId: Me, formula: Ne, variance: he, critical: { type: "boolean" } },
  required: ["type", "elementId", "formula", "variance", "critical"],
  additionalProperties: false
}, ve = {
  type: "object",
  properties: { code: he, dataId: Me, value1: he, value2: he },
  ...
  properties: { name: Ne, id: Me, description: Ne, iconIndex: Me, note: Ne, animationId: Me, hitType: he, occasion: he, repeats: he, scope: he, speed: he, successRate: he, tpGain: he, consumable: {
    type: "boolean"
  }, price: Me, itypeId: Me, effects: { type: "array", items: ve }, damage: ke }
}, Le = new e({ strict: true }), De = Le.compile(Pe), Fe = Le.compile(Oe), He = Le.compile({
  type: "object",
  ...
  additionalProperties: false
}), Ve = (e2, t2) => `<${e2}:${t2}>`, je = () => /<([^<>:]{1,100}):([^>]{1,1000})>/g, Ye = (e2, t2) => {
  const a2 = /<([^<>:]{1,100}):([^>]{1,1000})>/g;
  return Array.from(e2.matchAll(a2), (e3) => t2(e3[1], e3[2]));
}, We = (e2) => [ze(e2.elementRate), Ke(e2.debuffRate), Xe(e2.stateRate), $e(e2.stateResist), Ze(e2.regularParam), Je(e2.extraParam), Qe(e2.specialParam), et(e2.attackElement), tt(e2.attackState), at(e2.attackSpeed), rt(e2.attackTimes), ot(e2.attackSkill), it(e2.skillTypeAdd), st(e2.skillTypeSeal), nt(e2.skillAdd), mt(e2.skillSeal), pt(e2.equipWeaponType), dt(e2.equipArmorType), lt(e2.equipLock), ct(e2.equipSeal), ut(e2.slotType), yt(e2.actionPlus), xt(e2.specialFlag), gt(e2.collaps), Et(e2.partyAbility)], ze = (e2) => ({
  pattern: e2.format,
  label: e2.title,
  kindId: 11,
  dataSource: It()
  ...
  kindId: 13,
  dataSource: At()
}), $e = (e2) => ({ pattern: e2.format, label: e2.title, kindId: 14, dataSource: At() }), Ze = (e2) => ({
  pattern: e2.format,
  label: e2.title,
  kindId: 21,
  dataSource: { author: "rmmz", module: "trait", kind: "params" }
}), Je = (e2) => ({ pattern: e2.format, label: e2.title, kindId: 22, dataSource: { author: "rmmz", module: "trait", kind: "xparams" } }), Qe = (e2) => ({
  pattern: e2.format,
  label: e2.title,
  kindId: 23,
  dataSource: { author: "rmmz", module: "trait", kind: "sparams" }
}), et = (e2) => ({ pattern: e2.format, label: e2.title, kindId: 31, dataSource: It() }), tt = (e2) => ({
  pattern: e2.format,
  label: e2.title,
  kindId: 32,
  dataSource: At()
  ...
  kindId: 42,
  dataSource: _t()
}), nt = (e2) => ({ pattern: e2.format, label: e2.title, kindId: 43, dataSource: Tt() }), mt = (e2) => ({ pattern: e2.format, label: e2.title, kindId: 44, dataSource: Tt() }), pt = (e2) => ({
  pattern: e2.format,
  label: e2.title,
  kindId: 51,
  dataSource: bt()
}), dt = (e2) => ({ pattern: e2.format, label: e2.title, kindId: 52, dataSource: St() }), lt = (e2) => ({
  pattern: e2.format,
  label: e2.title,
  kindId: 53,
  dataSource: Rt()
}), ct = (e2) => ({ pattern: e2.format, label: e2.title, kindId: 54, dataSource: Rt() }), ut = (e2) => ({ pattern: e2.format, label: e2.title, kindId: 55, dataSource: Rt() }), yt = (e2) => ({
  pattern: e2.format,
  label: e2.title,
  kindId: 61
  ...
  module: "trait",
  kind: "collaps"
} }), Et = (e2) => ({ pattern: e2.format, label: e2.title, kindId: 64, dataSource: { author: "rmmz", module: "trait", kind: "partyAbility" } }), At = () => ({
  author: "rmmz",
  module: "data",
  kind: "state"
}), Tt = () => ({ author: "rmmz", module: "data", kind: "skill" }), It = () => ({ author: "rmmz", module: "system", kind: "elements" }), _t = () => ({
  author: "rmmz",
  module: "system",
  kind: "skillTypes"
}), bt = () => ({ author: "rmmz", module: "system", kind: "weaponTypes" }), St = () => ({ author: "rmmz", module: "system", kind: "armorTypes" }), Rt = () => ({
  author: "rmmz",
  module: "system",
  kind: "equipTypes"
}), Ct = {
  ...
  pitch: e2.pitch ?? 100,
  pan: e2.pan ?? 0
}), ht = (e2 = {}) => [Nt(e2.cursor), Nt(e2.ok), Nt(e2.cancel), Nt(e2.buzzer), Nt(e2.equip), Nt(e2.save), Nt(e2.load), Nt(e2.battleStart), Nt(e2.escape), Nt(e2.enemyAttack), Nt(e2.enemyDamage), Nt(e2.enemyCollapse), Nt(e2.bossCollapes1), Nt(e2.bossCollapes2), Nt(e2.actorDamage), Nt(e2.actorCollapse), Nt(e2.playRecovery), Nt(e2.playMiss), Nt(e2.playEvasion), Nt(e2.playMagicEvasion), Nt(e2.playReflection), Nt(e2.shop), Nt(e2.useItem), Nt(e2.useSkill)], Mt = {
  type: "object",
  ...
  properties: { battleBgm: Mt, victoryMe: Mt, gameoverMe: Mt, titleBgm: Mt, defeatMe: Mt, sounds: {
    type: "array",
    items: Mt,
    minItems: 24,
    maxItems: 24
...
}, Ot = (e2 = {}) => [e2.item ?? true, e2.weapon ?? true, e2.armor ?? true, e2.keyItem ?? true], Pt = (e2 = {}) => [e2.item ?? true, e2.skill ?? true, e2.equip ?? true, e2.status ?? true, e2.formation ?? true, e2.save ?? true], Lt = {
...
}, wt = { additionalProperties: false, type: "object", required: ["startMapId", "startX", "startY", "partyMembersArray"], properties: { startMapId: {
  type: "integer",
  minimum: 0
}, startX: { type: "integer", minimum: 0 }, startY: { type: "integer", minimum: 0 }, partyMembersArray: { type: "array", items: { type: "integer", minimum: 0 } } } }, Bt = {
  additionalProperties: false,
  type: "object",
...
}, Gt = { additionalProperties: false, type: "object", required: ["title1Name", "title2Name"], properties: { title1Name: { type: "string" }, title2Name: { type: "string" } } }, Ut = {
  type: "object",
  additionalProperties: false,
  ...
  name: e2,
  id: t2
}), Vt = (e2) => e2.variables.map(qt), jt = (e2) => e2.elements.map(qt), Yt = (e2) => e2.equipTypes.map(qt), Wt = (e2) => e2.skillTypes.map(qt), zt = (e2) => e2.weaponTypes.map(qt), Kt = (e2) => e2.armorTypes.map(qt), Xt = (e2) => e2.switches.map(qt), $t = (e2, t2) => [Jt(e2, t2), Qt(e2, t2), ra(e2, t2), ea(e2, t2), Zt(e2, t2), ta(e2, t2), aa(e2, t2)], Zt = (e2, t2) => ({
  items: Kt(e2),
  label: t2.options.armorTypes,
  source: { author: "rmmz", module: "system", kind: "armorTypes" }
}), Jt = (e2, t2) => ({ items: jt(e2), label: t2.options.elements, source: {
  author: "rmmz",
  module: "system",
  kind: "elements"
} }), Qt = (e2, t2) => ({ items: Yt(e2), label: t2.options.equipTypes, source: { author: "rmmz", module: "system", kind: "equipTypes" } }), ea = (e2, t2) => ({
  items: Wt(e2),
  label: t2.options.skillTypes,
  source: { author: "rmmz", module: "system", kind: "skillTypes" }
}), ta = (e2, t2) => ({ items: Vt(e2), label: t2.options.variables, source: {
  author: "rmmz",
  module: "system",
  kind: "variable"
} }), aa = (e2, t2) => ({ items: Xt(e2), label: t2.options.switches, source: { author: "rmmz", module: "system", kind: "switch" } }), ra = (e2, t2) => ({
  items: zt(e2),
  label: t2.options.weaponTypes,
  source: { author: "rmmz", module: "system", kind: "weaponTypes" }
}), oa = { type: "array", items: { type: "string" } }, ia = {
  additionalProperties: false,
  type: "object",
  ...
  armorTypes: na(e2.armorTypes),
  elements: na(e2.elements),
  equipTypes: na(e2.equipTypes),
  weaponTypes: na(e2.weaponTypes),
  skillTypes: na(e2.skillTypes),
  variables: na(e2.variables),
  switches: na(e2.switches)
}), na = (e2) => e2 ? [...e2] : [], ma = (e2) => [e2.level ?? "Level", e2.levelA ?? "Level", e2.hp ?? "HP", e2.hpA ?? "HP", e2.mp ?? "MP", e2.mpA ?? "MP", e2.tp ?? "TP", e2.tpA ?? "TP", e2.experience ?? "EXP", e2.exp ?? "EXP"], pa = (e2) => da(e2, ""), da = (e2, t2) => [e2.fight ?? "Fight", e2.escape ?? "Escape", e2.attack ?? "Attack", e2.guard ?? "Guard", e2.item ?? "Item", e2.skill ?? "Skill", e2.equip ?? "Equip", e2.status ?? "Status", e2.formation ?? "Formation", e2.save ?? "Save", e2.gameEnd ?? "Game End", e2.options ?? "Options", e2.weapon ?? "Weapon", e2.armor ?? "Armor", e2.keyItem ?? "Key Item", e2.equip2 ?? "Equip2", e2.optimize ?? "Optimize", e2.clear ?? "Clear", e2.newGame ?? "New Game", e2.continue_ ?? "Continue", t2, e2.toTitle ?? "To Title", e2.cancel ?? "Cancel", t2, e2.buy ?? "Buy", e2.sell ?? "Sell"], la = (e2, t2) => "string" == typeof e2 ? e2 : t2, ca = (e2) => ({
  actionFailure: la(e2.actionFailure, "Action failed."),
  actorDamage: la(e2.actorDamage, "%1 took %2 damage."),
  actorRecovery: la(e2.actorRecovery, "%1 recovered %2 HP."),
  actorGain: la(e2.actorGain, "%1 gained %2."),
  actorLoss: la(e2.actorLoss, "%1 lost %2."),
  actorDrain: la(e2.actorDrain, "%1 drained %2 HP."),
  actorNoDamage: la(e2.actorNoDamage, "%1 was not damaged."),
  actorNoHit: la(e2.actorNoHit, "%1 was not hit."),
  alwaysDash: la(e2.alwaysDash, "Always dash."),
  bgmVolume: la(e2.bgmVolume, "BGM volume"),
  bgsVolume: la(e2.bgsVolume, "BGS volume"),
  commandRemember: la(e2.commandRemember, "Command remember."),
  criticalToActor: la(e2.criticalToActor, "%1 dealt %2 damage to %3."),
  criticalToEnemy: la(e2.criticalToEnemy, "%1 dealt %2 damage to %3."),
  counterAttack: la(e2.counterAttack, "%1 countered!"),
  debuffAdd: la(e2.debuffAdd, "%1's %2 was lowered."),
  defeat: la(e2.defeat, "Defeat."),
  enemyDamage: la(e2.enemyDamage, "%1 took %2 damage."),
  enemyDrain: la(e2.enemyDrain, "%1 drained %2 HP."),
  enemyGain: la(e2.enemyGain, "%1 gained %2."),
  enemyLoss: la(e2.enemyLoss, "%1 lost %2."),
  enemyNoDamage: la(e2.enemyNoDamage, "%1 was not damaged."),
  enemyNoHit: la(e2.enemyNoHit, "%1 was not hit."),
  enemyRecovery: la(e2.enemyRecovery, "%1 recovered %2 HP."),
  evasion: la(e2.evasion, "%1 evaded the attack!"),
  autosave: la(e2.autosave, "Autosave"),
  escapeFailure: la(e2.escapeFailure, "Escape failed."),
  escapeStart: la(e2.escapeStart, "%1 started to escape!"),
  emerge: la(e2.emerge, "%1 appeared!"),
  expNext: la(e2.expNext, "Next level in %1 EXP."),
  expTotal: la(e2.expTotal, "Total EXP: %1"),
  file: la(e2.file, "File"),
  buffAdd: la(e2.buffAdd, "%1's %2 was raised."),
  buffRemove: la(e2.buffRemove, "%1's %2 was lowered."),
  obtainExp: la(e2.obtainExp, "%1 EXP obtained."),
  obtainGold: la(e2.obtainGold, "%1 gold obtained."),
  obtainItem: la(e2.obtainItem, "%1 obtained %2."),
  obtainSkill: la(e2.obtainSkill, "%1 learned %2."),
  levelUp: la(e2.levelUp, "%1 leveled up!"),
  partyName: la(e2.partyName, "Party"),
  loadMessage: la(e2.loadMessage, "Load %1?"),
  meVolume: la(e2.meVolume, "ME volume"),
  possession: la(e2.possession, "Possession"),
  preemptive: la(e2.preemptive, "%1 attacked first!"),
  saveMessage: la(e2.saveMessage, "Save %1?"),
  seVolume: la(e2.seVolume, "SE volume"),
  magicEvasion: la(e2.magicEvasion, "%1 evaded the magic!"),
  magicReflection: la(e2.magicReflection, "%1 reflected the magic!"),
  substitute: la(e2.substitute, "%1 took the hit!"),
  surprise: la(e2.surprise, "%1 surprised the enemy!"),
  touchUI: la(e2.touchUI, "Touch UI"),
  useItem: la(e2.useItem, "%1 used %2."),
  victory: la(e2.victory, "Victory!")
}), ua = { type: "string" }, ya = {
  type: "string",
  nullable: true
}, xa = { type: "string" }, ga = { required: ["terms", "currencyUnit", "gameTitle"], additionalProperties: false, type: "object", properties: {
...
} }, Ea = (e2) => [e2.mhp ?? "", e2.mmp ?? "", e2.atk ?? "", e2.def ?? "", e2.mat ?? "", e2.mdf ?? "", e2.agi ?? "", e2.luk ?? "", e2.hit ?? "", e2.eva ?? ""], Aa = (e2 = {}) => ({
...
}), Ia = { additionalProperties: false, type: "object", required: ["actorId", "equips", "level"], properties: { actorId: {
  type: "integer"
}, level: { type: "integer", minimum: 1 }, equips: { type: "array", items: { type: "integer" } } } }, _a = {
  additionalProperties: false,
  type: "object",
  required: ["battleback1Name", "battleback2Name", "battlerHue", "battlerName", "editMapId", "editor", "testBattlers", "testTroopId"],
  properties: {
    testBattlers: { type: "array", items: Ia },
...
}, Ra = { additionalProperties: false, required: ["airship", "boat", "ship", "advanced", "attackMotions"], type: "object", properties: {
  airship: Sa,
  boat: Sa,
  ship: Sa,
  advanced: {
  ...
  attackMotions: { type: "array", items: ba }
} }, Ca = (e2) => e2.reduce((e3, t2) => ({ required: [...e3.required, ...t2.required], properties: { ...e3.properties, ...t2.properties } }), {
  required: [],
  properties: {}
}), fa = new e({ strict: true }), Na = ((e2) => {
  const t2 = Ca(e2);
  return {
    additionalProperties: false,
    type: "object",
...
})([Ra, kt, vt, Lt, Ht, wt, Bt, Ut, ia, ga, Gt, _a]), ha = fa.compile(Na), Ma = fa.compile(Ia);
fa.compile(ba);
const ka = fa.compile(Bt), va = (e2) => ({
  basic: ma(e2.basic ?? {}),
  commands: pa(e2.commands ?? {}),
  params: Ea(e2.params ?? {}),
  messages: ca(e2.messages ?? {})
}), Oa = (e2) => e2 ? [...e2] : [], Pa = (e2) => ((e3) => ka(e3))(e2) ? {
  tileSize: e2.tileSize,
  faceSize: e2.faceSize,
  iconSize: e2.iconSize
} : { tileSize: 48, faceSize: 144, iconSize: 32 }, La = (e2, t2) => e2 ? e2.map(t2) : [], Da = (e2) => ((e3) => Ma(e3))(e2) ? { actorId: e2.actorId, equips: Oa(e2.equips), level: e2.level } : {
  actorId: 0,
  equips: [],
  level: 1
}, Fa = (e2, t2, a2 = 0) => ({ code: e2, parameters: [Nt(t2)], indent: a2 }), Ha = (e2) => [e2.eventId ?? 0], wa = (e2) => [e2.min, e2.max, e2.value], Ba = (e2) => [e2], Ga = (e2, t2 = 0) => ({ code: 108, indent: t2, parameters: Ba(e2) }), Ua = (e2, t2 = 0) => ({
  code: 408,
  indent: t2,
  parameters: Ba(e2)
}), qa = (e2) => [e2.variableId ?? 0, e2.digits ?? 0], Va = (e2 = {}) => [(e2 == null ? void 0 : e2.speed) ?? 4, (e2 == null ? void 0 : e2.skip) ?? false], ja = (e2 = "") => [e2], Ya = (e2, t2 = 0) => ({
  code: 355,
  indent: t2,
  parameters: [e2]
}), Wa = (e2, t2 = 0) => ({ code: 655, indent: t2, parameters: [e2] }), za = {
  HP: 0,
  MP: 1,
  MHP: 2,
  MMP: 3,
  ...
  LUK: 9,
  TP: 10
}, Ka = (e2) => [...e2], Xa = (e2) => "string" == typeof e2 || "number" == typeof e2 || "boolean" == typeof e2, $a = new e({ code: { source: false }, strict: true }), Za = $a.compile({
  type: "object",
  ...
  additionalProperties: false
}), ar = $a.compile({ type: "object", required: ["code", "parameters", "indent"], properties: { code: { type: "integer", enum: [108, 355, 401, 405, 408, 655] }, indent: {
  type: "integer",
  minimum: 0
}, parameters: { type: "array", minItems: 1, maxItems: 1, items: [{ type: "string" }] } }, additionalProperties: false }), rr = (e2) => ar(e2), or = $a.compile({
  type: "object",
  properties: {
  ...
  required: ["code", "indent", "parameters"]
}), sr = $a.compile({ type: "object", properties: { code: { type: "number", const: 402 }, indent: { type: "integer", minimum: 0 }, parameters: { type: "array", minItems: 2, maxItems: 2, items: [{
  type: "integer"
}, { type: "string" }] } }, required: ["code", "indent", "parameters"] }), nr = $a.compile({ type: "object", properties: {
  code: { type: "number", const: 103 },
  indent: { type: "integer", minimum: 0 },
  parameters: { type: "array", minItems: 2, maxItems: 2, items: [{ type: "number" }, { type: "number" }] }
}, required: ["code", "indent", "parameters"] }), mr = $a.compile({
  type: "object",
  required: ["code", "parameters", "indent"],
  ...
  ...dr(e2),
  ...lr(e2.default)
}), dr = (e2) => ({ ..."string" == typeof e2.text ? { title: e2.text } : {}, ..."string" == typeof e2.desc ? { description: e2.desc } : {} }), lr = (e2) => void 0 !== e2 ? {
  default: e2
} : {}, cr = (e2) => void 0 === e2 || 0 === e2, ur = (e2) => pr(e2, { type: "string" }), yr = (e2) => {
  switch (e2.kind) {
    case "string":
    case "multiline_string":
      return ((e3) => ({ type: "string", ...dr(e3), ...lr(e3.default) }))(e2);
    case "file":
    case "combo":
      return ((e3) => ({ type: "string", ...lr(e3.default), ...dr(e3) }))(e2);
    case "select":
      return ((e3) => ({ type: "string", ...lr(e3.default), ...dr(e3), ...e3.options ? {
    ...
    case "number[]":
      return ((e3) => ({ type: "array", items: {
        type: cr(e3.decimals) ? "integer" : "number"
      }, ...lr(e3.default), ...dr(e3) }))(e2);
    case "actor[]":
    case "weapon[]":
    case "armor[]":
    case "skill[]":
    ...
    case "class[]":
    case "troop[]":
      return ((e3) => pr(e3, { type: "integer" }))(e2);
    case "number":
      return ((e3) => ({ type: cr(e3.decimals) ? "integer" : "number", ...lr(e3.default), ...dr(e3) }))(e2);
    case "actor":
    case "weapon":
    case "armor":
    case "skill":
    ...
    case "class":
    case "troop":
      return ((e3) => ({ type: "integer", ...lr(e3.default), ...dr(e3) }))(e2);
    case "boolean":
      return ((e3) => ({ type: "boolean", ...lr(e3.default), ...dr(e3) }))(e2);
    case "struct":
      return { $ref: `#/definitions/${(t2 = e2).struct}`, ...dr(t2) };
    default:
      return {};
  }
  var t2;
}, xr = (e2, t2) => Object.entries(t2).reduce((t3, [a2, r2]) => {
  if (a2 in e2) {
    const o2 = e2[a2];
  ...
  ...xr(a2, r2),
  kind: e2
}), Er = (e2, t2, a2) => ({ default: [], ...xr(t2, a2), kind: e2 }), Ar = "help", Tr = "kind", Ir = "text", _r = "struct", br = (e2) => {
  const t2 = JSON.parse(e2);
  return Array.isArray(t2) ? t2.map(Sr) : "object" == typeof t2 && null !== t2 ? Object.fromEntries(Object.entries(t2).map(([e3, t3]) => [e3, Sr(t3)])) : t2;
}, Sr = (e2) => {
  ...
  if (Tr in e2.attr) {
    const t2 = Or[e2.attr.kind];
    if (t2) return t2(e2);
  }
  return gr("any", "", e2.attr, Nr);
}, Cr = (e2) => e2, fr = (e2) => e2.replace("[", "").replace("]", "").split(",").map((e3) => parseFloat(e3.replaceAll('"', "").trim())).filter((e3) => !isNaN(e3)), Nr = {
  default: Cr,
  text: Cr,
  desc: Cr,
  parent: Cr
}, hr = (e2) => gr("string", "", e2.attr, Nr), Mr = (e2) => {
  const t2 = { default: (e3) => br(e3), text: Cr, desc: Cr, parent: Cr };
  return Er("string[]", e2.attr, t2);
}, kr = (e2, t2) => {
  const a2 = {
    default: fr,
    text: Cr,
  ...
  return Er(t2, e2.attr, a2);
}, vr = (e2, t2) => {
  const a2 = { default: (e3) => parseInt(e3, 10), text: Cr, desc: Cr, parent: Cr };
  return gr(t2, 0, e2.attr, a2);
}, Or = {
  number: (e2) => ((e3) => {
    const t2 = {
    ...
    return gr("number", 0, e3.attr, t2);
  })(e2),
  "number[]": (e2) => {
    const t2 = { default: fr, text: Cr, desc: Cr, decimals: (e3) => parseInt(e3, 10), min: (e3) => parseFloat(e3), max: (e3) => parseFloat(e3), parent: Cr };
    return Er("number[]", e2.attr, t2);
  },
  string: hr,
  "string[]": Mr,
  multiline_string: hr,
  ...
  combo: (e2) => {
    ...
    return { ...gr("combo", "", e2.attr, Nr), options: t2 };
  },
  select: (e2) => {
    var _a2;
    const t2 = ((_a2 = e2.options) == null ? void 0 : _a2.map((e3) => ({ option: e3.option, value: e3.value }))) ?? [];
    return { ...gr("select", "", e2.attr, Nr), options: t2 };
  },
  actor: (e2) => vr(e2, "actor"),
  "actor[]": (e2) => kr(e2, "actor[]"),
  class: (e2) => vr(e2, "class"),
  "class[]": (e2) => kr(e2, "class[]"),
  skill: (e2) => vr(e2, "skill"),
  "skill[]": (e2) => kr(e2, "skill[]"),
  item: (e2) => vr(e2, "item"),
  "item[]": (e2) => kr(e2, "item[]"),
  weapon: (e2) => vr(e2, "weapon"),
  "weapon[]": (e2) => kr(e2, "weapon[]"),
  armor: (e2) => vr(e2, "armor"),
  "armor[]": (e2) => kr(e2, "armor[]"),
  state: (e2) => vr(e2, "state"),
  "state[]": (e2) => kr(e2, "state[]"),
  enemy: (e2) => vr(e2, "enemy"),
  "enemy[]": (e2) => kr(e2, "enemy[]"),
  common_event: (e2) => vr(e2, "common_event"),
  "common_event[]": (e2) => kr(e2, "common_event[]"),
  switch: (e2) => vr(e2, "switch"),
  "switch[]": (e2) => kr(e2, "switch[]"),
  variable: (e2) => vr(e2, "variable"),
  "variable[]": (e2) => kr(e2, "variable[]"),
  troop: (e2) => vr(e2, "troop"),
  "troop[]": (e2) => kr(e2, "troop[]"),
  boolean: (e2) => {
    const t2 = {
      default: (e3) => "true" === e3,
      text: Cr,
    ...
    return gr("boolean", true, e2.attr, t2);
  },
  file: (e2) => {
    const t2 = { default: Cr, text: Cr, desc: Cr, parent: Cr, dir: Cr };
    return { dir: "", ...gr("file", "", e2.attr, t2) };
  },
  "file[]": (e2) => {
    const t2 = { default: (e3) => br(e3), text: Cr, desc: Cr, parent: Cr, dir: Cr };
    return { dir: "", ...Er("file[]", e2.attr, t2) };
  }
}, Pr = "BODY", Lr = "STRUCT", Dr = "NONE", Fr = (e2, t2) => {
  const a2 = e2.lines.length > 0 ? wr(e2) : e2, r2 = t2[1] || void 0;
  return { ...a2, structName: r2, blockType: r2 ? Lr : "INVALID", locale: t2[2], lines: [] };
}, Hr = (e2) => ({
  ...
  locale: void 0,
  lines: []
}), wr = (e2) => e2.blockType === Pr ? { ...e2, bodies: e2.bodies.concat([{ lines: [...e2.lines] }]), lines: [], blockType: Dr } : e2.structName && e2.blockType === Lr ? {
  ...e2,
  ...
  structName: void 0,
  lines: []
}, Br = (e2) => e2.currentOption ? { items: e2.items.concat({ option: e2.currentOption, value: e2.currentOption }) } : e2, Gr = (e2) => ({
  ..."string" == typeof e2.desc ? { desc: e2.desc } : {},
  ..."string" == typeof e2.text ? { text: e2.text } : {}
}), Ur = (e2) => {
  const t2 = qr(e2), a2 = jr(t2);
  return Vr(a2);
}, qr = (e2) => {
  if (e2.currentParam && e2.currentOption) {
    const t2 = e2.currentParam.attr.kind;
    if ("select" === t2 || "combo" === t2) return { ...e2, currentParam: { ...e2.currentParam, options: Br(e2.currentOption).items } };
  }
  return e2;
}, Vr = (e2) => e2.currentParam ? {
  ...e2,
  ...
  if (e2.currentCommand) {
    const t2 = e2.currentParam ? [...e2.currentCommand.args, e2.currentParam] : e2.currentCommand.args, a2 = { ...Gr(e2.currentCommand), command: e2.currentCommand.command, args: t2 };
    return {
      ...e2,
  ...
  const a2 = e2.lines.reduce((e3, a3) => {
    ...
    if (!r2.startsWith("@")) return e3.currentContext === Ar ? { ...e3, helpLines: e3.helpLines.concat(r2) } : e3;
  ...
  const a2 = ((e3) => {
    const t3 = e3.split("\n"), a3 = {
      ...
      return r4 ? Fr(e4, r4) : "/*:" === a4 ? Hr(e4) : "*/" === a4 ? e4.lines.length > 0 ? wr(e4) : e4 : { ...e4, lines: e4.lines.concat([a4]) };
    }, a3);
  ...
  meta: {}
}), Kr = (e2, t2, a2) => e2.currentParam && !(t2 in e2.currentParam.attr) ? {
  ...e2,
  currentParam: { ...e2.currentParam, attr: { ...e2.currentParam.attr, [t2]: a2 } }
} : e2, Xr = (e2, t2, a2) => ({ ...e2, meta: { [t2]: a2, ...e2.meta } }), $r = {
  param: (e2, t2) => {
    const a2 = Ur(e2);
    return a2.params.some((e3) => e3.name === t2) ? a2 : { ...a2, currentContext: "param", currentParam: { name: t2, attr: {} } };
  },
  text: (e2, t2) => e2.currentParam ? Kr(e2, Ir, t2) : e2.currentCommand && !(Ir in e2.currentCommand) ? { ...e2, currentCommand: {
    ...Gr(e2.currentCommand),
    command: e2.currentCommand.command,
    args: e2.currentCommand.args,
    [Ir]: t2
  } } : e2,
  desc: (e2, t2) => e2.currentParam ? Kr(e2, "desc", t2) : e2.currentCommand ? { ...e2, currentCommand: { ...e2.currentCommand, desc: t2 } } : e2,
  command: (e2, t2) => {
    const a2 = Ur(e2);
  ...
  help: (e2) => ({ ...Ur(e2), currentContext: Ar }),
  option: (e2, t2) => {
  ...
  type: (e2, t2) => {
    if (((e3) => e3.endsWith(">") && e3.startsWith("struct<"))(t2)) {
      const a2 = t2.slice(7, -1), r2 = Kr(e2, _r, a2);
      return Kr(r2, Tr, _r);
    }
    return e2.currentParam ? Kr(e2, Tr, t2) : e2;
  },
  default: (e2, t2) => Kr(e2, "default", t2),
  on: (e2, t2) => Kr(e2, "on", t2),
  off: (e2, t2) => Kr(e2, "off", t2),
  min: (e2, t2) => Kr(e2, "min", t2),
  max: (e2, t2) => Kr(e2, "max", t2),
  base: (e2, t2) => {
...
exports.ABORT_BATTLE = 340, exports.AUTHOR_RMMZ = "rmmz", exports.BATTLE_PROCESSING = 301, exports.CHANGE_ACTOR_IMAGES = 322, exports.CHANGE_ARMORS = 128, exports.CHANGE_BATTLE_BACKGROUND = 283, exports.CHANGE_BATTLE_BGM = 132, exports.CHANGE_CLASS = 321, exports.CHANGE_DEFEAT_ME = 139, exports.CHANGE_ENCOUNTER = 136, exports.CHANGE_ENEMY_HP = 331, exports.CHANGE_ENEMY_MP = 332, exports.CHANGE_ENEMY_STATE = 333, exports.CHANGE_ENEMY_TP = 342, exports.CHANGE_EXP = 315, exports.CHANGE_FORMATION_ACCESS = 137, exports.CHANGE_GOLD = 125, exports.CHANGE_HP = 311, exports.CHANGE_ITEMS = 126, exports.CHANGE_MENU_ACCESS = 135, exports.CHANGE_MP = 312, exports.CHANGE_NAME = 320, exports.CHANGE_NICKNAME = 324, exports.CHANGE_PARALLAX = 284, exports.CHANGE_PARTY_MEMBER = 129, exports.CHANGE_PLAYER_FOLLOWERS = 216, exports.CHANGE_PROFILE = 325, exports.CHANGE_SAVE_ACCESS = 134, exports.CHANGE_TILESET = 282, exports.CHANGE_TP = 313, exports.CHANGE_TRANSPARENCY = 211, exports.CHANGE_VEHICLE_BGM = 140, exports.CHANGE_VEHICLE_IMAGE = 323, exports.CHANGE_VICTORY_ME = 133, exports.CHANGE_WEAPONS = 127, exports.CHANGE_WINDOW_COLOR = 138, exports.COLLAPS_BOSS = 1, exports.COLLAPS_INSTANT = 2, exports.COLLAPS_NONE = 3, exports.COLLAPS_NORMAL = 0, exports.COMMENT_BODY = 408, exports.COMMENT_HEAD = 108, exports.COMMON_EVENT = 117, exports.CONDITIONAL_BRANCH = 111, exports.CONDITIONAL_BRANCH_ELSE = 411, exports.CONTROL_SELF_SWITCH = 123, exports.CONTROL_SWITCHES = 121, exports.CONTROL_TIMER = 124, exports.CONTROL_VARIABLES = 122, exports.DEFAULT_DAMAGE_LABELS = I, exports.DEFAULT_GLOBAL_LABELS = Ct, exports.DEFAULT_ITEM_LABELS = { title: "アイテム", options: { consumable: "消耗品" } }, exports.DEFAULT_SKILL_LABELS = { title: "スキル", options: { requiredWeaponTypeId1: "必要武器タイプ1", requiredWeaponTypeId2: "必要武器タイプ2", mpCost: "MP消費", tpCost: "TP消費" } }, exports.DEFAULT_SYSTEM_LABELS_BOOLEAN = { title: "オプション", options: {
  ...
  code: e2.code,
  indent: e2.indent,
  parameters: Ka(e2.parameters)
}), exports.cloneParameters = Ka, exports.collapsOptionsToArray = R, exports.compileFormatRule = Y, exports.compileItemEffectDisplayData = (e2, t2, a2) => {
  const r2 = ne(t2);
  ...
  indent: a2,
  parameters: t2
}), exports.createNoteEntity = Ve, exports.createSystemVariableControlChars = (e2) => e2.variables.map((e3, a2) => ({ text: e3 || "", controlChar: t("V", a2) })).filter((e3) => "" !== e3.text), exports.defineGameDataSources = p, exports.defineSystemItems = $t, exports.defineTraitCollapseType = S, exports.defineTraitExtraParam = C, exports.defineTraitItems = G, exports.defineTraitPartyAbility = v, exports.defineTraitRegularParam = N, exports.defineTraitSpecialFlag = P, exports.defineTraitSpecialParam = M, exports.detectFormatErrors = (e2, t2, a2, r2 = {
...
}], semanticErrors: [] } : { formatLabel: e2.label, semanticErrors: Z(e2, t2, a2), syntaxErrors: $(e2.pattern, t2, a2, r2.placeHolderMaxLength) }, exports.domainNames = (e2) => Object.entries(e2).map(([, e3]) => e3.title), exports.extraParamName = (e2, t2) => {
  switch (e2) {
    case 3:
...
}, exports.getArmorCategoryEnabled = (e2) => e2.itemCategories[2], exports.getArmorTypes = Kt, exports.getControlChars = (e2) => Array.from(e2.matchAll(/\\([A-Za-z]+)\[(\d+)]/g)).map((e3) => ({ char: e3[1], id: parseInt(e3[2], 10) })), exports.getElementTypes = jt, exports.getEnemyValue = (e2, t2) => {
  switch (t2[6]) {
    case 0:
      return e2.hp;
    case 1:
  ...
  name: e3,
  id: t2
})), exports.getSaveCommandEnabled = (e2) => e2.menuCommands[5], exports.getSkillCommandEnabled = (e2) => e2.menuCommands[1], exports.getSkillTypes = Wt, exports.getStatusCommandEnabled = (e2) => e2.menuCommands[3], exports.getSwitches = Xt, exports.getVariableNames = Vt, exports.getWeaponCategoryEnabled = (e2) => e2.itemCategories[1], exports.getWeaponTypes = zt, exports.isCloneableCommand = (e2) => e2.parameters.every(Xa), exports.isCommandAudio = er, exports.isCommandChangeActorText = (e2) => Za(e2), exports.isCommandChangeBattleBgm = (e2) => er(e2) && 132 === e2.code, exports.isCommandChangeDefeatMe = (e2) => er(e2) && 139 === e2.code, exports.isCommandChangeVictoryMe = (e2) => er(e2) && 133 === e2.code, exports.isCommandCommentBody = (e2) => rr(e2) && 408 === e2.code, exports.isCommandCommentHeader = (e2) => rr(e2) && 108 === e2.code, exports.isCommandCommonEvent = (e2) => or(e2), exports.isCommandInputNumber = (e2) => nr(e2), exports.isCommandNonParam = (e2) => tr(e2), exports.isCommandPlayBgm = (e2) => er(e2) && 241 === e2.code, exports.isCommandPlayBgs = (e2) => er(e2) && 245 === e2.code, exports.isCommandPlayMe = (e2) => er(e2) && 249 === e2.code, exports.isCommandPlaySe = (e2) => er(e2) && 250 === e2.code, exports.isCommandScriptBody = (e2) => rr(e2) && 655 === e2.code, exports.isCommandScriptHeader = (e2) => rr(e2) && 355 === e2.code, exports.isCommandScrollTextHead = (e2) => Ja(e2), exports.isCommandShowChoiceItem = (e2) => sr(e2), exports.isCommandShowChoices = (e2) => ir(e2), exports.isCommandShowMessage = (e2) => mr(e2), exports.isCommandShowMessageBody = (e2) => rr(e2) && 401 === e2.code, exports.isCommandShowScrollingTextBody = (e2) => rr(e2) && 405 === e2.code, exports.isCommandTextBody = rr, exports.isDataActor = (e2) => He(e2), exports.isDataArmor = (e2) => we(e2), exports.isDataClass = (e2) => qe(e2), exports.isDataEnemy = (e2) => Ge(e2), exports.isDataItem = (e2) => De(e2), exports.isDataMap = (e2) => m(e2), exports.isDataMapInfo = (e2) => n(e2), exports.isDataSkill = (e2) => Fe(e2), exports.isDataState = (e2) => Ue(e2), exports.isDataSystem = (e2) => ha(e2), exports.isDataWeapon = (e2) => Be(e2), exports.isValidNumber = (e2) => "number" == typeof e2 && !Number.isNaN(e2), exports.labelsRegistry = () => ({ rpg: { damage: I, data: T, traits: B, itemEffect: fe }, global: Ct }), exports.makeActorData = (e2 = {}) => ({
  name: e2.name ?? "",
  id: e2.id ?? 0,
  ...
  price: e2.price ?? 0
}), exports.makeAudioCommand = (e2, t2) => Fa(e2, Nt({ name: t2 })), exports.makeAudioFileParams = Nt, exports.makeBooleanOptions = Dt, exports.makeClassData = (e2 = {}) => ({
  name: e2.name ?? "",
  id: e2.id ?? 0,
  traits: [],
  note: e2.note ?? "",
...
}), exports.makeCommandAudioAny = Fa, exports.makeCommandChangeActorName = (e2, t2 = 0) => ({ code: 320, parameters: [e2.actorId, e2.name], indent: t2 }), exports.makeCommandChangeActorNickName = (e2, t2 = 0) => ({ code: 324, parameters: [e2.actorId, e2.nickname], indent: t2 }), exports.makeCommandChangeActorProfile = (e2, t2 = 0) => ({
  code: 325,
  parameters: [e2.actorId, e2.profile],
  indent: t2
}), exports.makeCommandChangeBattleBGM = (e2, t2 = 0) => Fa(132, e2, t2), exports.makeCommandChangeDefeatME = (e2, t2 = 0) => Fa(139, e2, t2), exports.makeCommandChangeVictoryME = (e2, t2 = 0) => Fa(133, e2, t2), exports.makeCommandCommentBody = Ua, exports.makeCommandCommentHeader = Ga, exports.makeCommandCommonEvent = (e2, t2 = 0) => ({
  code: 117,
  indent: t2,
  parameters: Ha(e2 ?? {})
  ...
  indent: t2,
  parameters: qa(e2 ?? {})
}), exports.makeCommandPlayBGM = (e2, t2 = 0) => Fa(241, e2, t2), exports.makeCommandPlayBGS = (e2, t2 = 0) => Fa(245, e2, t2), exports.makeCommandPlayME = (e2, t2 = 0) => Fa(249, e2, t2), exports.makeCommandPlaySE = (e2, t2 = 0) => Fa(250, e2, t2), exports.makeCommandScriptArray = (e2, t2 = 0) => e2.map((e3, a2) => 0 === a2 ? Ya(e3, t2) : Wa(e3, t2)), exports.makeCommandScriptBody = Wa, exports.makeCommandScriptHeader = Ya, exports.makeCommandScrollingTextBody = (e2 = "", t2 = 0) => ({ code: 405, indent: t2 ?? 0, parameters: ja(e2) }), exports.makeCommandScrollingTextHeader = (e2 = {}, t2 = 0) => ({
  code: 105,
  indent: t2,
  parameters: Va(e2)
  ...
  indent: t2,
  parameters: [e2]
}), exports.makeCommentArray = Ba, exports.makeCommentCommandArray = (e2, t2 = 0) => e2.map((e3, a2) => 0 === a2 ? Ga(e3, t2) : Ua(e3, t2)), exports.makeCommonEventData = (e2 = {}) => ({
  id: e2.id ?? 0,
  name: e2.name ?? "",
  trigger: e2.trigger ?? 0,
  list: e2.list ?? [],
  switchId: e2.switchId ?? 0
}), exports.makeDamage = _, exports.makeDataNames = sa, exports.makeDropItem = b, exports.makeEditorSetting = Ta, exports.makeEnemyAction = (e2 = {}) => ({
...
}), exports.makeItemCategories = Ot, exports.makeItemCategoriesFromArray = (e2) => ({ item: e2[0], weapon: e2[1], armor: e2[2], keyItem: e2[3] }), exports.makeItemData = (e2 = {}) => ({
  ...
  var t2;
}, exports.makeMenuCommandsEnabled = Pt, exports.makeMenuCommandsEnabledFromArray = (e2) => ({ item: e2[0], skill: e2[1], equip: e2[2], status: e2[3], formation: e2[4], save: e2[5] }), exports.makeParamNamesArray = Ea, exports.makeRegex = je, exports.makeSkillData = (e2 = {}) => ({
  ...
  return {
    ...
    ...sa(e2.dataNames ?? {}),
    magicSkills: Oa([]),
    airship: Aa((_e2 = e2.vehicles) == null ? void 0 : _e2.airship),
    boat: Aa((_f = e2.vehicles) == null ? void 0 : _f.boat),
    ship: Aa((_g = e2.vehicles) == null ? void 0 : _g.ship),
    ...
    testBattlers: La((_n = e2.battleTest) == null ? void 0 : _n.testBattlers, Da),
    ...
    windowTone: [0, 0, 0, 0],
    terms: va(e2.terms ?? {}),
    itemCategories: Ot(e2.itemCategories),
    partyMembersArray: Oa((_v = e2.gameInit) == null ? void 0 : _v.partyMembersArray),
    battleSystem: 0,
    battlerHue: 0,
    menuCommands: Pt(e2.menuComamnds)
  };
}, exports.makeTermsBasic = ma, exports.makeTermsBasicFromArray = (e2) => ({
  level: e2[0],
  levelA: e2[1],
  hp: e2[2],
  hpA: e2[3],
  ...
  experience: e2[8],
  exp: e2[9]
}), exports.makeTermsCommand = pa, exports.makeTermsCommandFromArray = (e2) => ({
  fight: e2[0],
  escape: e2[1],
  attack: e2[2],
  guard: e2[3],
  ...
  buy: e2[24],
  sell: e2[25]
}), exports.makeTermsMessages = ca, exports.makeTitleCommandWindow = (e2) => ({ background: e2.background ?? 0, offsetX: e2.offsetX ?? 0, offsetY: e2.offsetY ?? 0 }), exports.makeTroopData = (e2 = {}) => ({
  id: e2.id ?? 0,
  name: e2.name ?? "",
  members: e2.members ?? [],
  pages: e2.pages ?? []
...
}), exports.makeTroopMember = (e2 = {}) => ({ enemyId: e2.enemyId ?? 0, x: e2.x ?? 0, y: e2.y ?? 0, hidden: e2.hidden ?? false }), exports.makeVehicleData = Aa, exports.makeWeaponData = (e2 = {}) => ({
  id: e2.id ?? 0,
  name: e2.name ?? "",
  iconIndex: e2.iconIndex ?? 0,
  description: e2.description ?? "",
  ...
  initialLevel: e2.initialLevel ?? 0,
  maxLevel: e2.maxLevel ?? 0
}), exports.partyAbilityToArray = O, exports.pluginSourceToJSON = (e2) => Zr(e2), exports.readNote = (e2) => Ye(e2, (e3, t2) => [e3, t2]), exports.readNoteObject = (e2, t2) => Ye(e2.note, (a2, r2) => t2(a2, r2, e2)), exports.regularParamName = (e2, t2) => {
  switch (e2) {
    case 0:
      return t2.maxHp;
    case 1:
...
})(e2), exports.toArrayCommonEvent = Ha, exports.toArrayControlSwitches = wa, exports.toArrayInputNumber = qa, exports.toArrayOperandActorStatus = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 3, 3, t2.index, t2.param], exports.toArrayOperandConstant = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 0, t2.value], exports.toArrayOperandEnemyStatus = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 3, 4, t2.index, za[t2.param]], exports.toArrayOperandItemData = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 3, t2.type, t2.itemId], exports.toArrayOperandRandom = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 2, t2.min, t2.max], exports.toArrayOperandScript = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 4, t2.code], exports.toArrayOperandVariable = (e2, t2, a2 = 0) => [e2.startId, e2.endId ?? e2.startId, a2, 1, t2.variableId], exports.toArrayScrollingTextBody = ja, exports.toArrayScrollingTextHeader = Va, exports.toArraySetupChoice = (e2) => [e2.choices ?? [], e2.cancelType ?? 0, e2.defaultType ?? 0, e2.positionType ?? 2, e2.background ?? 0], exports.toArraySetupChoiceItem = (e2) => [e2.index ?? 0, e2.name ?? ""], exports.toArrayShowMessageHeader = (e2) => [e2.facename, e2.faceIndex, e2.background, e2.positionType, e2.speakerName];
