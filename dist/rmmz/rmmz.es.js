import { m as E, r as k, G as R, ai as J, y as U, p as w, u as W, I as X, B as G, g as $, R as aa, V as ea, q as g, N as b, b as O, aa as A, aC as h, aS as ta, aR as ra, az as ma, ay as K, aH as sa, aI as oa, X as t, am as na, an as da, ao as ia, aq as ca, d as pa, M as la, f as Ea } from "../shared/eventCommandCodes.es.js";
import { A as Hs, C as xs, a as Ys, c as Us, e as ws, h as Ws, i as Xs, j as Ks, k as qs, l as js, n as zs, o as Qs, s as Zs, t as Js, v as $s, w as ao, x as eo, z as to, D as ro, E as mo, F as so, H as oo, J as no, K as io, L as co, O as po, P as lo, Q as Eo, S as Ao, T as Co, U as Io, W as To, Y as _o, Z as So, _ as ko, $ as Ro, a0 as yo, a1 as Mo, a2 as Po, a3 as Lo, a4 as No, a5 as go, a6 as bo, a7 as uo, a8 as Oo, a9 as Do, ab as Fo, ac as vo, ad as Vo, ae as fo, af as Go, ag as ho, ah as Bo, aj as Ho, ak as xo, al as Yo, ap as Uo, ar as wo, as as Wo, at as Xo, au as Ko, av as qo, aw as jo, ax as zo, aA as Qo, aB as Zo, aD as Jo, aE as $o, aF as an, aG as en, aJ as tn, aK as rn, aL as mn, aM as sn, aN as on, aO as nn, aP as dn, aQ as cn, aT as pn, aU as ln, aV as En, aW as An, aX as Cn, aY as In } from "../shared/eventCommandCodes.es.js";
import { ba as y, bc as M, bd as I, bb as P } from "../shared/namedItems.es.js";
import { C as _n, a as Sn, b as kn, c as Rn, E as yn, d as Mn, e as Pn, f as Ln, g as Nn, h as gn, i as bn, j as un, k as On, l as Dn, m as Fn, n as vn, o as Vn, p as fn, q as Gn, r as hn, s as Bn, t as Hn, u as xn, v as Yn, w as Un, x as wn, y as Wn, F as Xn, z as Kn, A as qn, B as jn, K as zn, D as Qn, G as Zn, P as Jn, H as $n, I as ad, J as ed, L as td, M as rd, R as md, N as sd, O as od, Q as nd, S as dd, T as id, U as cd, V as pd, W as ld, X as Ed, Y as Ad, Z as Cd, _ as Id, $ as Td, a0 as _d, a1 as Sd, a2 as kd, a3 as Rd, a4 as yd, a5 as Md, a6 as Pd, a7 as Ld, a8 as Nd, a9 as gd, aa as bd, ab as ud, ac as Od, ad as Dd, ae as Fd, af as vd, ag as Vd, ah as fd, ai as Gd, aj as hd, ak as Bd, al as Hd, am as xd, an as Yd, ao as Ud, ap as wd, aq as Wd, ar as Xd, as as Kd, at as qd, au as jd, av as zd, aw as Qd, ax as Zd, ay as Jd, az as $d, aA as ai, aB as ei, aC as ti, aD as ri, aE as mi, aF as si, aG as oi, aH as ni, aI as di, aJ as ii, aK as ci, aL as pi, aM as li, aN as Ei, aO as Ai, aP as Ci, aQ as Ii, aR as Ti, aS as _i, aT as Si, aU as ki, aV as Ri, aW as yi, aX as Mi, aY as Pi, aZ as Li, a_ as Ni, a$ as gi, b0 as bi, b1 as ui, b2 as Oi, b3 as Di, b4 as Fi, b5 as vi, b6 as Vi, b7 as fi, b8 as Gi, b9 as hi } from "../shared/namedItems.es.js";
import { g as Aa, f as Ca } from "../shared/applyFormat.es.js";
import { O as Hi, a as xi, b as Yi, c as Ui, d as wi, e as Wi } from "../shared/applyFormat.es.js";
import { c as Ki, a as qi, g as ji, b as zi, d as Qi, e as Zi, f as Ji, h as $i, i as ac, j as ec, k as tc, l as rc, m as mc, n as sc, o as oc, p as nc, q as dc, r as ic, s as cc, t as pc, u as lc, v as Ec, w as Ac, x as Cc, y as Ic, z as Tc, A as _c, B as Sc, C as kc, D as Rc, E as yc, F as Mc, G as Pc, H as Lc, I as Nc, J as gc, K as bc, L as uc, M as Oc, N as Dc, O as Fc, P as vc, Q as Vc, R as fc, S as Gc, T as hc, U as Bc, V as Hc, W as xc, X as Yc, Y as Uc, Z as wc, _ as Wc, $ as Xc, a0 as Kc, a1 as qc, a2 as jc, a3 as zc, a4 as Qc, a5 as Zc, a6 as Jc, a7 as $c, a8 as ap, a9 as ep, aa as tp, ab as rp, ac as mp, ad as sp, ae as op, af as np, ag as dp, ah as ip, ai as cp, aj as pp, ak as lp, al as Ep, am as Ap, an as Cp, ao as Ip, ap as Tp, aq as _p, ar as Sp, as as kp, at as Rp } from "../shared/makeSystemEx.es.js";
import { c as Mp, f as Pp, m as Lp, a as Np, b as gp, d as bp, e as up, g as Op, h as Dp, i as Fp, j as vp, k as Vp, t as fp } from "../shared/commands.es.js";
import { m as Ia } from "../shared/makeAudio.es.js";
const Wa = (a, e = 0) => ({ code: E, indent: e, parameters: [0, a.actorId, 0, 0, a.exp, a.showMessaage] }), Xa = (a, e = 0) => ({
  code: E,
  indent: e,
  parameters: [0, a.actorId, 1, 0, a.exp, a.showMessaage]
}), Ka = (a, e = 0) => ({ code: E, indent: e, parameters: [0, a.actorId, 0, 1, a.variableId, a.showMessaage] }), qa = (a, e = 0) => ({
  code: E,
  indent: e,
  parameters: [0, a.actorId, 1, 1, a.variableId, a.showMessaage]
}), ja = (a, e = 0) => ({ code: E, indent: e, parameters: [1, a.targetVariableId, 0, 0, a.value, a.showMessaage] }), za = (a, e = 0) => ({
  code: E,
  indent: e,
...
}), Za = (a, e = 0) => ({ code: E, indent: e, parameters: [1, a.targetVariableId, 1, 1, a.operandVariableId, a.showMessaage] }), Ja = (a, e = 0) => ({
  code: k,
  indent: e,
  parameters: [0, a.actorId, 0, 0, a.level, a.showMessaage]
}), $a = (a, e = 0) => ({ code: k, indent: e, parameters: [0, a.actorId, 1, 0, a.level, a.showMessaage] }), ae = (a, e = 0) => ({
  code: k,
  indent: e,
  parameters: [0, a.actorId, 0, 1, a.variableId, a.showMessaage]
}), ee = (a, e = 0) => ({ code: k, indent: e, parameters: [0, a.actorId, 1, 1, a.variableId, a.showMessaage] }), te = (a, e = 0) => ({
  code: k,
  indent: e,
  parameters: [0, 0, 0, 0, a.level, a.showMessaage]
}), re = (a, e = 0) => ({ code: k, indent: e, parameters: [0, 0, 1, 0, a.level, a.showMessaage] }), me = (a, e = 0) => ({
  code: R,
  indent: e,
...
}), le = (a, e = 0) => ({ code: 313, indent: e, parameters: [0, 0, 0, a.stateId] }), Ee = (a, e = 0) => ({ code: 313, indent: e, parameters: [0, 0, 1, a.stateId] }), Ae = (a, e = 0) => ({
  code: 313,
  indent: e,
...
}), Te = (a = 0) => ({ code: 314, indent: a, parameters: [0, 0] }), _e = (a, e = 0) => ({ code: 314, indent: e, parameters: [0, a.targetActorId] }), Se = (a, e = 0) => ({
  code: 314,
  indent: e,
  parameters: [1, a.variableId]
}), ke = (a, e = 0) => ({ code: U, indent: e, parameters: q(a, 0) }), Re = (a, e = 0) => ({
  code: U,
  indent: e,
  parameters: q(a, 1)
}), q = (a, e) => [a.actorId, a.paramId, e, a.value], S = { direct: 0, variable: 1 }, ye = (a, e = 0) => ({ code: w, indent: e, parameters: j(0, a) }), Me = (a, e = 0) => ({
  code: w,
  indent: e,
  parameters: j(1, a)
}), Pe = (a, e = 0) => ({ code: X, indent: e, parameters: D(0, a) }), Le = (a, e = 0) => ({ code: X, indent: e, parameters: D(1, a) }), Ne = (a, e = 0) => ({ code: W, indent: e, parameters: D(0, a) }), ge = (a, e = 0) => ({
  code: W,
  indent: e,
  parameters: D(1, a)
...
const qe = (a) => ({ enemyId: a[0], newEnemyId: a[1] }), je = (a, e = 0) => ({
...
}), at = (a, e = 0) => ({ code: aa, indent: e, parameters: Sa(a ?? {}) }), et = (a) => ({ eventId: a[0] }), Sa = (a) => [a.eventId ?? 0], tt = (a) => ({
  min: a[0],
  max: a[1],
  value: a[2]
}), ka = (a) => [a.min, a.max, a.value], rt = (a, e = 0) => ({ code: ea, indent: e, parameters: ka(a) }), mt = (a, e = 0) => ({
  code: 103,
  ...
  value: a[3],
  operand: a[2]
}), it = (a, e = 0) => ({ code: g, indent: e, parameters: [a.itemId, a.operation, a.operand, a.value] }), ct = (a, e = 0) => ({ code: g, indent: e, parameters: [a.itemId, y, M, a.value] }), pt = (a, e = 0) => ({
  code: g,
  indent: e,
  parameters: [a.itemId, y, I, a.variableId]
}), lt = (a, e = 0) => ({ code: g, indent: e, parameters: [a.itemId, P, M, a.value] }), Et = (a, e = 0) => ({
  code: g,
  indent: e,
  parameters: [a.itemId, P, I, a.variableId]
}), At = (a) => ({ operation: a[1], weaponId: a[0], value: a[3], operand: a[2], includesEquip: a[4] }), Ct = (a, e = 0) => ({
  code: b,
  indent: e,
  parameters: [a.weaponId, a.operation, a.operand, a.value, a.includesEquip]
}), It = (a, e = 0) => ({ code: b, indent: e, parameters: [a.weaponId, y, M, a.value, !1] }), Tt = (a, e = 0) => ({
  code: b,
  indent: e,
  parameters: [a.weaponId, y, I, a.variableId, !1]
}), _t = (a, e = 0) => ({ code: b, indent: e, parameters: [a.weaponId, P, M, a.value, !1] }), St = (a, e = 0) => ({
  code: b,
  indent: e,
  parameters: [a.weaponId, P, I, a.variableId, !1]
}), kt = (a, e = 0) => ({ code: O, indent: e, parameters: [a.armorId, y, M, a.value, !1] }), Rt = (a, e = 0) => ({
  code: O,
  indent: e,
  parameters: [a.armorId, y, I, a.variableId, !1]
}), yt = (a, e = 0) => ({ code: O, indent: e, parameters: [a.armorId, P, M, a.value, !1] }), Mt = (a, e = 0) => ({
  code: O,
  indent: e,
  parameters: [a.armorId, P, I, a.variableId, !1]
}), Pt = (a, e = 0) => ({ code: 104, parameters: [a.variableId, a.itemType], indent: e }), Lt = (a) => ({ variableId: a[0], itemType: a[1] }), Nt = (a, e = 0) => ({
  code: 284,
  indent: e,
...
}), Ft = (a, e = 0) => ({ code: A, indent: e, parameters: [a.variableId, 0, 0, a.x, a.y] }), vt = (a, e = 0) => ({
  code: A,
  indent: e,
  parameters: [a.variableId, 1, 1, a.x, a.y]
}), Vt = (a, e = 0) => ({ code: A, indent: e, parameters: [a.variableId, 1, 0, a.x, a.y] }), ft = (a, e = 0) => ({ code: A, indent: e, parameters: [a.variableId, 6, 1, a.x, a.y] }), Gt = (a, e = 0) => ({
  code: A,
  indent: e,
  parameters: [a.variableId, 6, 0, a.x, a.y]
}), ht = (a, e = 0) => ({ code: A, indent: e, parameters: [a.variableId, Q[a.layer] ?? 2, 1, a.x, a.y] }), Bt = (a, e = 0) => ({
  code: A,
  indent: e,
  ...
  indent: e
}), lr = (a, e = 0) => ({ code: 125, parameters: [1, 0, a.value], indent: e }), Er = (a, e = 0) => ({ code: 125, parameters: [0, 1, a.variableId], indent: e }), Ar = (a, e = 0) => ({
  code: 125,
  ...
  indent: a,
  parameters: []
}), Sr = (a = 0) => ({ code: 221, indent: a, parameters: [] }), kr = (a, e = 0) => ({
  code: 224,
  indent: e,
  ...
  indent: e,
  parameters: [a]
}), Mr = (a, e = 0) => a.map(((r, m) => m === 0 ? Ma(r, e) : Pa(r, e))), Pr = 1, Lr = 0, u = { item: 0, weapon: 1, armors: 2 }, Nr = ({ goods: a, buyOnly: e = !1 }, r = 0) => a.map(((m, n) => {
  ...
  indent: e,
  parameters: c(a, i.X)
}), lm = (a, e = 0) => ({ code: t, indent: e, parameters: c(a, i.Y) }), Em = (a, e = 0) => ({ code: t, indent: e, parameters: c(a, i.DIRECTION) }), Am = (a, e = 0) => ({
  code: t,
  indent: e,
...
}), _m = (a, e = 0) => ({ code: t, indent: e, parameters: c({ startId: a.startId, endId: a.endId, operation: a.operation, charactorId: -1 }, i.DIRECTION) }), Sm = (a, e = 0) => ({
  code: t,
  indent: e,
  parameters: c({ startId: a.startId, endId: a.endId, operation: a.operation, charactorId: -1 }, i.SCREEN_X)
}), km = (a, e = 0) => ({ code: t, indent: e, parameters: c({
  startId: a.startId,
  endId: a.endId,
  operation: a.operation,
  charactorId: -1
  ...
  indent: e,
  parameters: F(a, 0)
}), ym = (a, e = 0) => ({ code: t, indent: e, parameters: F(a, 1) }), Mm = (a, e = 0) => ({ code: t, indent: e, parameters: F(a, 2) }), Pm = (a, e = 0) => ({
  code: t,
  indent: e,
  parameters: F(a, 3)
...
}), zm = 0, Qm = 1, Zm = 2, Jm = (a) => a.code === na || a.code === da || a.code === ia || a.code === ca || a.code === pa || a.code === la || a.code === Ea, Da = (a) => [...a], $m = (a) => ({
  code: a.code,
  indent: a.indent,
  ...
  speed: "速度補正",
  successRate: "成功率"
} }, As = "data", Cs = "actor", Is = "map", Ts = "enemy", _s = "state", Ss = "skill", ks = "item", Rs = "weapon", ys = "armor", Ms = "class", Ps = "common_event", Ls = "troop", Ha = {
  id: "識別子",
  name: "名前",
  note: "メモ",
  description: "説明",
...
export {
  ...
  _o as ENEMY_APPEAR,
  So as ENEMY_RECOVER_ALL,
  ko as ENEMY_TRANSFORM,
  Ro as ERASE_EVENT,
  yo as ERASE_PICTURE,
  Mo as EXIT_EVENT_PROCESSING,
  ...
  vo as INPUT_NUMBER,
  zn as KEYWORD_GAME_OBJECTS,
  Qn as KEYWORD_GAME_VALIABLES,
  Zn as KEYWORD_MATH,
  Vo as LABEL,
  ...
  Hi as OPERATION_ADD,
  xi as OPERATION_DIVIDE,
  Yi as OPERATION_MOD,
  Ui as OPERATION_MULTIPLY,
  wi as OPERATION_SET,
  Wi as OPERATION_SUBTRACT,
  Jn as PARTY_ABILITY_CANCEL_SURPRISE,
  $n as PARTY_ABILITY_DROP_ITEM_DOUBLE,
  ad as PARTY_ABILITY_ENCOUNTER_HALF,
  ed as PARTY_ABILITY_ENCOUNTER_NONE,
  td as PARTY_ABILITY_GOLD_DOUBLE,
  rd as PARTY_ABILITY_RAISE_PREEMPTIVE,
  na as PLAY_BGM,
  da as PLAY_BGS,
  ia as PLAY_ME,
  Uo as PLAY_MOVIE,
  ...
  Xo as RECOVER_ALL,
  md as REGULAR_PARAM_AGI,
  sd as REGULAR_PARAM_ATK,
  od as REGULAR_PARAM_DEF,
  nd as REGULAR_PARAM_LUK,
  dd as REGULAR_PARAM_MATK,
  id as REGULAR_PARAM_MAX_HP,
  cd as REGULAR_PARAM_MAX_MP,
  pd as REGULAR_PARAM_MDEF,
  Ko as RESUME_BGM,
  ...
  ld as SPECIAL_PARAM_EXR,
  Ed as SPECIAL_PARAM_FDR,
  Ad as SPECIAL_PARAM_GRD,
  Cd as SPECIAL_PARAM_MCR,
  Id as SPECIAL_PARAM_MDR,
  Td as SPECIAL_PARAM_PDR,
  _d as SPECIAL_PARAM_PHA,
  Sd as SPECIAL_PARAM_REC,
  kd as SPECIAL_PARAM_TCR,
  Rd as SPECIAL_PARAM_TGR,
  Cs as SRC_DATA_ACTOR,
  ys as SRC_DATA_ARMOR,
  Ms as SRC_DATA_CLASS,
  Ps as SRC_DATA_COMMON_EVNET,
  Ts as SRC_DATA_ENEMY,
  ks as SRC_DATA_ITEMS,
  Is as SRC_DATA_MAP,
  ...
  En as TINT_PICTURE,
  An as TINT_SCREEN,
  yd as TRAIT_ACTION_PLUS,
  Md as TRAIT_ATTACK_ELEMENT,
  Pd as TRAIT_ATTACK_SKILL,
  Ld as TRAIT_ATTACK_SPEED,
  Nd as TRAIT_ATTACK_STATE,
  gd as TRAIT_ATTACK_TIMES,
  bd as TRAIT_COLLAPSE_TYPE,
  ud as TRAIT_DEBUFF_RATE,
  Od as TRAIT_ELEMENT_RATE,
  Dd as TRAIT_EQUIP_ARMOR_TYPE,
  Fd as TRAIT_EQUIP_LOCK,
  vd as TRAIT_EQUIP_SEAL,
  Vd as TRAIT_EQUIP_WEAPON_TYPE,
  fd as TRAIT_PARAM,
  Gd as TRAIT_PARTY_ABILITY,
  hd as TRAIT_SKILL_ADD,
  Bd as TRAIT_SKILL_SEAL,
  Hd as TRAIT_SKILL_TYPE_ADD,
  xd as TRAIT_SKILL_TYPE_SEAL,
  Yd as TRAIT_SLOT_TYPE,
  Ud as TRAIT_SPARAM,
  wd as TRAIT_SPECIAL_FLAG,
  Wd as TRAIT_STATE_RATE,
  Xd as TRAIT_STATE_RESIST,
  Kd as TRAIT_XPARAM,
  ...
  qd as buildNoteFromNormalized,
  mr as cloneChoices,
  $m as cloneEventCommand,
  Da as cloneParameters,
  jd as collapsOptionsToArray,
  Ki as convertCommentArrayToObject,
  Mp as convertTermsMessageMZtoMV,
  zd as createActorControlChars,
  Qd as createControlCharFormat,
  qi as createMenuCommandState,
  Zd as createNoteEntity,
  Jd as createSystemVariableControlChars,
  $d as defineGameDataSources,
  ai as defineSystemItems,
  ei as defineTraitCollapseType,
  ti as defineTraitExtraParam,
  ri as defineTraitItems,
  mi as defineTraitPartyAbility,
  si as defineTraitRegularParam,
  oi as defineTraitSpecialFlag,
  ni as defineTraitSpecialParam,
  di as extraParamName,
  ii as extraParamsToArray,
  Gs as extractFileName,
  cs as formatItemEffectText,
  rs as formatTraitText,
  dt as fromArrayChangeItems,
  At as fromArrayChangeWeapons,
  ...
  Pp as fromArrayShowMessageHeader,
  ci as fromStringArray,
  ji as getArmorCategoryEnabled,
  pi as getArmorTypes,
  es as getControlChars,
  li as getElementTypes,
  zi as getEquipCommandEnabled,
  Ei as getEquipTypes,
  Qi as getFormationCommandEnabled,
  Zi as getItemCategoryEnabled,
  Ji as getItemCommandEnabled,
  Ai as getItemIdFromItemCommand,
  $i as getKeyItemCategoryEnabled,
  Ci as getNoteValue,
  us as getParamNames,
  ac as getSaveCommandEnabled,
  ec as getSkillCommandEnabled,
  Ii as getSkillTypes,
  tc as getStatusCommandEnabled,
  Ti as getSwitches,
  _i as getVariableNames,
  rc as getWeaponCategoryEnabled,
  Si as getWeaponTypes,
  as as isCloneableCommand,
  Jm as isCommandAnyAudio,
  He as isCommandBattleProcessingVariable,
  sm as isCommandOperandVariables,
  ki as isScript,
  Ri as isUsingVariableItemCommand,
  nt as isUsingVaribleCommandChangingItems,
  Ns as labelsRegistry,
  mc as makeActorData,
  sc as makeActorDataFromTestSoruce,
  oc as makeArmorData,
  nc as makeArmorDataFromTestSoruce,
  dc as makeAudioCommand,
  ic as makeBattleEventPage,
  cc as makeBooleanOptions,
  pc as makeClassData,
  lc as makeClassDataEx,
  Ec as makeClassDataFromTestSoruce,
  Qe as makeCommandAddEachEnemyState,
  je as makeCommandAddEnemyState,
  ir as makeCommandAddPartyMember,
  Ae as makeCommandAddStateByVariable,
  le as makeCommandAddStateEachActor,
  ce as makeCommandAddStateTargetActor,
  Ac as makeCommandAudioAny,
  xe as makeCommandBattleProcessingDirect,
  Ue as makeCommandBattleProcessingEncount,
  Ye as makeCommandBattleProcessingVariable,
  Cc as makeCommandChangeActorImages,
  Ic as makeCommandChangeActorName,
  Tc as makeCommandChangeActorNickName,
  _c as makeCommandChangeActorProfile,
  Sc as makeCommandChangeBattleBGM,
  fe as makeCommandChangeBattleBackground,
  kc as makeCommandChangeClass,
  Rc as makeCommandChangeDefeatME,
  ...
  Mc as makeCommandChangeVictoryME,
  Ct as makeCommandChangeWeapons,
  Pc as makeCommandCommentBody,
  Lc as makeCommandCommentHeader,
  ...
  Pe as makeCommandGainActorTP,
  kt as makeCommandGainArmor,
  ...
  ke as makeCommandIncreaseActorParam,
  ...
  Ar as makeCommandLoseGoldByVariable,
  ...
  Nc as makeCommandPlayBGM,
  gc as makeCommandPlayBGS,
  bc as makeCommandPlayME,
  sr as makeCommandPlayMovie,
  uc as makeCommandPlaySE,
  ...
  Lp as makeCommandShowMessage,
  Np as makeCommandShowMessageBody,
  ...
  Am as makeCommandVariableFromMapCharactorScreenX,
  ...
  km as makeCommandVariableFromMapPlayerScreenY,
  ...
  Pm as makeCommandVariableFromPartySteps,
  ...
  Oc as makeCommentArray,
  Dc as makeCommentCommandArray,
  Fc as makeCommonEventData,
  vc as makeDamage,
  bs as makeDataNames,
  Vc as makeDropItem,
  fc as makeEditorSetting,
  Gc as makeEnemyAction,
  hc as makeEnemyData,
  Bc as makeEnemyDataFromTestSoruce,
  Hc as makeEventPageCondition,
  gs as makeGameInitial,
  xc as makeItemCategories,
  Yc as makeItemCategoriesFromArray,
  Uc as makeItemData,
  wc as makeItemDataFromTestSoruce,
  Wc as makeMapData,
  Xc as makeMapDataFromSingleEvent,
  Kc as makeMapEvent,
  qc as makeMapEventIamge,
  jc as makeMapEventPage,
  zc as makeMapFileInfo,
  Qc as makeMapInfoData,
  Zc as makeMapName,
  Jc as makeMenuCommandsEnabled,
  $c as makeMenuCommandsEnabledFromArray,
  ap as makeParamArray,
  gp as makeParamNamesArray,
  bp as makeParamNamesFromArray,
  ep as makeSkillData,
  tp as makeSkillDataFromTestSoruce,
  rp as makeSoundsArray,
  mp as makeSoundsObject,
  sp as makeStateData,
  op as makeStateDataFromTestSoruce,
  np as makeSystemAdvanced,
  dp as makeSystemData,
  ip as makeSystemDataFromMV,
  cp as makeSystemDataMV,
  up as makeTermsBasic,
  Op as makeTermsBasicFromArray,
  Dp as makeTermsCommandArray,
  Fp as makeTermsCommandArrayWithNulls,
  vp as makeTermsCommandFromArray,
  Vp as makeTermsMessages,
  pp as makeTestAudioCommands,
  lp as makeTestSystemData,
  Ep as makeTitleCommandWindow,
  Ap as makeTroopData,
  Cp as makeTroopEventConditions,
  Ip as makeTroopMember,
  Tp as makeVehicleData,
  _p as makeWeaponData,
  Sp as makeWeaponDataFromTestSoruce,
  kp as normalizeDataActor,
  yi as normalizeNote,
  Rp as paramArrayToObject,
  Mi as partyAbilityToArray,
  Pi as readNote,
  Li as readNoteEx,
  Ni as readNoteEx2,
  gi as readNoteObject,
  bi as regularParamName,
  ui as regularParamsToArray,
  Oi as replaceNote,
  Di as replaceNoteWithHandlers,
  ts as repleaceMapEventCommands,
  Fi as resolveItemEffectLabels,
  vi as resolveTraitLabels,
  Vi as setNoteValue,
  fi as specialFlagToArray,
  Gi as specialParamName,
  hi as specialParamsToArray,
  Vs as textAndDesc,
