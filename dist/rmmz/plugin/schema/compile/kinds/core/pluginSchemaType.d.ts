import { BooleanParam, StructArrayRefParam, StructRefParam, StructParamPrimitive } from './primitiveParams';
...
export type PluginSchemaType<T> = T extends boolean ? BooleanParam : T extends number ? Extract<StructParamPrimitive, {
    default: number;
