import { NewRmmzParam_Boolean } from './newParamType';
...
import { RmmzParamCore_DataId } from './rpgDataId';
import { RmmzParamCore_Select } from './select';
import { RmmzParamCore_String, RmmzParamCore_FilePath, RmmzParamCore_Combo } from './string';
...
export type AnnotationSigleTypes = BooleanArg | Primitive_Numbers | Primitive_Strings;
export type AnnotationArrayTypes = Primitive_NumbersArray | Primitive_StringsArray;
export type AnnotationPrimitiveTypes = AnnotationSigleTypes | AnnotationArrayTypes;
type List = [
    NumberArg,
    Actor,
    Switch,
