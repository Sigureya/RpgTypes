...
const V = v((function() {
  ...
  return X = 1, T.exports = t, T.exports.default = t, T.exports;
})()), me = (t) => V(t);
var Y, q = { exports: {} };
const Z = v((function() {
                                            ...
                                            }], !1;
                                            {
                                              ...
                                              if (g) {
                                                if (n.dataId !== void 0) {
                                                  ...
                                                  if (typeof f == "number" && isFinite(f) && (f < 0 || isNaN(f))) return t.errors = [{
                                                    instancePath: i + "/effects/" + p + "/dataId",
