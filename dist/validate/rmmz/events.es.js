...
const Fe = be(function() {
  ...
  function u(P, { instancePath: n = "", parentData: l, parentDataProperty: s, rootData: Pe = P } = {}) {
    ...
    {
      let t;
      if (P.code === void 0 && (t = "code") || P.parameters === void 0 && (t = "parameters") || P.indent === void 0 && (t = "indent")) return u.errors = [{
        instancePath: n,
        schemaPath: "#/required",
        keyword: "required",
      ...
      for (const e in P) if (e !== "code" && e !== "indent" && e !== "parameters") return u.errors = [{
        instancePath: n,
      ...
      if (P.code !== void 0) {
        let e = P.code;
        const m = 0;
        if (typeof e != "number" || e % 1 || isNaN(e) || !isFinite(e)) return u.errors = [{
          instancePath: n + "/code",
        ...
        if (e !== 320 && e !== 324 && e !== 325) return u.errors = [{
          instancePath: n + "/code",
      ...
      if (L) {
        if (P.indent !== void 0) {
          let e = P.indent;
          const m = 0;
          if (typeof e != "number" || e % 1 || isNaN(e) || !isFinite(e)) return u.errors = [{ instancePath: n + "/indent", schemaPath: "#/properties/indent/type", keyword: "type", params: {
            type: "integer"
          }, message: "must be integer" }], !1;
          L = m === 0;
        } else L = !0;
        if (L) if (P.parameters !== void 0) {
          let e = P.parameters;
          const m = 0;
          if (!Array.isArray(e)) return u.errors = [{
            instancePath: n + "/parameters",
            schemaPath: "#/properties/parameters/type",
            keyword: "type",
            params: { type: "array" },
            message: "must be array"
          }], !1;
          if (e.length > 2) return u.errors = [{
            instancePath: n + "/parameters",
          ...
          }], !1;
          {
            ...
            if (k > 0) {
              let S = e[0];
              const w = 0;
              if (typeof S != "number" || !isFinite(S)) return u.errors = [{
                instancePath: n + "/parameters/0",
            ...
            if (D && k > 1) {
              if (typeof e[1] != "string") return u.errors = [{
                instancePath: n + "/parameters/1",
  ...
  function u(P, { instancePath: n = "", parentData: l, parentDataProperty: s, rootData: Pe = P } = {}) {
    ...
    }], !1;
    {
      ...
      if (P.code !== void 0) {
        ...
        if (e !== 132 && e !== 133 && e !== 139 && e !== 241 && e !== 245 && e !== 249 && e !== 250) return u.errors = [{
          instancePath: n + "/code",
          schemaPath: "#/properties/code/enum",
          keyword: "enum",
          params: { allowedValues: J.properties.code.enum },
      ...
      if (L) {
        ...
        if (L) if (P.parameters !== void 0) {
          ...
          if (e.length > 0) {
            let k = e[0];
            if (!k || typeof k != "object" || Array.isArray(k)) return u.errors = [{
              instancePath: n + "/parameters/0",
              schemaPath: "#/properties/parameters/items/0/type",
              keyword: "type",
              params: { type: "object" },
            ...
            {
              let S;
              if (k.name === void 0 && (S = "name") || k.volume === void 0 && (S = "volume") || k.pitch === void 0 && (S = "pitch") || k.pan === void 0 && (S = "pan")) return u.errors = [{
                instancePath: n + "/parameters/0",
              ...
              for (const w in k) if (w !== "name" && w !== "volume" && w !== "pitch" && w !== "pan") return u.errors = [{
                instancePath: n + "/parameters/0",
              ...
              if (k.name !== void 0) {
                if (typeof k.name != "string") return u.errors = [{
                  instancePath: n + "/parameters/0/name",
...
const Me = be(function() {
  ...
  }, u = { items: { oneOf: [{ type: "null" }, { required: ["id", "name", "x", "y", "pages", "note"], type: "object", properties: { id: { type: "integer" }, name: { type: "string" }, note: { type: "string" }, pages: {
    type: "array",
    items: {
  ...
  function n(l, { instancePath: s = "", parentData: Pe, parentDataProperty: L, rootData: D = l } = {}) {
    ...
    if (e === 0) {
      ...
      }], !1;
      {
        ...
        {
          const $e = e;
          for (const r in l) if (!P.call(J.properties, r)) return n.errors = [{
            instancePath: s,
            schemaPath: "#/additionalProperties",
            keyword: "additionalProperties",
          ...
          if ($e === e) {
            ...
            if (m) {
              if (l.autoplayBgs !== void 0) {
                const r = e;
                if (typeof l.autoplayBgs != "boolean") return n.errors = [{
              ...
              if (m) {
                if (l.battleback1Name !== void 0) {
                  const r = e;
                  if (typeof l.battleback1Name != "string") return n.errors = [{
                ...
                if (m) {
                  if (l.battleback2Name !== void 0) {
                    const r = e;
                    if (typeof l.battleback2Name != "string") return n.errors = [{
                  ...
                  if (m) {
                    if (l.bgm !== void 0) {
                      ...
                      if (e === e) {
                        ...
                        {
                          let V;
                          if (r.name === void 0 && (V = "name") || r.pan === void 0 && (V = "pan") || r.pitch === void 0 && (V = "pitch") || r.volume === void 0 && (V = "volume")) return n.errors = [{
                            instancePath: s + "/bgm",
                          ...
                          {
                            const o = e;
                            for (const p in r) if (p !== "name" && p !== "pan" && p !== "pitch" && p !== "volume") return n.errors = [{
                              instancePath: s + "/bgm",
                            ...
                            if (o === e) {
                              ...
                              if (k) {
                                if (r.pan !== void 0) {
                                  let p = r.pan;
                                  const R = e;
                                  if (typeof p != "number" || p % 1 || isNaN(p) || !isFinite(p)) return n.errors = [{
                      ...
                      if (m) {
                        ...
                        if (m) {
                          if (l.disableDashing !== void 0) {
                            const r = e;
                            if (typeof l.disableDashing != "boolean") return n.errors = [{
                          ...
                          if (m) {
                            if (l.displayName !== void 0) {
                              const r = e;
                              if (typeof l.displayName != "string") return n.errors = [{
                                ...
                                if (e === e) {
                                  ...
                                  }], !1;
                                  {
                                    ...
                                    for (let o = 0; o < V; o++) {
                                      ...
                                      const R = e;
                                      if (e === R) {
                                        if (!p || typeof p != "object" || Array.isArray(p)) return n.errors = [{
                                        ...
                                        {
                                          let Z;
                                          if (p.regionSet === void 0 && (Z = "regionSet") || p.troopId === void 0 && (Z = "troopId") || p.weight === void 0 && (Z = "weight")) return n.errors = [{
                                            instancePath: s + "/encounterList/" + o,
                                          ...
                                          {
                                            const re = e;
                                            for (const E in p) if (E !== "regionSet" && E !== "troopId" && E !== "weight") return n.errors = [{
                                              instancePath: s + "/encounterList/" + o,
                                                            ...
                                                            if (ce === e) {
                                                              if (f.stepAnime !== void 0) {
                                                                ...
                                                                if (typeof f.stepAnime != "boolean") {
                                                                  const b = {
                                                                    instancePath: s + "/events/" + o + "/pages/" + c + "/stepAnime",
                                                              ...
                                                              if (g) {
                                                                if (f.walkAnime !== void 0) {
                                                                  const a = e;
                                                                  if (typeof f.walkAnime != "boolean") {
                                                                    const b = {
                                                                      instancePath: s + "/events/" + o + "/pages/" + c + "/walkAnime",
                                                                ...
                                                                if (g) {
                                                                  if (f.through !== void 0) {
                                                                    const a = e;
                                                                    if (typeof f.through != "boolean") {
                                                                      const b = {
                                                                        instancePath: s + "/events/" + o + "/pages/" + c + "/through",
                                                                  ...
                                                                  if (g) {
                                                                    if (f.priorityType !== void 0) {
                                                                      let a = f.priorityType;
                                                                      const b = e;
                                                                      if (typeof a != "number" || a % 1 || isNaN(a) || !isFinite(a)) {
                                                                        const h = {
                                                                          instancePath: s + "/events/" + o + "/pages/" + c + "/priorityType",
                                                                    ...
                                                                    if (g) {
                                                                      if (f.moveSpeed !== void 0) {
                                                                        let a = f.moveSpeed;
                                                                        const b = e;
                                                                        if (typeof a != "number" || a % 1 || isNaN(a) || !isFinite(a)) {
                                                                          const h = {
                                                                            instancePath: s + "/events/" + o + "/pages/" + c + "/moveSpeed",
                                                                      ...
                                                                      if (g) {
                                                                        if (f.moveType !== void 0) {
                                                                          let a = f.moveType;
                                                                          const b = e;
                                                                          if (typeof a != "number" || a % 1 || isNaN(a) || !isFinite(a)) {
                                                                            const h = {
                                                                              instancePath: s + "/events/" + o + "/pages/" + c + "/moveType",
                                                                        ...
                                                                        if (g) {
                                                                          if (f.trigger !== void 0) {
                                                                            ...
                                                                            if (typeof a != "number" || a % 1 || isNaN(a) || !isFinite(a)) {
                                                                              const h = {
                                                                                instancePath: s + "/events/" + o + "/pages/" + c + "/trigger",
                                                                          ...
                                                                          if (g) {
                                                                            if (f.conditions !== void 0) {
                                                                              let a = f.conditions;
                                                                              const b = e;
                                                                              if (e === b) if (a && typeof a == "object" && !Array.isArray(a)) {
                                                                                let h;
                                                                                if (a.switch1Id === void 0 && (h = "switch1Id") || a.switch1Valid === void 0 && (h = "switch1Valid") || a.switch2Id === void 0 && (h = "switch2Id") || a.switch2Valid === void 0 && (h = "switch2Valid") || a.variableId === void 0 && (h = "variableId") || a.variableValid === void 0 && (h = "variableValid") || a.selfSwitchCh === void 0 && (h = "selfSwitchCh") || a.selfSwitchValid === void 0 && (h = "selfSwitchValid") || a.variableValue === void 0 && (h = "variableValue") || a.itemId === void 0 && (h = "itemId") || a.itemValid === void 0 && (h = "itemValid") || a.actorId === void 0 && (h = "actorId") || a.actorValid === void 0 && (h = "actorValid")) {
                                                                                  const I = {
                                                                                    instancePath: s + "/events/" + o + "/pages/" + c + "/conditions",
                                                                                  ...
                                                                                  const I = e;
                                                                                  for (const i in a) if (!P.call(u.items.oneOf[1].properties.pages.items.properties.conditions.properties, i)) {
                                                                                    const d = {
                                                                                      instancePath: s + "/events/" + o + "/pages/" + c + "/conditions",
                                                                                  ...
                                                                                  if (I === e) {
                                                                                    if (a.switch1Id !== void 0) {
                                                                                      let i = a.switch1Id;
                                                                                      const d = e;
                                                                                      if (typeof i != "number" || i % 1 || isNaN(i) || !isFinite(i)) {
                                                                                        const y = {
                                                                                          instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/switch1Id",
                                                                                      ...
                                                                                      if (e === d && typeof i == "number" && isFinite(i) && (i < 0 || isNaN(i))) {
                                                                                        const y = {
                                                                                          instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/switch1Id",
                                                                                    ...
                                                                                    if (v) {
                                                                                      if (a.switch1Valid !== void 0) {
                                                                                        const i = e;
                                                                                        if (typeof a.switch1Valid != "boolean") {
                                                                                          const d = {
                                                                                            instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/switch1Valid",
                                                                                      ...
                                                                                      if (v) {
                                                                                        if (a.switch2Id !== void 0) {
                                                                                          let i = a.switch2Id;
                                                                                          const d = e;
                                                                                          if (typeof i != "number" || i % 1 || isNaN(i) || !isFinite(i)) {
                                                                                            const y = {
                                                                                              instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/switch2Id",
                                                                                        ...
                                                                                        if (v) {
                                                                                          if (a.switch2Valid !== void 0) {
                                                                                            const i = e;
                                                                                            if (typeof a.switch2Valid != "boolean") {
                                                                                              const d = {
                                                                                                instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/switch2Valid",
                                                                                          ...
                                                                                          if (v) {
                                                                                            if (a.variableId !== void 0) {
                                                                                              let i = a.variableId;
                                                                                              const d = e;
                                                                                              if (typeof i != "number" || i % 1 || isNaN(i) || !isFinite(i)) {
                                                                                                const y = {
                                                                                                  instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/variableId",
                                                                                            ...
                                                                                            if (v) {
                                                                                              if (a.variableValid !== void 0) {
                                                                                                const i = e;
                                                                                                if (typeof a.variableValid != "boolean") {
                                                                                                  const d = {
                                                                                                    instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/variableValid",
                                                                                              ...
                                                                                              if (v) {
                                                                                                if (a.selfSwitchCh !== void 0) {
                                                                                                  const i = e;
                                                                                                  if (typeof a.selfSwitchCh != "string") {
                                                                                                    const d = {
                                                                                                      instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/selfSwitchCh",
                                                                                                ...
                                                                                                if (v) {
                                                                                                  if (a.selfSwitchValid !== void 0) {
                                                                                                    const i = e;
                                                                                                    if (typeof a.selfSwitchValid != "boolean") {
                                                                                                      const d = {
                                                                                                        instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/selfSwitchValid",
                                                                                                  ...
                                                                                                  if (v) {
                                                                                                    if (a.variableValue !== void 0) {
                                                                                                      let i = a.variableValue;
                                                                                                      const d = e;
                                                                                                      if (typeof i != "number" || i % 1 || isNaN(i) || !isFinite(i)) {
                                                                                                        const y = {
                                                                                                          instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/variableValue",
                                                                                                    ...
                                                                                                    if (v) {
                                                                                                      if (a.itemId !== void 0) {
                                                                                                        ...
                                                                                                        if (typeof i != "number" || i % 1 || isNaN(i) || !isFinite(i)) {
                                                                                                          const y = {
                                                                                                            instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/itemId",
                                                                                                      ...
                                                                                                      if (v) {
                                                                                                        if (a.itemValid !== void 0) {
                                                                                                          const i = e;
                                                                                                          if (typeof a.itemValid != "boolean") {
                                                                                                            const d = {
                                                                                                              instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/itemValid",
                                                                                                        ...
                                                                                                        if (v) {
                                                                                                          if (a.actorId !== void 0) {
                                                                                                            ...
                                                                                                            if (typeof i != "number" || i % 1 || isNaN(i) || !isFinite(i)) {
                                                                                                              const y = {
                                                                                                                instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/actorId",
                                                                                                          ...
                                                                                                          if (v) if (a.actorValid !== void 0) {
                                                                                                            const i = e;
                                                                                                            if (typeof a.actorValid != "boolean") {
                                                                                                              const d = {
                                                                                                                instancePath: s + "/events/" + o + "/pages/" + c + "/conditions/actorValid",
                                                                            ...
                                                                            if (g) {
                                                                              if (f.directionFix !== void 0) {
                                                                                const a = e;
                                                                                if (typeof f.directionFix != "boolean") {
                                                                                  const b = {
                                                                                    instancePath: s + "/events/" + o + "/pages/" + c + "/directionFix",
                                                                              ...
                                                                              if (g) {
                                                                                if (f.image !== void 0) {
                                                                                  ...
                                                                                  if (e === b) if (a && typeof a == "object" && !Array.isArray(a)) {
                                                                                    let h;
                                                                                    if (a.characterIndex === void 0 && (h = "characterIndex") || a.characterName === void 0 && (h = "characterName") || a.direction === void 0 && (h = "direction") || a.pattern === void 0 && (h = "pattern") || a.tileId === void 0 && (h = "tileId")) {
                                                                                      const I = { instancePath: s + "/events/" + o + "/pages/" + c + "/image", schemaPath: "#/$defs/MapEvents/items/oneOf/1/properties/pages/items/properties/image/required", keyword: "required", params: {
                                                                                        missingProperty: h
                                                                                      }, message: "must have required property '" + h + "'" };
                                                                                      t === null ? t = [I] : t.push(I), e++;
                                                                                    } else {
                                                                                      const I = e;
                                                                                      for (const i in a) if (i !== "characterIndex" && i !== "characterName" && i !== "direction" && i !== "pattern" && i !== "tileId") {
                                                                                        const d = {
                                                                                          instancePath: s + "/events/" + o + "/pages/" + c + "/image",
                                                                                      ...
                                                                                      if (I === e) {
                                                                                        if (a.characterIndex !== void 0) {
                                                                                          let i = a.characterIndex;
                                                                                          const d = e;
                                                                                          if (typeof i != "number" || i % 1 || isNaN(i) || !isFinite(i)) {
                                                                                            const y = {
                                                                                              instancePath: s + "/events/" + o + "/pages/" + c + "/image/characterIndex",
                                                                                        ...
                                                                                        if (C) {
                                                                                          if (a.characterName !== void 0) {
                                                                                            const i = e;
                                                                                            if (typeof a.characterName != "string") {
                                                                                              const d = {
                                                                                                instancePath: s + "/events/" + o + "/pages/" + c + "/image/characterName",
                                                                                          ...
                                                                                          if (C) {
                                                                                            if (a.direction !== void 0) {
                                                                                              let i = a.direction;
                                                                                              const d = e;
                                                                                              if (typeof i != "number" || i % 1 || isNaN(i) || !isFinite(i)) {
                                                                                                const y = {
                                                                                                  instancePath: s + "/events/" + o + "/pages/" + c + "/image/direction",
                                                                                              ...
                                                                                              if (i !== 2 && i !== 4 && i !== 6 && i !== 8) {
                                                                                                const y = {
                                                                                                  ...
                                                                                                  keyword: "enum",
                                                                                                  params: {
                                                                                                    allowedValues: u.items.oneOf[1].properties.pages.items.properties.image.properties.direction.enum
                                                                                                  },
                                                                                                  message: "must be equal to one of the allowed values"
                                                                                                };
                                                                                                t === null ? t = [y] : t.push(y), e++;
                                                                                            ...
                                                                                            if (C) {
                                                                                              if (a.pattern !== void 0) {
                                                                                                ...
                                                                                                if (typeof i != "number" || i % 1 || isNaN(i) || !isFinite(i)) {
                                                                                                  const y = {
                                                                                                    instancePath: s + "/events/" + o + "/pages/" + c + "/image/pattern",
                                                                                              ...
                                                                                              if (C) if (a.tileId !== void 0) {
                                                                                                let i = a.tileId;
                                                                                                const d = e;
                                                                                                if (typeof i != "number" || i % 1 || isNaN(i) || !isFinite(i)) {
                                                                                                  const y = {
                                                                                                    instancePath: s + "/events/" + o + "/pages/" + c + "/image/tileId",
                                                                                ...
                                                                                if (g) {
                                                                                  if (f.list !== void 0) {
                                                                                    ...
                                                                                    if (e === b) if (Array.isArray(a)) {
                                                                                      ...
                                                                                      const h = {
                                                                                        instancePath: s + "/events/" + o + "/pages/" + c + "/list",
                                                                                  ...
                                                                                  if (g) {
                                                                                    if (f.moveFrequency !== void 0) {
                                                                                      let a = f.moveFrequency;
                                                                                      const b = e;
                                                                                      if (typeof a != "number" || a % 1 || isNaN(a) || !isFinite(a)) {
                                                                                        const h = {
                                                                                          instancePath: s + "/events/" + o + "/pages/" + c + "/moveFrequency",
                                                                                    ...
                                                                                    if (g) if (f.moveRoute !== void 0) {
                                                                                      let a = f.moveRoute;
                                                                                      const b = e;
                                                                                      if (e === b) if (a && typeof a == "object" && !Array.isArray(a)) {
                                                                                        let h;
                                                                                        if (a.wait === void 0 && (h = "wait") || a.repeat === void 0 && (h = "repeat") || a.skippable === void 0 && (h = "skippable") || a.list === void 0 && (h = "list")) {
                                                                                          const I = {
                                                                                          ...
                                                                                          const I = e;
                                                                                          for (const i in a) if (i !== "list" && i !== "repeat" && i !== "skippable" && i !== "wait") {
                                                                                            const d = {
                                                                                              instancePath: s + "/events/" + o + "/pages/" + c + "/moveRoute",
                                                                                              ...
                                                                                              if (e === d) if (Array.isArray(i)) {
                                                                                                ...
                                                                                                for (let F = 0; F < y; F++) {
                                                                                                  ...
                                                                                                  if (e === G) if (O && typeof O == "object" && !Array.isArray(O)) {
                                                                                                    let Y;
                                                                                                    if (O.code === void 0 && (Y = "code") || O.parameters === void 0 && (Y = "parameters")) {
                                                                                                      const de = {
                                                                                                ...
                                                                                                const y = {
                                                                                                  instancePath: s + "/events/" + o + "/pages/" + c + "/moveRoute/list",
                                                                                            ...
                                                                                            if (W) {
                                                                                              if (a.repeat !== void 0) {
                                                                                                ...
                                                                                                if (typeof a.repeat != "boolean") {
                                                                                                  const d = {
                                                                                                    instancePath: s + "/events/" + o + "/pages/" + c + "/moveRoute/repeat",
                                                                                              ...
                                                                                              if (W) {
                                                                                                if (a.skippable !== void 0) {
                                                                                                  const i = e;
                                                                                                  if (typeof a.skippable != "boolean") {
                                                                                                    const d = {
                                                                                                      instancePath: s + "/events/" + o + "/pages/" + c + "/moveRoute/skippable",
                                                                                                ...
                                                                                                if (W) if (a.wait !== void 0) {
                                                                                                  const i = e;
                                                                                                  if (typeof a.wait != "boolean") {
                                                                                                    const d = {
                                                                                                      instancePath: s + "/events/" + o + "/pages/" + c + "/moveRoute/wait",
                                ...
                                if (m) {
                                  ...
                                  if (m) {
                                    ...
                                    if (m) {
                                      if (l.note !== void 0) {
                                        const r = e;
                                        if (typeof l.note != "string") return n.errors = [{
                                          instancePath: s + "/note",
                                      ...
                                      if (m) {
                                        if (l.parallaxLoopX !== void 0) {
                                          const r = e;
                                          if (typeof l.parallaxLoopX != "boolean") return n.errors = [{ instancePath: s + "/parallaxLoopX", schemaPath: "#/properties/parallaxLoopX/type", keyword: "type", params: {
                                            type: "boolean"
                                        ...
                                        if (m) {
                                          if (l.parallaxLoopY !== void 0) {
                                            const r = e;
                                            if (typeof l.parallaxLoopY != "boolean") return n.errors = [{
                                          ...
                                          if (m) {
                                            if (l.parallaxName !== void 0) {
                                              const r = e;
                                              if (typeof l.parallaxName != "string") return n.errors = [{
                                            ...
                                            if (m) {
                                              if (l.parallaxShow !== void 0) {
                                                const r = e;
                                                if (typeof l.parallaxShow != "boolean") return n.errors = [{
                                                    ...
                                                    if (m) {
                                                      ...
                                                      if (m) {
                                                        ...
                                                        if (m) if (l.specifyBattleback !== void 0) {
                                                          const r = e;
                                                          if (typeof l.specifyBattleback != "boolean") return n.errors = [{
