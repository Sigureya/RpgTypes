import type {
  Rmmz_Action_Constructor,
  Rmmz_InterpreterConstructor,
  Rmmz_Enemy_Constructor,
  Rmmz_System_Constructor,
  Rmmz_Variables_Constructor,
  Rmmz_Switches_Constructor,
  Rmmz_Message_Constructor,
...
export declare var Game_Party: Rmmz_Party_Constructor;
