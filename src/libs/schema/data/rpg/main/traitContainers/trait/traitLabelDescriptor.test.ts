...
describe("TraitLabelClass", () => {
  test("should match trait code correctly", () => {
    const traitLabel = new TraitDescriptor(1, "Test Label", "{value}");
  ...
  test("should format text with value placeholder", () => {
    const traitLabel = new TraitDescriptor(1, "Test Label", "Value: {value}");
    const trait = { code: 1, value: 10, dataId: 0 };
  ...
  test("should format text with name and value placeholders", () => {
    const traitLabel = new TraitDescriptor(
      1,
      "Test Label",
  ...
  test("should identify if format requires name", () => {
    const traitLabel = new TraitDescriptor(1, "Test Label", "Name: {name}", {
      author: "author",
      module: "module",
      kind: "kind",
    });
  ...
  test("should return invalid placeholders", () => {
    const traitLabel = new TraitDescriptor(1, "Test Label", "Invalid: {foo}");
