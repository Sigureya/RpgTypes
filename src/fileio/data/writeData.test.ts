...
const rawGameData: RawGameData = {
  ...
  commonEvent: createArrayResult(bundle.commonEvents),
  enemies: createArrayResult(bundle.enemies),
  item: createArrayResult(bundle.items),
  mapInfo: createArrayResult(bundle.mapInfos),
  skill: createArrayResult(bundle.skills),
  state: createArrayResult(bundle.states),
  system: { system: systemData, message: "" },
  troop: createArrayResult(bundle.troops),
  weapon: createArrayResult(bundle.weapons),
