...
export const TRAIT_STYPE_ADD = 41 as const;
export const TRAIT_STYPE_SEAL = 42 as const;
export const TRAIT_SKILL_ADD = 43 as const;
export const TRAIT_SKILL_SEAL = 44 as const;
export const TRAIT_EQUIP_WTYPE = 51 as const;
export const TRAIT_EQUIP_ATYPE = 52 as const;
