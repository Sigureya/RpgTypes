...
export interface Command_ShowMessageBody
  extends EventCommandLike<401, [content: string]> {}
...
export interface Command_ChoiceWhen
  extends EventCommandLike<402, [index: number, text: string]> {}

export interface Command_InputNumber
  extends EventCommandLike<103, [variableId: number, digits: number]> {}
export interface Command_SelectItem
  extends EventCommandLike<104, [variableId: number, itemType: number]> {}

export interface Command_ShowScrollingText
  extends EventCommandLike<105, [speed: number, skip: boolean]> {}
export interface Command_ShowScrollingTextBody
  extends EventCommandLike<405, [content: string]> {}

export interface Command_Comment
  extends EventCommandLike<108, [content: string]> {}
export interface Command_CommentBody
  extends EventCommandLike<408, [content: string]> {}
...
export interface Command_ExitEventProcessing
  extends EventCommandLike<115, []> {}

export interface Command_CommonEvent
  extends EventCommandLike<117, [eventId: number]> {}
...
export interface Command_ChangeBattleBGM
  extends EventCommandLike<132, [value: AudioFileParams]> {}

export interface Command_ChangeVictoryME
  extends EventCommandLike<133, [value: AudioFileParams]> {}
...
export interface Command_ChangeFormationAccess
  extends EventCommandLike<137, [value: ValueOf<Toggle>]> {}

export interface Command_ChangeWindowColor
  extends EventCommandLike<138, [color: ColorRGBA]> {}
...
export interface Command_ChangeTransparency
  extends EventCommandLike<211, [value: ValueOf<Toggle>]> {}
...
export interface Command_ShowBalloonIcon
  extends EventCommandLike<213, [characterId: number, balloonId: number]> {}

export interface Command_EraseEvent extends EventCommandLike<214, []> {}

export interface Command_ChangePlayerFollowers
  extends EventCommandLike<216, [value: ValueOf<Toggle>]> {}
...
export interface Command_TintPicture
  extends EventCommandLike<234, [unknown, unknown, unknown, wait: boolean]> {}
...
export interface Command_FadeOutBGM
  extends EventCommandLike<242, [duration: number]> {}
...
export interface Command_PlayME
  extends EventCommandLike<249, [value: AudioFileParams]> {}

export interface Command_PlaySE
  extends EventCommandLike<250, [value: AudioFileParams]> {}

export interface Command_StopSE extends EventCommandLike<251, []> {}

export interface Command_PlayMovie
  extends EventCommandLike<261, [filename: string]> {}

export interface Command_ChangeTileset
  extends EventCommandLike<282, [tilesetId: number]> {}

export interface Command_ChangeBattleBackground
  extends EventCommandLike<283, [background1: string, background2: string]> {}
...
export interface Command_ShopProcessingBody
  extends EventCommandLike<605, [goods: ShopGoods]> {}

export interface Command_NameInputProcessing
  extends EventCommandLike<303, [actorId: number, maxLength: number]> {}

export interface Command_ChangeName
  extends EventCommandLike<320, [actorId: number, name: string]> {}
...
export interface Command_ChangeNickName
  extends EventCommandLike<324, [actorId: number, nickname: string]> {}

export interface Command_ChangeProfile
  extends EventCommandLike<325, [actorId: number, profile: string]> {}
...
export interface Command_ScriptHeader
  extends EventCommandLike<355, [script: string]> {}

export interface Command_ScriptBody
  extends EventCommandLike<655, [script: string]> {}

export interface Command_PluginCommandMV
  extends EventCommandLike<356, [command: string, args: string]> {}
