...
export const makeTestTerms = (text: string): Required<System_TermsPartial> => {
  const basic: Terms_Basic = {
    exp: text,
    experience: text,
    hp: text,
    mp: text,
  ...
  const params: SystemLabels_TermsParamNames = {
    agi: text,
    atk: text,
    def: text,
    mat: text,
